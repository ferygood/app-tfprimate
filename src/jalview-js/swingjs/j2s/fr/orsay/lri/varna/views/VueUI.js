...
this.closeBtnCallback=null;
this.errorCallback=null;
this.finalCallback=null;
this.noBtnCallback=null;
...
this._tikzFilter=null;
}, 1);

Clazz.newMeth(C$, '$init$', function () {
this._fileChooserDirectory=null;
this._varnaFilter=Clazz.new_($I$(1).c$$S$S$S,["VARNA Session File", "varna", "VARNA"]);
this._bpseqFilter=Clazz.new_($I$(1).c$$S$S$S,["BPSeq (CRW) File", "bpseq", "BPSEQ"]);
this._ctFilter=Clazz.new_($I$(1).c$$S$S$S,["Connect (MFold) File", "ct", "CT"]);
this._dbnFilter=Clazz.new_($I$(1).c$$S$S$S$S$S,["Dot-bracket notation (Vienna) File", "dbn", "DBN", "faa", "FAA"]);
this._jpgFilter=Clazz.new_($I$(1).c$$S$S$S$S$S,["JPEG Picture", "jpeg", "jpg", "JPG", "JPEG"]);
this._pngFilter=Clazz.new_($I$(1).c$$S$S$S,["PNG Picture", "png", "PNG"]);
this._epsFilter=Clazz.new_($I$(1).c$$S$S$S,["EPS File", "eps", "EPS"]);
this._svgFilter=Clazz.new_($I$(1).c$$S$S$S,["SVG Picture", "svg", "SVG"]);
this._xfigFilter=Clazz.new_($I$(1).c$$S$S$S$S$S,["XFig Diagram", "fig", "xfig", "FIG", "XFIG"]);
this._tikzFilter=Clazz.new_($I$(1).c$$S$S$S,["PGF/Tikz diagram", "tex", "pgf"]);
}, 1);
...
C$.$init$.apply(this);
this._vp=vp;
this._undoableEditSupport=Clazz.new_($I$(4).c$$O,[this._vp]);
}, 1);
...
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(6).c$$I$fr_orsay_lri_varna_VARNAPanel$Z,[2, this._vp, !this._vp.getFlatExteriorLoop$()]));
...
if (this._vp.isModifiable$()) {
var bck=this.backupAllCoords$();
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(6).c$$I$fr_orsay_lri_varna_VARNAPanel,[2, this._vp]));
this._vp.reset$();
this._vp.drawRNA$fr_orsay_lri_varna_models_rna_RNA$I(this._vp.getRNA$(), 2);
this._vp.repaint$();
this._vp.fireLayoutChanged$java_util_Hashtable(bck);
...
if (this._vp.isModifiable$()) {
var bck=this.backupAllCoords$();
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(6).c$$I$fr_orsay_lri_varna_VARNAPanel,[6, this._vp]));
this._vp.reset$();
...
if (this._vp.isModifiable$()) {
var bck=this.backupAllCoords$();
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(6).c$$I$fr_orsay_lri_varna_VARNAPanel,[4, this._vp]));
this._vp.reset$();
...
if (this._vp.isModifiable$()) {
var bck=this.backupAllCoords$();
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(6).c$$I$fr_orsay_lri_varna_VARNAPanel,[1, this._vp]));
this._vp.reset$();
...
if (this._vp.isModifiable$()) {
var bck=this.backupAllCoords$();
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(6).c$$I$fr_orsay_lri_varna_VARNAPanel,[3, this._vp]));
this._vp.reset$();
...
if (this._vp.isModifiable$()) {
var bck=this.backupAllCoords$();
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(6).c$$I$fr_orsay_lri_varna_VARNAPanel,[5, this._vp]));
this._vp.reset$();
...
if (this._vp.isModifiable$()) {
var bck=this.backupAllCoords$();
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(6).c$$I$fr_orsay_lri_varna_VARNAPanel,[this._vp.getRNA$().get_drawMode$(), this._vp]));
this._vp.reset$();
...
if (rnas.size$() > 5) {
var vrna=Clazz.new_($I$(7).c$$java_util_ArrayList,[rnas]);
var ok=((P$.VueUI$1||
(function(){var C$=Clazz.newClass(P$, "VueUI$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
if (rnas.isEmpty$()) {
throw Clazz.new_($I$(10).c$$S,["No RNA could be parsed from that source."]);
} else {
...
var vcms=Clazz.new_($I$(11).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
var ok=((P$.VueUI$2||
(function(){var C$=Clazz.newClass(P$, "VueUI$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
(function(){var C$=Clazz.newClass(P$, "VueUI$3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
var vcmv=Clazz.new_($I$(12).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
var ok=((P$.VueUI$4||
(function(){var C$=Clazz.newClass(P$, "VueUI$4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
var vbv=Clazz.new_($I$(13).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
var cancel=((P$.VueUI$5||
(function(){var C$=Clazz.newClass(P$, "VueUI$5", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
if (this._vp.isModifiable$()) {
var manualInput=Clazz.new_($I$(14).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
var ok=((P$.VueUI$6||
(function(){var C$=Clazz.newClass(P$, "VueUI$6", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
var r=Clazz.new_($I$(15));
var cfg=Clazz.new_($I$(16));
...
if (this._vp.isModifiable$()) {
var input=((P$.VueUI$7||
(function(){var C$=Clazz.newClass(P$, "VueUI$7", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
if (this._vp.isModifiable$()) {
var input=((P$.VueUI$8||
(function(){var C$=Clazz.newClass(P$, "VueUI$8", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
var input=((P$.VueUI$9||
(function(){var C$=Clazz.newClass(P$, "VueUI$9", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
(function(){var C$=Clazz.newClass(P$, "VueUI$10", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
var listeExtension=Clazz.new_($I$(17));
listeExtension.addAll$java_util_Collection($I$(19).asList$TTA((f).getExtensions$()));
...
var border=Clazz.new_($I$(20).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
var oldBorder=this._vp.getBorderSize$();
this._vp.drawBBox$Z(true);
this._vp.drawBorder$Z(true);
this._vp.repaint$();
var cancel=((P$.VueUI$11||
(function(){var C$=Clazz.newClass(P$, "VueUI$11", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
(function(){var C$=Clazz.newClass(P$, "VueUI$12", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
(function(){var C$=Clazz.newClass(P$, "VueUI$13", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
var newTrans=Clazz.new_($I$(21).c$$I$I,[((_actualTranslation.x * ratio)|0), ((_actualTranslation.y * ratio)|0)]);
...
var zoom=Clazz.new_($I$(22).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
var oldZoom=this._vp.getZoom$();
var oldZoomAmount=this._vp.getZoomIncrement$();
this._vp.drawBBox$Z(true);
this._vp.repaint$();
var cancel=((P$.VueUI$14||
(function(){var C$=Clazz.newClass(P$, "VueUI$14", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
(function(){var C$=Clazz.newClass(P$, "VueUI$15", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
var rescale=Clazz.new_($I$(23).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
var cancel=((P$.VueUI$16||
(function(){var C$=Clazz.newClass(P$, "VueUI$16", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
(function(){var C$=Clazz.newClass(P$, "VueUI$17", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(24).c$$D$fr_orsay_lri_varna_VARNAPanel,[d, this._vp]));
}}});
...
this._vp.drawBBox$Z(true);
this._vp.repaint$();
var rotation=Clazz.new_($I$(25).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
var cancel=((P$.VueUI$18||
(function(){var C$=Clazz.newClass(P$, "VueUI$18", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
(function(){var C$=Clazz.newClass(P$, "VueUI$19", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(26).c$$D$fr_orsay_lri_varna_VARNAPanel,[d, this._vp]));
}}});

Clazz.newMeth(C$, 'UISetBPStyle$', function () {
if (this._vp.getRNA$().get_listeBases$().size$() > 0) {
var bpstyle=Clazz.new_($I$(27).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
var bck=this._vp.getBPStyle$();
var cancel=((P$.VueUI$20||
(function(){var C$=Clazz.newClass(P$, "VueUI$20", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
(function(){var C$=Clazz.newClass(P$, "VueUI$21", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
(function(){var C$=Clazz.newClass(P$, "VueUI$22", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
if (this._vp.isModifiable$()) {
var font=Clazz.new_($I$(28).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
var ok=((P$.VueUI$23||
(function(){var C$=Clazz.newClass(P$, "VueUI$23", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
if (this._vp.isModifiable$()) {
var vsbb=Clazz.new_($I$(29).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
var oldSpace=new Double(this._vp.getSpaceBetweenBases$());
var cancel=((P$.VueUI$24||
(function(){var C$=Clazz.newClass(P$, "VueUI$24", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
Clazz.newMeth(C$, 'run$', function () {
this.b$['fr.orsay.lri.varna.views.VueUI']._vp.setSpaceBetweenBases$D((this.$finals$.oldSpace).doubleValue$());
...
if (this._vp.isModifiable$()) {
var v=Clazz.new_($I$(30).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
var oldSpace=new Double(this._vp.getBPHeightIncrement$());
var cancel=((P$.VueUI$25||
(function(){var C$=Clazz.newClass(P$, "VueUI$25", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
Clazz.newMeth(C$, 'run$', function () {
this.b$['fr.orsay.lri.varna.views.VueUI']._vp.setBPHeightIncrement$D((this.$finals$.oldSpace).doubleValue$());
this.b$['fr.orsay.lri.varna.views.VueUI']._vp.drawRNA$fr_orsay_lri_varna_models_rna_RNA(this.b$['fr.orsay.lri.varna.views.VueUI']._vp.getRNA$());
this.b$['fr.orsay.lri.varna.views.VueUI']._vp.repaint$();
});
})()
...
var vnp=Clazz.new_($I$(31).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
var cancel=((P$.VueUI$26||
(function(){var C$=Clazz.newClass(P$, "VueUI$26", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
var vbpt=Clazz.new_($I$(32).c$$fr_orsay_lri_varna_VARNAPanel$fr_orsay_lri_varna_models_rna_ModeleBP,[this._vp, msbp]);
var cancel=((P$.VueUI$27||
(function(){var C$=Clazz.newClass(P$, "VueUI$27", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
), Clazz.new_(P$.VueUI$27.$init$, [this, {msbp: msbp, bck5: bck5, bck3: bck3, bcks: bcks}]));
...
(function(){var C$=Clazz.newClass(P$, "VueUI$28", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
if (mb.getElementStructure$() != -1) {
var msbp=mb.getStyleBP$();
var bases=Clazz.new_($I$(17));
bases.add$TE(msbp);
this.UIThicknessBasePairs$java_util_ArrayList(bases);
}}});

Clazz.newMeth(C$, 'saveToPNG$S', function (filename) {
var jpeg=Clazz.new_($I$(33).c$$Z$Z,[true, false]);
var ok=((P$.VueUI$29||
(function(){var C$=Clazz.newClass(P$, "VueUI$29", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
var myImage=Clazz.new_($I$(34).c$$I$I$I,[(Math.round(this.b$['fr.orsay.lri.varna.views.VueUI']._vp.getWidth$() * (scale).doubleValue$())|0), (Math.round(this.b$['fr.orsay.lri.varna.views.VueUI']._vp.getHeight$() * (scale).doubleValue$())|0), 2]);
var g2=myImage.createGraphics$();
var AF=Clazz.new_($I$(35));
...
g2.dispose$();
try {
$I$(36).write$java_awt_image_RenderedImage$S$java_io_File(myImage, "PNG", Clazz.new_($I$(37).c$$S,[this.$finals$.filename]));
} catch (e) {
if (Clazz.exceptionOf(e,"java.io.IOException")){
this.b$['fr.orsay.lri.varna.views.VueUI']._vp.errorDialog$Exception(Clazz.new_($I$(38).c$$S$S,[e.getMessage$(), this.$finals$.filename]));
} else {
throw e;
}
}
...
), Clazz.new_(P$.VueUI$29.$init$, [this, {jpeg: jpeg, filename: filename}]));
...
var jpeg=Clazz.new_($I$(33).c$$Z$Z,[true, true]);
var ok=((P$.VueUI$30||
(function(){var C$=Clazz.newClass(P$, "VueUI$30", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
var myImage=Clazz.new_($I$(34).c$$I$I$I,[(Math.round(this.b$['fr.orsay.lri.varna.views.VueUI']._vp.getWidth$() * (scale).doubleValue$())|0), (Math.round(this.b$['fr.orsay.lri.varna.views.VueUI']._vp.getHeight$() * (scale).doubleValue$())|0), 1]);
var g2=myImage.createGraphics$();
var AF=Clazz.new_($I$(35));
AF.setToScale$D$D((scale).doubleValue$(), (scale).doubleValue$());
g2.setTransform$java_awt_geom_AffineTransform(AF);
...
try {
var out=Clazz.new_($I$(39).c$$java_io_File,[Clazz.new_($I$(37).c$$S,[this.$finals$.filename])]);
...
var myIIOImage=Clazz.new_($I$(40).c$$java_awt_image_RenderedImage$java_util_List$javax_imageio_metadata_IIOMetadata,[myImage, null, null]);
...
(function(){var C$=Clazz.newClass(P$, "VueUI$31", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
(function(){var C$=Clazz.newClass(P$, "VueUI$32", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
if (this._vp.isModifiable$()) {
Clazz.new_($I$(41).c$$fr_orsay_lri_varna_VARNAPanel$I,[this._vp, 1]);
}});
...
if (this._vp.isModifiable$()) {
Clazz.new_($I$(41).c$$fr_orsay_lri_varna_VARNAPanel$I,[this._vp, 3]);
}});

Clazz.newMeth(C$, 'UIBaseAllColor$', function () {
if (this._vp.isModifiable$()) {
Clazz.new_($I$(41).c$$fr_orsay_lri_varna_VARNAPanel$I,[this._vp, 2]);
}});

Clazz.newMeth(C$, 'UIAbout$', function () {
var about=Clazz.new_($I$(42));
var ok=((P$.VueUI$33||
(function(){var C$=Clazz.newClass(P$, "VueUI$33", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
var vue;
if (textAnnotation.getType$() === $I$(43).POSITION ) vue=Clazz.new_($I$(44).c$$fr_orsay_lri_varna_VARNAPanel$fr_orsay_lri_varna_models_annotations_TextAnnotation$Z,[this._vp, textAnnotation, false]);
 else vue=Clazz.new_($I$(44).c$$fr_orsay_lri_varna_VARNAPanel$fr_orsay_lri_varna_models_annotations_TextAnnotation$Z$Z,[this._vp, textAnnotation, true, false]);
vue.show$();
});
...
switch (type) {
case $I$(43).BASE:
textAnnot=Clazz.new_($I$(45).c$$S$fr_orsay_lri_varna_models_rna_ModeleBase,["", this._vp.getRNA$().get_listeBases$().get$I((listeIndex.get$I(0)).intValue$())]);
vue=Clazz.new_($I$(44).c$$fr_orsay_lri_varna_VARNAPanel$fr_orsay_lri_varna_models_annotations_TextAnnotation$Z,[this._vp, textAnnot, true]);
vue.show$();
break;
case $I$(43).LOOP:
listeBase=Clazz.new_($I$(17));
for (var i, $i = listeIndex.iterator$(); $i.hasNext$()&&((i=($i.next$())),1);) {
listeBase.add$TE(this._vp.getRNA$().get_listeBases$().get$I((i).intValue$()));
}
textAnnot=Clazz.new_($I$(45).c$$S$java_util_ArrayList$fr_orsay_lri_varna_models_annotations_TextAnnotation_AnchorType,["", listeBase, type]);
vue=Clazz.new_($I$(44).c$$fr_orsay_lri_varna_VARNAPanel$fr_orsay_lri_varna_models_annotations_TextAnnotation$Z,[this._vp, textAnnot, true]);
vue.show$();
break;
case $I$(43).HELIX:
...
if (this._vp.isModifiable$()) {
var p=this._vp.panelToLogicPoint$java_awt_geom_Point2D_Double(Clazz.new_($I$(46).c$$D$D,[x, y]));
var annotationAdd=Clazz.new_($I$(44).c$$fr_orsay_lri_varna_VARNAPanel$I$I,[this._vp, (p.x|0), (p.y|0)]);
annotationAdd.show$();
}});

Clazz.newMeth(C$, 'UIAnnotationsAddBase$I$I', function (x, y) {
if (this._vp.isModifiable$()) {
var mb=this._vp.getBaseAt$java_awt_geom_Point2D_Double(Clazz.new_($I$(46).c$$D$D,[x, y]));
if (mb != null ) {
this._vp.highlightSelectedBase$fr_orsay_lri_varna_models_rna_ModeleBase(mb);
var textAnnot=Clazz.new_($I$(45).c$$S$fr_orsay_lri_varna_models_rna_ModeleBase,["", mb]);
var annotationAdd=Clazz.new_($I$(44).c$$fr_orsay_lri_varna_VARNAPanel$fr_orsay_lri_varna_models_annotations_TextAnnotation$Z,[this._vp, textAnnot, true]);
annotationAdd.show$();
}}});
...
var textAnnot;
textAnnot=Clazz.new_($I$(45).c$$S$java_util_ArrayList$fr_orsay_lri_varna_models_annotations_TextAnnotation_AnchorType,["", mbs, $I$(43).LOOP]);
...
var best=Clazz.new_($I$(17));
var current=Clazz.new_($I$(17));
for (var i=0; i < tab.length; i++) {
if (tab[i] != null ) {
current.add$TE(tab[i]);
} else {
if (current.size$() > best.size$()) best=current;
current=Clazz.new_($I$(17));
}}
...
if (mb.size$() == 0) {
var m=this._vp.getBaseAt$java_awt_geom_Point2D_Double(Clazz.new_($I$(46).c$$D$D,[x, y]));
mb.add$TE(m);
...
var regionAnnot=Clazz.new_($I$(48).c$$java_util_ArrayList,[mb]);
this._vp.addHighlightRegion$fr_orsay_lri_varna_models_annotations_HighlightRegionAnnotation(regionAnnot);
var annotationAdd=Clazz.new_($I$(49).c$$fr_orsay_lri_varna_VARNAPanel$fr_orsay_lri_varna_models_annotations_HighlightRegionAnnotation,[this._vp, regionAnnot]);
...
var p=this._vp.panelToLogicPoint$java_awt_geom_Point2D_Double(Clazz.new_($I$(46).c$$D$D,[x, y]));
var m1=this._vp.getBaseAt$java_awt_geom_Point2D_Double(Clazz.new_($I$(46).c$$D$D,[x, y]));
var best=null;
if (m1.getIndex$() - 1 >= 0) {
...
best=m2;
}}}var tab=Clazz.new_($I$(17));
tab.add$TE(m1);
tab.add$TE(best);
this._vp.setSelection$java_util_Collection(tab);
var regionAnnot=Clazz.new_($I$(50).c$$fr_orsay_lri_varna_models_rna_ModeleBase$fr_orsay_lri_varna_models_rna_ModeleBase,[m1, best]);
this._vp.getRNA$().addChemProbAnnotation$fr_orsay_lri_varna_models_annotations_ChemProbAnnotation(regionAnnot);
var annotationAdd=Clazz.new_($I$(51).c$$fr_orsay_lri_varna_VARNAPanel$fr_orsay_lri_varna_models_annotations_ChemProbAnnotation,[this._vp, regionAnnot]);
if (!annotationAdd.show$()) {
...
var mbs=this._vp.getRNA$().getBasesAt$java_util_Collection(v);
var textAnnot;
textAnnot=Clazz.new_($I$(45).c$$S$java_util_ArrayList$fr_orsay_lri_varna_models_annotations_TextAnnotation_AnchorType,["", mbs, $I$(43).HELIX]);
this._vp.setSelection$java_util_Collection(mbs);
var annotationAdd=Clazz.new_($I$(44).c$$fr_orsay_lri_varna_VARNAPanel$fr_orsay_lri_varna_models_annotations_TextAnnotation$Z,[this._vp, textAnnot, true]);
annotationAdd.show$();
}} catch (e) {
...
if (this._vp.isModifiable$()) {
var annotationAdd=Clazz.new_($I$(44).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
annotationAdd.show$();
}});

Clazz.newMeth(C$, 'UIEditAllBasePairs$', function () {
if (this._vp.isModifiable$()) {
Clazz.new_($I$(52).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
}});
...
if (this._vp.isModifiable$()) {
Clazz.new_($I$(53).c$$fr_orsay_lri_varna_VARNAPanel$I,[this._vp, 0]);
}});

Clazz.newMeth(C$, 'UIAnnotationsEdit$', function () {
if (this._vp.isModifiable$()) {
Clazz.new_($I$(53).c$$fr_orsay_lri_varna_VARNAPanel$I,[this._vp, 1]);
}});
...
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(54).c$$I$I$fr_orsay_lri_varna_models_rna_ModeleBP$fr_orsay_lri_varna_VARNAPanel,[i, j, ms, this._vp]));
this._vp.repaint$();
var tmp=Clazz.new_($I$(55));
tmp.add$TE(ms);
this._vp.fireStructureChanged$java_util_Set$java_util_Set$java_util_Set(Clazz.new_($I$(55).c$$java_util_Collection,[this._vp.getRNA$().getAllBPs$()]), tmp, Clazz.new_($I$(55)));
}});

Clazz.newMeth(C$, 'UIRemoveBP$fr_orsay_lri_varna_models_rna_ModeleBP', function (ms) {
if (this._vp.isModifiable$()) {
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(56).c$$I$I$fr_orsay_lri_varna_models_rna_ModeleBP$fr_orsay_lri_varna_VARNAPanel,[ms.getIndex5$(), ms.getIndex3$(), ms, this._vp]));
this._vp.getRNA$().removeBP$fr_orsay_lri_varna_models_rna_ModeleBP(ms);
this._vp.repaint$();
var tmp=Clazz.new_($I$(55));
tmp.add$TE(ms);
this._vp.fireStructureChanged$java_util_Set$java_util_Set$java_util_Set(Clazz.new_($I$(55).c$$java_util_Collection,[this._vp.getRNA$().getAllBPs$()]), Clazz.new_($I$(55)), tmp);
}});

Clazz.newMeth(C$, 'UIShiftBaseCoord$java_util_ArrayList$D$D', function (indices, dx, dy) {
if (this._vp.isModifiable$()) {
var backupPos=Clazz.new_($I$(5));
...
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(57).c$$java_util_ArrayList$D$D$fr_orsay_lri_varna_VARNAPanel,[indices, dx, dy, this._vp]));
this._vp.repaint$();
...
var backupPos=Clazz.new_($I$(5));
backupPos.put$TK$TV(new Integer(index), d);
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(58).c$$I$D$D$fr_orsay_lri_varna_VARNAPanel,[index, nx, ny, this._vp]));
...
this.UISetBaseCenter$I$java_awt_geom_Point2D_Double(index, Clazz.new_($I$(46).c$$D$D,[x, y]));
});
...
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(59).c$$java_awt_Point$fr_orsay_lri_varna_VARNAPanel,[h, this._vp]));
}} else {
...
var AB=Clazz.new_($I$(46).c$$D$D,[B.x - A.x, B.y - A.y]);
var normAB=Math.sqrt(AB.x * AB.x + AB.y * AB.y);
var O=A;
var Ox=Clazz.new_($I$(46).c$$D$D,[AB.x / normAB, AB.y / normAB]);
var old=Clazz.new_($I$(5));
...
var hAB=Clazz.new_($I$(46).c$$D$D,[B.y - A.y, -(B.x - A.x)]);
var AC=Clazz.new_($I$(46).c$$D$D,[C.x - A.x, C.y - A.y]);
var AP=Clazz.new_($I$(46).c$$D$D,[P.x - A.x, P.y - A.y]);
...
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(60).c$$D$D$D$D$java_awt_Point$java_awt_Point$fr_orsay_lri_varna_VARNAPanel,[delta, base, pLimL, pLimR, h, ml, this._vp]));
...
var vbpt=Clazz.new_($I$(61).c$$fr_orsay_lri_varna_VARNAPanel$java_util_ArrayList,[this._vp, bases]);
var cancel=((P$.VueUI$34||
(function(){var C$=Clazz.newClass(P$, "VueUI$34", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
