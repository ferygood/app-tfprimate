...
this.spaceSlider=Clazz.new_($I$(2).c$$I$I$I$I,[0, 10, 200, (Integer.valueOf$S(String.valueOf$J(Math.round(vp.getRNA$().getBPHeightIncrement$() * 100)))).intValue$()]);
this.spaceSlider.setMajorTickSpacing$I(30);
this.spaceSlider.setPaintTicks$Z(true);
this.spaceSlider.setPaintLabels$Z(true);
var spaceLabel=Clazz.new_($I$(3).c$$S,[String.valueOf$D(vp.getRNA$().getBPHeightIncrement$() * 100.0)]);
...
this.spaceSlider.addChangeListener$javax_swing_event_ChangeListener(Clazz.new_($I$(6).c$$fr_orsay_lri_varna_views_VueBPHeightIncrement,[this]));
this.panel=Clazz.new_($I$(1));
this.panel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(7).c$$I,[0]));
var labelS=Clazz.new_($I$(3).c$$S,["HeighInc:"]);
