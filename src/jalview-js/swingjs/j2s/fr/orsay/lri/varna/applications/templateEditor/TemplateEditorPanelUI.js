...
C$.$init$.apply(this);
this._tp=tp;
this._undoableEditSupport=Clazz.new_($I$(2).c$$O,[tp]);
}, 1);
...
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(3).c$$fr_orsay_lri_varna_applications_templateEditor_GraphicalTemplateElement$fr_orsay_lri_varna_applications_templateEditor_GraphicalTemplateElement_RelativePosition$D$D$fr_orsay_lri_varna_applications_templateEditor_TemplatePanel,[h, edge, nx, ny, this._tp]));
h.setEdgePosition$fr_orsay_lri_varna_applications_templateEditor_GraphicalTemplateElement_RelativePosition$java_awt_geom_Point2D_Double(edge, Clazz.new_($I$(4).c$$D$D,[nx, ny]));
this._tp.repaint$();
});
...
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(6).c$$fr_orsay_lri_varna_applications_templateEditor_GraphicalTemplateElement$fr_orsay_lri_varna_applications_templateEditor_TemplatePanel,[h, this._tp]));
...
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(7).c$$fr_orsay_lri_varna_applications_templateEditor_GraphicalTemplateElement$fr_orsay_lri_varna_applications_templateEditor_TemplatePanel,[h, this._tp]));
...
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(9).c$$fr_orsay_lri_varna_applications_templateEditor_Connection$fr_orsay_lri_varna_applications_templateEditor_TemplatePanel,[c, this._tp]));
}});

Clazz.newMeth(C$, 'removeConnectionUI$fr_orsay_lri_varna_applications_templateEditor_Connection', function (c) {
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(10).c$$fr_orsay_lri_varna_applications_templateEditor_Connection$fr_orsay_lri_varna_applications_templateEditor_TemplatePanel,[c, this._tp]));
...
this._undoableEditSupport.postEdit$javax_swing_undo_UndoableEdit(Clazz.new_($I$(11).c$$fr_orsay_lri_varna_applications_templateEditor_Helix$fr_orsay_lri_varna_applications_templateEditor_TemplatePanel,[h, this._tp]));
...
;
(function(){var C$=Clazz.newClass(P$.TemplateEditorPanelUI, "Tool", function(){
