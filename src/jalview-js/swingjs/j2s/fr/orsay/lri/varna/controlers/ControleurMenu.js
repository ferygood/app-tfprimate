(function(){var P$=Clazz.newPackage("fr.orsay.lri.varna.controlers"),p$1={},I$=[[0,'java.util.ArrayList',['fr.orsay.lri.varna.models.annotations.TextAnnotation','.AnchorType'],'javax.swing.JColorChooser','fr.orsay.lri.varna.models.VARNAConfig','fr.orsay.lri.varna.views.VueBPThickness','javax.swing.JOptionPane']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "ControleurMenu", null, null, ['fr.orsay.lri.varna.interfaces.InterfaceVARNAListener', 'java.awt.event.ActionListener']);
...
var listeIndex=Clazz.new_($I$(1));
switch (type) {
case $I$(2).BASE:
listeIndex.add$TE(this._vp.getNearestBase$());
case $I$(2).LOOP:
if (this._type.startsWith$S("loop1")) listeIndex=this._vp.getRNA$().findLoopForward$I((this._vp.getNearestBase$()).intValue$());
 else if (this._type.startsWith$S("loop2")) listeIndex=this._vp.getRNA$().findLoopBackward$I((this._vp.getNearestBase$()).intValue$());
 else listeIndex=this._vp.getRNA$().findLoop$I((this._vp.getNearestBase$()).intValue$());
break;
case $I$(2).HELIX:
listeIndex=this._vp.getRNA$().findHelix$I((this._vp.getNearestBase$()).intValue$());
break;
}
...
this._vp.getRNA$().get_listeBases$().get$I((listBase.get$I(i)).intValue$()).getStyleBase$().setBaseInnerColor$java_awt_Color(c);
}
this._vp.repaint$();
...
listBase=p$1.listSwitchType$S.apply(this, [this._type]);
for (var i=0; i < listBase.size$(); i++) {
this._vp.getRNA$().get_listeBases$().get$I((listBase.get$I(i)).intValue$()).getStyleBase$().setBaseOutlineColor$java_awt_Color(c);
}
this._vp.repaint$();
...
listBase=p$1.listSwitchType$S.apply(this, [this._type]);
for (var i=0; i < listBase.size$(); i++) {
this._vp.getRNA$().get_listeBases$().get$I((listBase.get$I(i)).intValue$()).getStyleBase$().setBaseNameColor$java_awt_Color(c);
}
this._vp.repaint$();
...
listBase=p$1.listSwitchType$S.apply(this, [this._type]);
for (var i=0; i < listBase.size$(); i++) {
this._vp.getRNA$().get_listeBases$().get$I((listBase.get$I(i)).intValue$()).getStyleBase$().setBaseNumberColor$java_awt_Color(c);
}
this._vp.repaint$();
...
listBase=p$1.listSwitchType$S.apply(this, [this._type]);
for (var i=0; i < listBase.size$(); i++) {
for (var msbp, $msbp = this._vp.getRNA$().getBPsAt$I((listBase.get$I(i)).intValue$()).iterator$(); $msbp.hasNext$()&&((msbp=($msbp.next$())),1);) {
if (msbp != null ) {
...
listBase=p$1.listSwitchType$S.apply(this, [this._type]);
for (var i=0; i < listBase.size$(); i++) {
var mb=this._vp.getRNA$().get_listeBases$().get$I((listBase.get$I(i)).intValue$());
...
listBase=p$1.listSwitchType$S.apply(this, [this._type]);
var styleBPs=Clazz.new_($I$(1));
for (var i=0; i < listBase.size$(); i++) {
var mb=this._vp.getRNA$().get_listeBases$().get$I((listBase.get$I(i)).intValue$());
if (mb.getElementStructure$() != -1) {
styleBPs.add$TE(mb.getStyleBP$());
}}
var vbpt=Clazz.new_($I$(5).c$$fr_orsay_lri_varna_VARNAPanel$java_util_ArrayList,[this._vp, styleBPs]);
...
if (_type.equals$O("helix")) return this._vp.getRNA$().findHelix$I((this._vp.getNearestBase$()).intValue$());
...
return this._vp.getRNA$().findLoopForward$I((this._vp.getNearestBase$()).intValue$());
}if (_type.equals$O("loop2")) {
return this._vp.getRNA$().findLoopBackward$I((this._vp.getNearestBase$()).intValue$());
}if (_type.equals$O("stem")) return this._vp.getRNA$().findStem$I((this._vp.getNearestBase$()).intValue$());
if (_type.equals$O("base")) {
var list=Clazz.new_($I$(1));
list.add$TE(this._vp.getNearestBase$());
return list;
