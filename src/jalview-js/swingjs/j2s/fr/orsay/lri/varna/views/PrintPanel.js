...
var C$=Clazz.newClass(P$, "PrintPanel", null, 'javax.swing.JPanel', 'java.awt.print.Printable');
...
Clazz.newMeth(C$, ['print$java_awt_Graphics$java_awt_print_PageFormat$I','print$'], function (g, pf, page) {
if (page >= 1) return 1;
var g2=g;
g2.translate$D$D(pf.getImageableX$(), pf.getImageableY$());
g2.draw$java_awt_Shape(Clazz.new_($I$(8).c$$D$D$D$D,[0, 0, pf.getImageableWidth$(), pf.getImageableHeight$()]));
this.drawPage$java_awt_Graphics2D(g2);
return 0;
});
...
var f=Clazz.new_($I$(9).c$$S$I$I,["Serif", 0, 72]);
var drawOutline=true;
{
drawOutline = false;
}
if (drawOutline) {
var clipShape=Clazz.new_($I$(10));
var layout=Clazz.new_($I$(11).c$$S$java_awt_Font$java_awt_font_FontRenderContext,["Hello", f, context]);
...
layout=Clazz.new_($I$(11).c$$S$java_awt_Font$java_awt_font_FontRenderContext,["World", f, context]);
...
var p=Clazz.new_($I$(13).c$$D$D,[0, 0]);
for (var i=0; i < 50; i++) {
var x=((2 * this.getWidth$() * i )/50|0);
var y=((2 * this.getHeight$() * (50 - 1 - i ) )/50|0);
var q=Clazz.new_($I$(13).c$$D$D,[x, y]);
g2.draw$java_awt_Shape(Clazz.new_($I$(14).c$$java_awt_geom_Point2D$java_awt_geom_Point2D,[p, q]));
}
});
