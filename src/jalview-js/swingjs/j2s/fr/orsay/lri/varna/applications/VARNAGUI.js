...
this._createButton=Clazz.new_($I$(7).c$$S,["Create"]);
this._deleteButton=Clazz.new_($I$(7).c$$S,["Delete"]);
this._duplicateButton=Clazz.new_($I$(7).c$$S,["Snapshot"]);
this._listPanel=Clazz.new_($I$(4));
this._sideList=null;
this._backgroundColor=$I$(8).white;
this._vert=Clazz.new_($I$(9).c$$I,[1]);
this._horiz=Clazz.new_($I$(9).c$$I,[0]);
}, 1);

Clazz.newMeth(C$, 'c$', function () {
C$.superclazz.c$$S.apply(this, ["VARNA GUI"]);
C$.$init$.apply(this);
p$1.RNAPanelDemoInit.apply(this, []);
}, 1);

Clazz.newMeth(C$, 'RNAPanelDemoInit', function () {
var dlm=Clazz.new_($I$(10));
var marginTools=40;
var m=Clazz.new_($I$(11));
m.setSelectionMode$I(0);
m.setLeadAnchorNotificationEnabled$Z(false);
this._sideList=Clazz.new_($I$(12));
...
(function(){var C$=Clazz.newClass(P$, "VARNAGUI$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'javax.swing.event.ListSelectionListener', 1);
...
this._rnaList=Clazz.new_($I$(13).c$$javax_swing_DefaultListModel$javax_swing_JList, [this, null, dlm, this._sideList]);
var _RNA1=Clazz.new_($I$(3).c$$S,["User defined 1"]);
var _RNA2=Clazz.new_($I$(3).c$$S,["User defined 2"]);
try {
this._vp=Clazz.new_($I$(14).c$$S$S,["0", "."]);
this._zoomWindow=Clazz.new_($I$(15).c$$fr_orsay_lri_varna_VARNAPanel,[this._vp]);
...
this._vp.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(16).c$$I$I,[400, 400]));
...
var listScroller=Clazz.new_($I$(17).c$$java_awt_Component,[this._sideList]);
listScroller.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(16).c$$I$I,[150, 0]));
this.setBackground$java_awt_Color(this._backgroundColor);
this._vp.setBackground$java_awt_Color(this._backgroundColor);
var textFieldsFont=$I$(18).decode$S("MonoSpaced-PLAIN-12");
this._seqLabel.setHorizontalTextPosition$I(2);
this._seqLabel.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(16).c$$I$I,[marginTools, 15]));
...
(function(){var C$=Clazz.newClass(P$, "VARNAGUI$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
try {
var nRNA=Clazz.new_($I$(3).c$$S,[P$.VARNAGUI.generateDefaultName$()]);
...
this.b$['fr.orsay.lri.varna.applications.VARNAGUI']._rnaList.add$fr_orsay_lri_varna_models_VARNAConfig$fr_orsay_lri_varna_models_rna_RNA$Z(Clazz.new_($I$(19)), nRNA, true);
} catch (e$$) {
if (Clazz.exceptionOf(e$$,"fr.orsay.lri.varna.exceptions.ExceptionUnmatchedClosingParentheses")){
var e1 = e$$;
{
$I$(20).showMessageDialog$java_awt_Component$O$S$I(this.b$['fr.orsay.lri.varna.applications.VARNAGUI']._vp, e1.getMessage$(), "Error", 0);
}
} else if (Clazz.exceptionOf(e$$,"fr.orsay.lri.varna.exceptions.ExceptionFileFormatOrSyntax")){
var e1 = e$$;
{
...
goPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(21)));
this._tools.setLayout$java_awt_LayoutManager(Clazz.new_($I$(21)));
...
(function(){var C$=Clazz.newClass(P$, "VARNAGUI$3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
(function(){var C$=Clazz.newClass(P$, "VARNAGUI$4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
var vpScroll=Clazz.new_($I$(4));
vpScroll.setLayout$java_awt_LayoutManager(Clazz.new_($I$(21)));
...
var split=Clazz.new_($I$(25).c$$I$Z$java_awt_Component$java_awt_Component,[1, true, this._listPanel, vpScroll]);
this.getContentPane$().setLayout$java_awt_LayoutManager(Clazz.new_($I$(21)));
...
var dt=Clazz.new_($I$(26).c$$java_awt_Component$java_awt_dnd_DropTargetListener,[this._vp, this]);
this._vp.addRNAListener$fr_orsay_lri_varna_interfaces_InterfaceVARNARNAListener(((P$.VARNAGUI$5||
(function(){var C$=Clazz.newClass(P$, "VARNAGUI$5", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'fr.orsay.lri.varna.interfaces.InterfaceVARNARNAListener', 1);
...
(function(){var C$=Clazz.newClass(P$, "VARNAGUI$6", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'fr.orsay.lri.varna.interfaces.InterfaceVARNASelectionListener', 1);
...
this.b$['fr.orsay.lri.varna.applications.VARNAGUI']._hoverHighlightSeq=this.b$['fr.orsay.lri.varna.applications.VARNAGUI']._seq.getHighlighter$().addHighlight$I$I$javax_swing_text_Highlighter_HighlightPainter(i + shifts[i], i + shifts[i] + 1 , Clazz.new_($I$(27).c$$java_awt_Color,[$I$(8).green]));
this.b$['fr.orsay.lri.varna.applications.VARNAGUI']._hoverHighlightStr=this.b$['fr.orsay.lri.varna.applications.VARNAGUI']._str.getHighlighter$().addHighlight$I$I$javax_swing_text_Highlighter_HighlightPainter(i + shifts[i], i + shifts[i] + 1 , Clazz.new_($I$(27).c$$java_awt_Color,[$I$(8).green]));
} catch (e) {
...
try {
var i=m.getIndex$();
this.b$['fr.orsay.lri.varna.applications.VARNAGUI']._selectionHighlightSeq.add$TE(this.b$['fr.orsay.lri.varna.applications.VARNAGUI']._seq.getHighlighter$().addHighlight$I$I$javax_swing_text_Highlighter_HighlightPainter(i + shifts[i], i + shifts[i] + 1 , Clazz.new_($I$(27).c$$java_awt_Color,[$I$(8).orange])));
this.b$['fr.orsay.lri.varna.applications.VARNAGUI']._selectionHighlightStr.add$TE(this.b$['fr.orsay.lri.varna.applications.VARNAGUI']._str.getHighlighter$().addHighlight$I$I$javax_swing_text_Highlighter_HighlightPainter(i + shifts[i], i + shifts[i] + 1 , Clazz.new_($I$(27).c$$java_awt_Color,[$I$(8).orange])));
} catch (e) {
if (Clazz.exceptionOf(e,"javax.swing.text.BadLocationException")){
e.printStackTrace$();
} else {
...
Clazz.new_($I$(28).c$$Runnable,[this._zoomWindow]).start$();
}, p$1);
...
var icons=Clazz.new_($I$(1));
icons.add$TE($I$(29).getDefaultToolkit$().getImage$S("./VARNA16x16.png"));
icons.add$TE($I$(29).getDefaultToolkit$().getImage$S("./VARNA32x32.png"));
icons.add$TE($I$(29).getDefaultToolkit$().getImage$S("./VARNA64x64.png"));
var d=Clazz.new_(C$);
...
var vp=c;
try {
var bck=$I$(14).importSession$O(o);
...
var rnas=$I$(30).loadSecStr$java_io_File(o);
if (rnas.isEmpty$()) {
throw Clazz.new_($I$(31).c$$S,["No RNA could be parsed from that source."]);
...
var newName=$I$(20).showInputDialog$java_awt_Component$O$S$I$javax_swing_Icon$OA$O(this, "Specify a new name for this RNA", "Rename RNA", 3, null, null, item.toString());
if (newName != null ) {
...
Clazz.newMeth(C$, ['adjustmentValueChanged$java_awt_event_AdjustmentEvent','adjustmentValueChanged$'], function (arg0) {
if (arg0.getSource$() === this._horiz ) {
this._vp.setTranslation$java_awt_Point(Clazz.new_($I$(32).c$$I$I,[this._horiz.getMaximum$() - (arg0.getValue$() - this._horiz.getMinimum$()) - this._vp.getWidth$() , this._vp.getTranslation$().y]));
this._vp.repaint$();
} else if (arg0.getSource$() === this._vert ) {
this._vp.setTranslation$java_awt_Point(Clazz.new_($I$(32).c$$I$I,[this._vp.getTranslation$().x, this._vert.getMaximum$() - (arg0.getValue$() - this._vert.getMinimum$()) - this._vp.getHeight$() ]));
this._vp.repaint$();
}});
;
(function(){var C$=Clazz.newClass(P$.VARNAGUI, "BackupHolder", function(){
...
name=P$.VARNAGUI.generateDefaultName$();
