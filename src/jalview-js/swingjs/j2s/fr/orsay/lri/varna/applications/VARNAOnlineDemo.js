...
this._struct=Clazz.new_($I$(3));
this._seq=Clazz.new_($I$(3));
...
C$.$init$.apply(this);
try {
this._vp=Clazz.new_($I$(5).c$$S$S,[this._seq.getText$(), this._struct.getText$()]);
...
this._seqLabel.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(7).c$$I$I,[marginTools, 15]));
this._seq.setFont$java_awt_Font(textFieldsFont);
this._seq.setText$S(this._vp.getRNA$().getSeq$());
this._seqPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(8)));
this._seqPanel.add$java_awt_Component$O(this._seqLabel, "West");
this._seqPanel.add$java_awt_Component$O(this._seq, "Center");
this._structLabel.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(7).c$$I$I,[marginTools, 15]));
...
this._structPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(8)));
...
var controleurTextField=Clazz.new_($I$(9).c$$fr_orsay_lri_varna_applications_VARNAOnlineDemo,[this]);
...
this._input.setLayout$java_awt_LayoutManager(Clazz.new_($I$(10).c$$I$I,[3, 0]));
this._input.add$java_awt_Component(this._seqPanel);
this._input.add$java_awt_Component(this._structPanel);
this._tools.setLayout$java_awt_LayoutManager(Clazz.new_($I$(8)));
