(function(){var P$=Clazz.newPackage("fr.orsay.lri.varna.applications.newGUI"),I$=[[0,'fr.orsay.lri.varna.applications.newGUI.VARNAGUIRenderer']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
C$.$init$.apply(this);
this._base=Clazz.new_($I$(1).c$$javax_swing_JTree$fr_orsay_lri_varna_applications_newGUI_VARNAGUITreeModel,[tree, m]);
this._m=m;
}, 1);
