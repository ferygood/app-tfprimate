...
var newTree=Clazz.new_($I$(4));
newTree.setValue$TT(null);
...
var groupOfConsecutiveBases=Clazz.new_($I$(5).c$$Z,[false]);
groupOfConsecutiveBases.getNodes$().addAll$java_util_Collection(consecutiveNonPairedBases);
var groupOfConsecutiveBasesNode=Clazz.new_($I$(4));
groupOfConsecutiveBasesNode.setValue$TT(groupOfConsecutiveBases);
forest.add$TE(groupOfConsecutiveBasesNode);
consecutiveNonPairedBases.clear$();
}}, 1);

Clazz.newMeth(C$, 'RNAForest2FromRNAForest$java_util_List', function (originalForest) {
var forest=Clazz.new_($I$(6));
var consecutiveNonPairedBases=Clazz.new_($I$(7));
...
var pairedBase=Clazz.new_($I$(5).c$$Z,[true]);
pairedBase.setNode$fr_orsay_lri_varna_models_treealign_RNANodeValue(originalTree.getValue$());
var pairedBaseNode=Clazz.new_($I$(4));
pairedBaseNode.setValue$TT(pairedBase);
forest.add$TE(pairedBaseNode);
break;
case $I$(8).BASE_FROM_UNPAIRED_REGION:
consecutiveNonPairedBases.add$TE(originalTree.getValue$());
break;
...
var converter=Clazz.new_($I$(9));
return converter.convert$fr_orsay_lri_varna_models_treealign_Tree(alignment);
}, 1);
;
(function(){var C$=Clazz.newClass(P$.RNATree2, "ConvertToMapping", function(){
...
this.m=null;
this.sequenceAligner=null;
}, 1);

Clazz.newMeth(C$, '$init$', function () {
this.sequenceAligner=Clazz.new_($I$(1));
}, 1);

Clazz.newMeth(C$, 'convert$fr_orsay_lri_varna_models_treealign_Tree', function (tree) {
this.m=Clazz.new_($I$(2));
