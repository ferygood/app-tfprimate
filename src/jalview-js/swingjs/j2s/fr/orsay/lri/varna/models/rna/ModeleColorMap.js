(function(){var P$=Clazz.newPackage("fr.orsay.lri.varna.models.rna"),I$=[[0,'fr.orsay.lri.varna.models.rna.ModeleColorMap','java.awt.Color','java.util.Vector','java.util.Arrays',['fr.orsay.lri.varna.models.rna.ModeleColorMap','.NamedColorMapTypes'],'java.util.Formatter']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "ModeleColorMap", function(){
...
C$.c$$java_util_Vector$java_util_Vector.apply(this, [Clazz.new_($I$(3)), Clazz.new_($I$(3))]);
}, 1);
...
result=Clazz.new_($I$(2).c$$I$I$I,[((blendCoeff * c1.getRed$() + (1.0 - blendCoeff) * c2.getRed$())|0), ((blendCoeff * c1.getGreen$() + (1.0 - blendCoeff) * c2.getGreen$())|0), ((blendCoeff * c1.getBlue$() + (1.0 - blendCoeff) * c2.getBlue$())|0)]);
} else {
result=c1;
}}}return result;
});
...
var cm=Clazz.new_(C$);
cm.addColor$D$java_awt_Color(1.0, Clazz.new_($I$(2).c$$I$I$I,[128, 50, 50]).brighter$());
cm.addColor$D$java_awt_Color(0.9, Clazz.new_($I$(2).c$$I$I$I,[255, 50, 50]).brighter$());
cm.addColor$D$java_awt_Color(0.65, Clazz.new_($I$(2).c$$I$I$I,[255, 255, 50]).brighter$());
cm.addColor$D$java_awt_Color(0.55, Clazz.new_($I$(2).c$$I$I$I,[20, 255, 50]).brighter$());
cm.addColor$D$java_awt_Color(0.2, Clazz.new_($I$(2).c$$I$I$I,[50, 50, 255]).brighter$());
cm.addColor$D$java_awt_Color(0.0, Clazz.new_($I$(2).c$$I$I$I,[50, 50, 128]).brighter$());
return cm;
}, 1);

Clazz.newMeth(C$, 'viennaColorMap$', function () {
var cm=Clazz.new_(C$);
cm.addColor$D$java_awt_Color(0.0, Clazz.new_($I$(2).c$$I$I$I,[0, 80, 220]));
cm.addColor$D$java_awt_Color(0.1, Clazz.new_($I$(2).c$$I$I$I,[0, 139, 220]));
cm.addColor$D$java_awt_Color(0.2, Clazz.new_($I$(2).c$$I$I$I,[0, 220, 218]));
cm.addColor$D$java_awt_Color(0.3, Clazz.new_($I$(2).c$$I$I$I,[0, 220, 123]));
cm.addColor$D$java_awt_Color(0.4, Clazz.new_($I$(2).c$$I$I$I,[0, 220, 49]));
cm.addColor$D$java_awt_Color(0.5, Clazz.new_($I$(2).c$$I$I$I,[34, 220, 0]));
cm.addColor$D$java_awt_Color(0.6, Clazz.new_($I$(2).c$$I$I$I,[109, 220, 0]));
cm.addColor$D$java_awt_Color(0.7, Clazz.new_($I$(2).c$$I$I$I,[199, 220, 0]));
cm.addColor$D$java_awt_Color(0.8, Clazz.new_($I$(2).c$$I$I$I,[220, 165, 0]));
cm.addColor$D$java_awt_Color(0.9, Clazz.new_($I$(2).c$$I$I$I,[220, 86, 0]));
cm.addColor$D$java_awt_Color(1.0, Clazz.new_($I$(2).c$$I$I$I,[220, 0, 0]));
return cm;
}, 1);
...
;
(function(){var C$=Clazz.newClass(P$.ModeleColorMap, "NamedColorMapTypes", function(){
