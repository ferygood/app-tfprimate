...
this._seq1Panel=Clazz.new_($I$(1));
this._seq2Panel=Clazz.new_($I$(1));
...
this._seq1=Clazz.new_($I$(3).c$$S,["CGCGCACGCGA----UAUU----UCGCGUCGCGCAUUUGCGCGUAGCGCG"]);
this._seq2=Clazz.new_($I$(3).c$$S,["CGCGCACGCGSGCGCGUUUGCGCUCGCGU---------------AGCGCG"]);
this._struct1Label=Clazz.new_($I$(2).c$$S,[" Str1:"]);
this._struct2Label=Clazz.new_($I$(2).c$$S,[" Str2:"]);
this._seq1Label=Clazz.new_($I$(2).c$$S,[" Seq1:"]);
this._seq2Label=Clazz.new_($I$(2).c$$S,[" Seq2:"]);
this._goButton=Clazz.new_($I$(4).c$$S,["Go"]);
this._str1Backup="";
this._str2Backup="";
this._seq1Backup="";
this._seq2Backup="";
this._RNA=Clazz.new_($I$(5));
...
C$.$init$.apply(this);
this._vpMaster=Clazz.new_($I$(7).c$$S$S$S$S$I$S,[this.getSeq1$(), this.getStruct1$(), this.getSeq2$(), this.getStruct2$(), 2, ""]);
this._vpMaster.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(8).c$$I$I,[600, 400]));
...
this._seq1Label.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(8).c$$I$I,[marginTools, 15]));
this._seq1.setFont$java_awt_Font(textFieldsFont);
this._seq1Panel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(10)));
...
this._seq2Label.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(8).c$$I$I,[marginTools, 15]));
this._seq2.setFont$java_awt_Font(textFieldsFont);
this._seq2Panel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(10)));
this._seq2Panel.add$java_awt_Component$O(this._seq2Label, "West");
this._seq2Panel.add$java_awt_Component$O(this._seq2, "Center");
this._struct1Label.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(8).c$$I$I,[marginTools, 15]));
this._struct1Label.setHorizontalTextPosition$I(2);
this._struct1.setFont$java_awt_Font(textFieldsFont);
this._struct1Panel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(10)));
...
this._struct2Label.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(8).c$$I$I,[marginTools, 15]));
this._struct2Label.setHorizontalTextPosition$I(2);
this._struct2.setFont$java_awt_Font(textFieldsFont);
this._struct2Panel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(10)));
...
this._input.setLayout$java_awt_LayoutManager(Clazz.new_($I$(11).c$$I$I,[4, 0]));
...
goPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(10)));
...
VARNAs.setLayout$java_awt_LayoutManager(Clazz.new_($I$(11).c$$I$I,[1, 1]));
