...
var top=$I$(7).getTopInvokableAncestor$java_awt_Component$Z(c, true);
if (top == null ) {
return null;
...
var top=$I$(7).getTopInvokableAncestor$java_awt_Component$Z(mb, true);
if (top == null ) {
return;
}var keyMap=this.containerMap.get$O(top);
if (keyMap != null ) {
...
;Clazz.setTVer('3.2.4.07');//Created 2019-04-18 22:59:20 Java2ScriptVisitor version 3.2.4.07 net.sf.j2s.core.jar version 3.2.4.07
