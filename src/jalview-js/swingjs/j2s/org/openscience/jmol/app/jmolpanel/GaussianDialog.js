...
this.basisBox=null;
this.dfBox=null;
this.procSpinner=null;
this.chargeSpinner=null;
this.multSpinner=null;
...
this.container=Clazz.new_($I$(2));
this.container.setLayout$java_awt_LayoutManager(Clazz.new_($I$(3)));
...
var splitPane=Clazz.new_($I$(4).c$$I$java_awt_Component$java_awt_Component,[1, basicPanel, advancedPanel]);
...
var showPanel=Clazz.new_($I$(2).c$$java_awt_LayoutManager,[Clazz.new_($I$(3))]);
var linkPanel=Clazz.new_($I$(2).c$$java_awt_LayoutManager,[Clazz.new_($I$(3))]);
var linkTitle=$I$(5).createTitledBorder$S("link0 Section");
linkPanel.setBorder$javax_swing_border_Border(linkTitle);
var linkLabels=Clazz.new_($I$(2).c$$java_awt_LayoutManager,[Clazz.new_($I$(6).c$$I$I,[3, 1])]);
var linkControls=Clazz.new_($I$(2).c$$java_awt_LayoutManager,[Clazz.new_($I$(6).c$$I$I,[3, 1])]);
var checkLabel=Clazz.new_($I$(7).c$$S,[$I$(1).$$S("Checkpoint File: ")]);
linkLabels.add$java_awt_Component(checkLabel);
this.checkField=Clazz.new_($I$(8).c$$I,[20]);
linkControls.add$java_awt_Component(this.checkField);
this.checkField.addActionListener$java_awt_event_ActionListener(this);
var memLabel=Clazz.new_($I$(7).c$$S,[$I$(1).$$S("Memory:")]);
linkLabels.add$java_awt_Component(memLabel);
this.memBox=Clazz.new_($I$(9).c$$TEA,[C$.MEMORY_LIST]);
...
var procLabel=Clazz.new_($I$(7).c$$S,[$I$(1).$$S("Processors:")]);
linkLabels.add$java_awt_Component(procLabel);
var procModel=Clazz.new_($I$(10).c$$I$I$I$I,[1, 1, 16, 1]);
this.procSpinner=Clazz.new_($I$(11).c$$javax_swing_SpinnerModel,[procModel]);
this.procSpinner.setEditor$javax_swing_JComponent(Clazz.new_($I$(12).c$$javax_swing_JSpinner$S,[this.procSpinner, "#"]));
...
var routePanel=Clazz.new_($I$(2).c$$java_awt_LayoutManager,[Clazz.new_($I$(3))]);
var routeTitle=$I$(5).createTitledBorder$S($I$(1).$$S("Route"));
routePanel.setBorder$javax_swing_border_Border(routeTitle);
var routeLabels=Clazz.new_($I$(2).c$$java_awt_LayoutManager,[Clazz.new_($I$(6).c$$I$I,[4, 1])]);
var routeControls=Clazz.new_($I$(2).c$$java_awt_LayoutManager,[Clazz.new_($I$(6).c$$I$I,[4, 1])]);
var methLabel=Clazz.new_($I$(7).c$$S,[$I$(1).$$S("Method: ")]);
routeLabels.add$java_awt_Component(methLabel);
this.methBox=Clazz.new_($I$(9).c$$TEA,[C$.METHOD_LIST]);
...
var basisLabel=Clazz.new_($I$(7).c$$S,[$I$(1).$$S("Basis Set: ")]);
routeLabels.add$java_awt_Component(basisLabel);
this.basisBox=Clazz.new_($I$(9).c$$TEA,[C$.BASIS_LIST]);
...
var dfLabel=Clazz.new_($I$(7).c$$S,[$I$(1).$$S("DFT Density Fit: ")]);
routeLabels.add$java_awt_Component(dfLabel);
this.dfBox=Clazz.new_($I$(9).c$$TEA,[C$.DF_LIST]);
...
var optsLabel=Clazz.new_($I$(7).c$$S,[$I$(1).$$S("Job Options: ")]);
routeLabels.add$java_awt_Component(optsLabel);
this.optsField=Clazz.new_($I$(8).c$$I,[20]);
...
var molPanel=Clazz.new_($I$(2).c$$java_awt_LayoutManager,[Clazz.new_($I$(3))]);
var molTitle=$I$(5).createTitledBorder$S($I$(1).$$S("Molecular Properties"));
molPanel.setBorder$javax_swing_border_Border(molTitle);
var molLabels=Clazz.new_($I$(2).c$$java_awt_LayoutManager,[Clazz.new_($I$(6).c$$I$I,[3, 1])]);
var molControls=Clazz.new_($I$(2).c$$java_awt_LayoutManager,[Clazz.new_($I$(6).c$$I$I,[3, 1])]);
var chargeLabel=Clazz.new_($I$(7).c$$S,[$I$(1).$$S("Total Charge: ")]);
molLabels.add$java_awt_Component(chargeLabel);
var chargeModel=Clazz.new_($I$(10).c$$I$I$I$I,[0, -10, 10, 1]);
this.chargeSpinner=Clazz.new_($I$(11).c$$javax_swing_SpinnerModel,[chargeModel]);
this.chargeSpinner.setEditor$javax_swing_JComponent(Clazz.new_($I$(12).c$$javax_swing_JSpinner$S,[this.chargeSpinner, "#"]));
...
var multLabel=Clazz.new_($I$(7).c$$S,[$I$(1).$$S("Multiplicity: ")]);
molLabels.add$java_awt_Component(multLabel);
var multModel=Clazz.new_($I$(10).c$$I$I$I$I,[1, 0, 10, 1]);
this.multSpinner=Clazz.new_($I$(11).c$$javax_swing_SpinnerModel,[multModel]);
this.multSpinner.setEditor$javax_swing_JComponent(Clazz.new_($I$(12).c$$javax_swing_JSpinner$S,[this.multSpinner, "#"]));
...
var editPanel=Clazz.new_($I$(2).c$$java_awt_LayoutManager,[Clazz.new_($I$(3))]);
var editTitle=$I$(5).createTitledBorder$S("Edit Gaussian Input File");
editPanel.setBorder$javax_swing_border_Border(editTitle);
this.editArea=Clazz.new_($I$(13));
this.editArea.setContentType$S("text/html");
this.editArea.setFont$java_awt_Font(Clazz.new_($I$(14).c$$S$I$I,["Monospaced", 0, 8]));
this.editArea.addMouseListener$java_awt_event_MouseListener(this);
this.editPane=Clazz.new_($I$(15).c$$java_awt_Component,[this.editArea]);
this.editPane.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(16).c$$I$I,[150, 100]));
editPanel.add$java_awt_Component$O(this.editPane, "Center");
return editPanel;
}, p$1);

Clazz.newMeth(C$, 'buildFilePanel', function () {
var showPanel=Clazz.new_($I$(2).c$$java_awt_LayoutManager,[Clazz.new_($I$(17).c$$I,[2])]);
...
this.fileField=Clazz.new_($I$(8).c$$I,[30]);
showPanel.add$java_awt_Component(this.fileField);
this.fileField.setText$S(Clazz.new_($I$(18).c$$S,["my_input.com"]).getAbsolutePath$());
this.fileButton=Clazz.new_($I$(19).c$$S,[$I$(1).$$S("File...")]);
...
var buttonPanel=Clazz.new_($I$(2));
buttonPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(17).c$$I,[2]));
var selectLabel=Clazz.new_($I$(7).c$$S,[$I$(1).$$S("Selection: ")]);
buttonPanel.add$java_awt_Component(selectLabel);
this.selectField=Clazz.new_($I$(8).c$$I,[20]);
...
this.refreshButton=Clazz.new_($I$(19).c$$S,[$I$(1).$$S("Refresh")]);
...
}var outputFile=Clazz.new_($I$(18).c$$S,[this.fileField.getText$()]);
this.fileField.setText$S(outputFile.getAbsolutePath$());
output=Clazz.new_($I$(20).c$$java_io_Writer,[Clazz.new_($I$(21).c$$java_io_File,[outputFile])]);
...
this.fileChooser=Clazz.new_($I$(22));
var fname=this.fileField.getText$();
this.fileChooser.setSelectedFile$java_io_File(Clazz.new_($I$(18).c$$S,[fname]));
...
(function(){var C$=Clazz.newClass(P$, "GaussianDialog$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
(function(){var C$=Clazz.newClass(P$, "GaussianDialog$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
