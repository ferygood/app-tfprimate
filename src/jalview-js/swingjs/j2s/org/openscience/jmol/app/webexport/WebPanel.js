...
var C$=Clazz.newClass(P$, "WebPanel", function(){
...
this.panelName=null;
this.htmlAppletTemplate=null;
this.listLabel=null;
this.appletInfoDivs=null;
this.appletSizeSpinnerW=null;
this.appletSizeSpinnerH=null;
this.appletSizeSpinnerP=null;
this.editorScrollPane=null;
this.saveButton=null;
this.viewButton=null;
this.helpButton=null;
this.addInstanceButton=null;
this.deleteInstanceButton=null;
this.showInstanceButton=null;
this.remoteAppletPath=null;
this.localAppletPath=null;
this.pageAuthorName=null;
this.webPageTitle=null;
this.fc=null;
this.instanceList=null;
this.theWidgets=null;
this.nWidgets=0;
this.widgetCheckboxes=null;
this.vwr=null;
this.panelIndex=0;
this.webPanels=null;
this.errCount=0;
...
this.localAppletPath=Clazz.new_($I$(3).c$$I,[20]);
...
this.pageAuthorName=Clazz.new_($I$(3).c$$I,[20]);
...
this.webPageTitle=Clazz.new_($I$(3).c$$I,[20]);
...
this.instanceList=Clazz.new_($I$(6).c$$javax_swing_ListModel,[Clazz.new_($I$(7))]);
this.instanceList.setSelectionMode$I(1);
this.instanceList.setTransferHandler$javax_swing_TransferHandler(Clazz.new_($I$(8).c$$org_openscience_jmol_app_webexport_WebPanel,[this]));
this.instanceList.setCellRenderer$javax_swing_ListCellRenderer(Clazz.new_($I$(9), [this, null]));
this.instanceList.setDragEnabled$Z(true);
this.instanceList.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(10).c$$I$I,[350, 200]));
this.instanceList.addListSelectionListener$javax_swing_event_ListSelectionListener(this);
var instanceListView=Clazz.new_($I$(11).c$$java_awt_Component,[this.instanceList]);
instanceListView.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(10).c$$I$I,[350, 200]));
var instanceSet=Clazz.new_($I$(12));
instanceSet.setLayout$java_awt_LayoutManager(Clazz.new_($I$(13)));
instanceSet.add$java_awt_Component$O(Clazz.new_($I$(14).c$$S,[this.listLabel]), "North");
instanceSet.add$java_awt_Component$O(instanceListView, "Center");
instanceSet.add$java_awt_Component$O(Clazz.new_($I$(14).c$$S,[$I$(5).$$S("click and drag to reorder")]), "South");
this.addInstanceButton=Clazz.new_($I$(15).c$$S,[$I$(5).$$S("Add present Jmol state as instance...")]);
this.addInstanceButton.addActionListener$java_awt_event_ActionListener(this);
var buttonPanel=Clazz.new_($I$(12));
buttonPanel.setMaximumSize$java_awt_Dimension(Clazz.new_($I$(10).c$$I$I,[350, 50]));
this.deleteInstanceButton=Clazz.new_($I$(15).c$$S,[$I$(5).$$S("Delete selected")]);
...
paramPanel.setMaximumSize$java_awt_Dimension(Clazz.new_($I$(10).c$$I$I,[350, 70]));
var instanceButtonPanel=Clazz.new_($I$(12));
...
p.setLayout$java_awt_LayoutManager(Clazz.new_($I$(13)));
p.add$java_awt_Component$O(instanceButtonPanel, "North");
p.add$java_awt_Component$O(buttonPanel, "South");
var instancePanel=Clazz.new_($I$(12));
instancePanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(13)));
instancePanel.add$java_awt_Component$O(instanceSet, "Center");
instancePanel.add$java_awt_Component$O(p, "South");
var rightPanel=Clazz.new_($I$(12));
rightPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(13)));
rightPanel.setMinimumSize$java_awt_Dimension(Clazz.new_($I$(10).c$$I$I,[350, 350]));
rightPanel.setMaximumSize$java_awt_Dimension(Clazz.new_($I$(10).c$$I$I,[350, 1000]));
rightPanel.add$java_awt_Component$O(paramPanel, "North");
rightPanel.add$java_awt_Component$O(instancePanel, "Center");
rightPanel.setBorder$javax_swing_border_Border($I$(16).createTitledBorder$S($I$(5).$$S("JSmol Instances:")));
var widgetPanel=Clazz.new_($I$(12));
widgetPanel.setMinimumSize$java_awt_Dimension(Clazz.new_($I$(10).c$$I$I,[150, 150]));
widgetPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(17).c$$java_awt_Container$I,[widgetPanel, 1]));
widgetPanel.setBorder$javax_swing_border_Border($I$(16).createTitledBorder$S($I$(5).$$S("Select widgets:")));
for (var i=0; i < this.nWidgets; i++) {
this.widgetCheckboxes[i]=Clazz.new_($I$(2).c$$S,[this.theWidgets.widgetList[i].name]);
...
var panel=Clazz.new_($I$(12));
panel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(13)));
var leftPanel=p$1.getLeftPanel$I$I.apply(this, [infoWidth, infoHeight]);
leftPanel.setMaximumSize$java_awt_Dimension(Clazz.new_($I$(10).c$$I$I,[350, 1000]));
...
this.helpButton=Clazz.new_($I$(15).c$$S,[$I$(5).$$S("Help/Instructions")]);
...
var pageImage=null;
if (pageCartoon != null ) {
pageImage=Clazz.new_($I$(19).c$$java_net_URL$S,[pageCartoon, $I$(5).$$S("Cartoon of Page")]);
} else {
System.err.println$S("Error Loading Page Cartoon Image " + templateImage);
}var pageCartoonLabel=Clazz.new_($I$(14).c$$javax_swing_Icon,[pageImage]);
var pageCartoonPanel=Clazz.new_($I$(12));
pageCartoonPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(13)));
pageCartoonPanel.setBorder$javax_swing_border_Border($I$(16).createTitledBorder$S($I$(5).$$S("Cartoon of Page") + ":"));
pageCartoonPanel.add$java_awt_Component(pageCartoonLabel);
this.saveButton=Clazz.new_($I$(15).c$$S,[$I$(5).$$S("Save HTML as...")]);
this.saveButton.addActionListener$java_awt_event_ActionListener(this);
this.viewButton=Clazz.new_($I$(15).c$$S,[$I$(5).$$S("View HTML")]);
this.viewButton.addActionListener$java_awt_event_ActionListener(this);
var savePanel=Clazz.new_($I$(12));
savePanel.add$java_awt_Component(this.saveButton);
savePanel.add$java_awt_Component(this.viewButton);
var pathPanel=Clazz.new_($I$(12));
pathPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(13)));
pathPanel.setBorder$javax_swing_border_Border($I$(16).createTitledBorder$S($I$(5).$$S("Relative server path to JSmol.min.js:")));
pathPanel.add$java_awt_Component$O(this.remoteAppletPath, "North");
var pathPanel2=Clazz.new_($I$(12));
pathPanel2.setLayout$java_awt_LayoutManager(Clazz.new_($I$(13)));
pathPanel2.setBorder$javax_swing_border_Border($I$(16).createTitledBorder$S($I$(5).$$S("Relative local path to JSmol.min.js:")));
pathPanel2.add$java_awt_Component$O(this.localAppletPath, "North");
var authorPanel=Clazz.new_($I$(12));
authorPanel.setBorder$javax_swing_border_Border($I$(16).createTitledBorder$S($I$(5).$$S("Author (your name):")));
authorPanel.add$java_awt_Component$O(this.pageAuthorName, "North");
var titlePanel=Clazz.new_($I$(12));
titlePanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(13)));
titlePanel.setBorder$javax_swing_border_Border($I$(16).createTitledBorder$S($I$(5).$$S("Browser window title for this web page:")));
titlePanel.add$java_awt_Component$O(this.webPageTitle, "North");
titlePanel.add$java_awt_Component$O(savePanel, "South");
var pathPanels=Clazz.new_($I$(12));
pathPanels.setLayout$java_awt_LayoutManager(Clazz.new_($I$(13)));
pathPanels.add$java_awt_Component$O(pathPanel, "North");
pathPanels.add$java_awt_Component$O(pathPanel2, "South");
var settingsPanel=Clazz.new_($I$(12));
settingsPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(13)));
...
var leftpanel=Clazz.new_($I$(12));
leftpanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(13)));
...
var webExportHelp=Clazz.new_($I$(20).c$$javax_swing_JFrame$java_net_URL,[$I$(4).getFrame$(), $I$(18).getHtmlResource$O$S(this, this.panelName + "_instructions")]);
...
var name=$I$(21).showInputDialog$O$O($I$(5).$$S("Give the occurrence of JSmol a name:"), label);
...
if (instance == null ) {
$I$(23).log$S($I$(5).$$S("Error creating new instance containing script(s) and image."));
return;
}var i;
...
if (i < 0) {
i=listModel.getSize$();
listModel.addElement$TE(instance);
$I$(23).log$S($I$(5).o$S$O(m, instance.name));
} else {
listModel.setElementAt$TE$I(instance, i);
$I$(23).log$S($I$(5).o$S$O(m, instance.name));
...
if (retVal != null ) {
$I$(23).log$S($I$(5).o$S$O($I$(5).$$S("file {0} created"), retVal));
} else {
$I$(23).log$S($I$(5).$$S("Call to FileWriter unsuccessful."));
this.errCount+=1;
}if (this.errCount > 0) {
$I$(23).log$S($I$(5).$$S("Errors occurred during web page creation.  See Log Tab!"));
}return;
}});
...
var f=Clazz.new_($I$(24).c$$S,[datadirPath + ".html"]);
if (f.exists$()) {
datadirName += ".html";
file=f;
} else if ((f=Clazz.new_($I$(24).c$$S,[datadirPath + ".htm"])).exists$()) {
datadirName += ".htm";
file=f;
}}if (datadirName.indexOf$S(".htm") > 0) {
fileName=datadirName;
datadirPath=file.getParent$();
file=Clazz.new_($I$(24).c$$S,[datadirPath]);
...
$I$(23).log$S("");
if (made_datadir) {
$I$(23).log$S($I$(5).o$S$O($I$(5).$$S("Using directory {0}"), datadirPath));
$I$(23).log$S("  " + $I$(5).o$S$O($I$(5).$$S("adding {0}"), "support.js"));
try {
...
$I$(23).log$S("      ..." + $I$(5).o$S$O($I$(5).$$S("adding {0}"), javaname + ".png"));
try {
...
var filesToCopy=Clazz.new_($I$(25));
...
filesToCopy.addLast$TV(jmolJarDirPath + "/jsmol.zip");
} catch (e) {
if (Clazz.exceptionOf(e,"java.io.UnsupportedEncodingException")){
$I$(23).log$S($I$(5).$$S("There was an error in the text encoding so the path to jsmol.zip is unknown."));
} else {
throw e;
}
}
}$I$(26).getFileReferences$S$javajs_util_Lst(script, filesToCopy);
var copiedFileNames=Clazz.new_($I$(27));
...
copiedFileNames.add$TE(newName.substring$I(newName.lastIndexOf$I("/") + 1));
}
script=C$.replaceQuotedStrings$S$java_util_ArrayList$java_util_ArrayList(script, filesToCopy, copiedFileNames);
$I$(23).log$S("      ..." + $I$(5).o$S$O($I$(5).$$S("adding {0}"), javaname + ".spt"));
...
$I$(23).log$S("  " + $I$(5).o$S$O($I$(5).$$S("adding {0}"), scriptFileName));
...
if (fileURL == null ) {
$I$(23).log$S("    " + $I$(5).o$S$O($I$(5).$$S("Unable to load resource {0}"), inFile));
this.errCount+=1;
} else {
var is=fileURL.openConnection$().getInputStream$();
var os=Clazz.new_($I$(28).c$$S,[datadirPath + "/" + outFile ]);
var temp=is.read$();
while (temp != -1){
os.write$I(temp);
temp=is.read$();
...
os.flush$();
os.close$();
$I$(23).log$S("  " + $I$(5).o$S$O($I$(5).$$S("adding {0}"), outFile));
}}
}}}
html=$I$(29).rep$S$S$S(html, "@WIDGETJSFILES@", jsStr);
this.appletInfoDivs="";
var appletDefs=Clazz.new_($I$(30));
...
html=$I$(29).rep$S$S$S(html, "@AUTHOR@", $I$(5).escapeHTML$S(this.pageAuthorName.getText$()));
html=$I$(29).rep$S$S$S(html, "@TITLE@", $I$(5).escapeHTML$S(this.webPageTitle.getText$()));
html=$I$(29).rep$S$S$S(html, "@REMOTEAPPLETPATH@", this.remoteAppletPath.getText$());
var localPath=this.localAppletPath.getText$();
...
html=$I$(29).rep$S$S$S(html, "@CREATIONDATA@", $I$(5).escapeHTML$S($I$(4).TimeStamp_WebLink$()));
html=$I$(29).rep$S$S$S(html, "@AUTHORDATA@", $I$(5).escapeHTML$S($I$(5).$$S("Based on a template by A. Herr&#x00E1;ez and J. Gutow")));
html=$I$(29).rep$S$S$S(html, "@LOGDATA@", "<pre>\n" + $I$(23).getText$() + "\n</pre>\n" );
$I$(23).log$S("      ..." + $I$(5).o$S$O($I$(5).$$S("creating {0}"), fileName));
...
$I$(23).log$S($I$(5).o$S$O($I$(5).$$S("copying and unzipping jsmol.zip directory into {0}"), dataPath));
var tempDP=p$1.copyandUnzip$S$S$S.apply(this, [fullPathName, dataPath, name]);
return (tempDP);
}name=dataPath + "/" + name ;
var gzname=name + ".gz";
var outFile=Clazz.new_($I$(24).c$$S,[name]);
var gzoutFile=Clazz.new_($I$(24).c$$S,[gzname]);
...
if (!retName[0].equals$O(name)) $I$(23).log$S("      ..." + $I$(5).$$S("compressing large data file to") + "\n" + (name=retName[0]) );
$I$(23).log$S(name);
if (err != null ) {
$I$(23).log$S(err);
this.errCount+=1;
...
retName[0] += ".gz";
var gzFile=Clazz.new_($I$(32).c$$java_io_OutputStream,[Clazz.new_($I$(28).c$$S,[retName[0]])]);
gzFile.write$BA(data);
gzFile.flush$();
gzFile.close$();
} else {
var os=Clazz.new_($I$(28).c$$S,[retName[0]]);
os.write$BA(data);
os.flush$();
os.close$();
}} catch (e) {
...
var zipFile=null;
try {
zipFile=Clazz.new_($I$(33).c$$S,[fullPathName]);
...
f=Clazz.new_($I$(24).c$$S,[dataPath + $I$(24).separator + entry.getName$() ]);
...
f.createNewFile$();
fos=Clazz.new_($I$(28).c$$java_io_File,[f]);
var bytesRead=0;
...
if (Clazz.exceptionOf(e,"java.io.IOException")){
$I$(23).log$S($I$(5).$$S("Error encountered while openning zip file. You may not have\n" + "a complete copy of the Jmol distribution.  Check for the file jsmol.zip.\n" + e.getMessage$() ));
this.errCount+=1;
} else {
throw e;
}
...
pathStr=$I$(35).decode$S$S(jarURL.toString(), System.getProperty$S("file.encoding"));
...
for (var i=0; i < n; i++) model2.addElement$TE(model1.get$I(i));
...
;
(function(){var C$=Clazz.newClass(P$.WebPanel, "InstanceCellRenderer", function(){
