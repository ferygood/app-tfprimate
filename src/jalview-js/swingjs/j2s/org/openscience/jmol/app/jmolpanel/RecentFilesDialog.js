(function(){var P$=Clazz.newPackage("org.openscience.jmol.app.jmolpanel"),p$1={},I$=[[0,'org.jmol.i18n.GT','java.util.Properties','java.awt.BorderLayout','javax.swing.JPanel','javax.swing.JList','java.awt.event.MouseAdapter','javax.swing.JButton','org.openscience.jmol.app.jmolpanel.JmolPanel']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "RecentFilesDialog", null, 'javax.swing.JDialog', ['java.awt.event.ActionListener', 'java.awt.event.WindowListener']);
...
C$.superclazz.c$$java_awt_Frame$S$Z.apply(this, [boss, $I$(1).$$S("Recent Files"), true]);
C$.$init$.apply(this);
this.props=Clazz.new_($I$(2));
p$1.getFiles.apply(this, []);
this.getContentPane$().setLayout$java_awt_LayoutManager(Clazz.new_($I$(3)));
...
this.fileList=Clazz.new_($I$(5).c$$TEA,[this.files]);
this.fileList.setSelectedIndex$I(0);
this.fileList.setSelectionMode$I(0);
var dblClickListener=((P$.RecentFilesDialog$1||
(function(){var C$=Clazz.newClass(P$, "RecentFilesDialog$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.MouseAdapter'), null, 1);
...
), Clazz.new_($I$(6), [this, null],P$.RecentFilesDialog$1));
...
var btn=Clazz.new_($I$(7).c$$S,[label]);
...
if ($I$(8).historyFile != null ) this.props=$I$(8).historyFile.getProperties$();
for (var i=0; i < 10; i++) {
...
this.files[0]=name;
this.fileList.setListData$TEA(this.files);
this.fileList.setSelectedIndex$I(0);
this.pack$();
this.saveList$();
});
...
$I$(8).addJmolProperties$java_util_Properties(this.props);
});
