(function(){var P$=Clazz.newPackage("org.jmol.util"),I$=[[0,'javajs.util.BS','org.jmol.util.Logger','java.util.Hashtable','javajs.util.PT']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "Elements");
C$.elementSymbols=null;
C$.atomicMass=null;
C$.isotopeMass=null;
C$.elementNumberMax=0;
C$.htElementMap=null;
C$.elementNames=null;
C$.altElementNumbers=null;
C$.altElementMax=0;
C$.altElementSymbols=null;
C$.altElementNames=null;
C$.vanderwaalsMars=null;
C$.covalentVersion=0;
C$.bondingVersion=0;
C$.defaultBondingMars=null;
C$.cationLookupTable=null;
C$.anionLookupTable=null;
C$.bsCations=null;
C$.bsAnions=null;
C$.hydrophobicities=null;
C$.electroNegativities=null;
...
C$.bsCations=Clazz.new_($I$(1));
C$.bsAnions=Clazz.new_($I$(1));
{
...
map.put$TK$TV(symbol, boxed);
if (symbol.length$() == 2) map.put$TK$TV(symbol.toUpperCase$(), boxed);
}
...
C$.htElementMap.put$TK$TV(elementSymbol.toUpperCase$(), Integer.valueOf$I(isotope));
return isotope;
