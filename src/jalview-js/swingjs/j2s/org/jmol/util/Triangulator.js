(function(){var P$=Clazz.newPackage("org.jmol.util"),I$=[[0,'javajs.util.Lst','javajs.util.P3','org.jmol.util.TriangleData','javajs.util.BS','javajs.util.AU']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "Triangulator", null, 'org.jmol.util.TriangleData');
C$.fullCubePolygon=null;
...
if ((flags & 1) == 1) v.addLast$TV(Clazz.array($I$(2), -1, [pt1, pt2, pt3]));
if ((flags & 2) == 2) {
var b=($b$[0] = triangles[i], $b$[0]);
if ((b & 1) == 1) v.addLast$TV(Clazz.array($I$(2), -1, [pt1, pt2]));
if ((b & 2) == 2) v.addLast$TV(Clazz.array($I$(2), -1, [pt2, pt3]));
if ((b & 4) == 4) v.addLast$TV(Clazz.array($I$(2), -1, [pt1, pt3]));
}}
return v;
});
