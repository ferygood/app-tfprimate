...
var C$=Clazz.newClass(P$, "CalculationsUFF", null, 'org.jmol.minimize.forcefield.Calculations');
...
this.torsionCalc=Clazz.new_($I$(3)).set$org_jmol_minimize_forcefield_Calculations(this);
this.oopCalc=Clazz.new_($I$(4)).set$org_jmol_minimize_forcefield_Calculations(this);
this.vdwCalc=Clazz.new_($I$(5)).set$org_jmol_minimize_forcefield_Calculations(this);
}, 1);
...
calc=this.calculations[0]=Clazz.new_($I$(6));
...
calc=this.calculations[1]=Clazz.new_($I$(6));
...
calc=this.calculations[3]=Clazz.new_($I$(6));
var torsionCalc=Clazz.new_($I$(3)).set$org_jmol_minimize_forcefield_Calculations(this);
for (var i=this.minTorsions.length; --i >= 0; ) torsionCalc.setData$javajs_util_Lst$IA(calc, this.minTorsions[i].data);

calc=this.calculations[4]=Clazz.new_($I$(6));
var oopCalc=Clazz.new_($I$(4)).set$org_jmol_minimize_forcefield_Calculations(this);
var elemNo;
...
this.pairSearch$javajs_util_Lst$org_jmol_minimize_forcefield_Calculation$javajs_util_Lst$org_jmol_minimize_forcefield_Calculation(this.calculations[5]=Clazz.new_($I$(6)), Clazz.new_($I$(5)).set$org_jmol_minimize_forcefield_Calculations(this), null, null);
return true;
});
