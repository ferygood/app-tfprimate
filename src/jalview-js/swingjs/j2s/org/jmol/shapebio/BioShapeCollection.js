(function(){var P$=Clazz.newPackage("org.jmol.shapebio"),I$=[[0,'javajs.util.AU','org.jmol.c.PAL','org.jmol.util.C','java.util.Hashtable','org.jmol.viewer.JC','org.jmol.shapebio.BioShape','org.jmol.util.BSUtil']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "BioShapeCollection", null, 'org.jmol.shape.Shape');
...
this.atoms=null;
this.madOn=0;
this.madHelixSheet=0;
this.madTurnRandom=0;
this.madDnaRna=0;
this.isActive=false;
this.bioShapes=null;
}, 1);
...
var pid=($b$[0] = $I$(2).pidOf$O(value), $b$[0]);
var colix=$I$(3).getColixO$O(value);
for (var i=this.bioShapes.length; --i >= 0; ) {
var bioShape=this.bioShapes[i];
if (bioShape.monomerCount > 0) bioShape.setColixBS$H$B$javajs_util_BS(colix, ($b$[0] = pid, $b$[0]), bsSelected);
}
return;
...
bioShape.setColixBS$H$B$javajs_util_BS(colix, ($b$[0] = 64, $b$[0]), bsSelected);
...
var temp=Clazz.new_($I$(4));
var temp2=Clazz.new_($I$(4));
...
shapes[n]=(this.bioShapes == null  || this.bioShapes.length <= n  || this.bioShapes[n] == null   || this.bioShapes[n].bioPolymer !== bp   ? Clazz.new_($I$(6).c$$org_jmol_shapebio_BioShapeCollection$I$org_jmol_modelsetbio_BioPolymer,[this, i, bp]) : this.bioShapes[n]);
}
