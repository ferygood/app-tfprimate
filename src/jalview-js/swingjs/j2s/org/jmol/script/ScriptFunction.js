(function(){var P$=Clazz.newPackage("org.jmol.script"),p$1={},I$=[[0,'javajs.util.Lst','java.util.Hashtable','org.jmol.script.T','org.jmol.script.SV','javajs.util.AU','javajs.util.SB']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "ScriptFunction", null, null, 'org.jmol.api.JmolScriptFunction');
...
contextVariables.put$TK$TV(name, ($var == null  ? $I$(4).newS$S("").setName$S(name) : $var));
}
if (this.tok != 364558) {
contextVariables.put$TK$TV("_argcount", $I$(4).newI$I(params == null  ? 0 : params.size$()));
contextVariables.put$TK$TV("_arguments", (params == null  ? $I$(4).getVariableAI$IA(Clazz.array(Integer.TYPE, -1, [])) : $I$(4).getVariableList$javajs_util_Lst(params)));
}contextVariables.put$TK$TV("_retval", $I$(4).newI$I(this.tok == 364558 ? 2147483647 : 0));
});
...
this.variables.put$TK$TV(name, name);
this.names.addLast$TV(name);
...
var s=Clazz.new_($I$(6)).append$S(this.typeName).append$S(" ").append$S(this.name).append$S("(");
