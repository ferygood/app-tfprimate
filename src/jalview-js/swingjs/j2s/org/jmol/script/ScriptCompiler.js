...
this.errorMessage=$I$(23).$$S("script compiler ERROR: ") + this.errorMessage + $I$(24).getErrorLineMessage$S$S$I$I$S(null, this.filename, this.lineCurrent, this.iCommand, lineInfo) ;
if (!this.isSilent) {
