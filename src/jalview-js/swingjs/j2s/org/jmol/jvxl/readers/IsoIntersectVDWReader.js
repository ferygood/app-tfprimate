...
var C$=Clazz.newClass(P$, "IsoIntersectVDWReader", null, 'org.jmol.jvxl.readers.AtomDataReader');
...
this.myBsA=Clazz.new_(Clazz.load('javajs.util.BS'));
...
var v=this.getValueAB$F$F(va, vb);
...
return this.getValueAB$F$F(p$1.getValueAtPoint2$javajs_util_T3$javajs_util_BS.apply(this, [pt, this.myBsA]), p$1.getValueAtPoint2$javajs_util_T3$javajs_util_BS.apply(this, [pt, this.myBsB]));
});
...
;Clazz.setTVer('3.2.2.04');//Created 2018-09-01 22:46:16 Java2ScriptVisitor version 3.2.2.04 net.sf.j2s.core.jar version 3.2.2.04
