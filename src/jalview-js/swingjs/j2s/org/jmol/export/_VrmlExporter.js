...
this.tempQ1=Clazz.new_($I$(2));
this.tempQ2=Clazz.new_($I$(2));
this.tempQ3=Clazz.new_($I$(2));
}, 1);

Clazz.newMeth(C$, 'c$', function () {
Clazz.super_(C$, this,1);
this.useTable=Clazz.new_($I$(3).c$$S,["USE "]);
this.commentChar="# ";
...
this.output$S(P$.___Exporter.round$javajs_util_T3(pt));
});

Clazz.newMeth(C$, 'outputHeader$', function () {
this.output$S("#VRML V2.0 utf8 Generated by Jmol " + $I$(4).getJmolVersion$() + "\n" );
this.output$S("WorldInfo { \n");
this.output$S(" title " + $I$(5).esc$S(this.vwr.ms.modelSetName) + "\n" );
this.output$S(" info [ \"Generated by Jmol " + $I$(4).getJmolVersion$() + " \", \n" );
...
this.outputRotation$javajs_util_A4($I$(6).newVA$javajs_util_V3$F(this.tempV2, 3.1415927));
});
...
var a=$I$(7).getQuaternionFrame$javajs_util_P3$javajs_util_T3$javajs_util_T3(ptCenter, this.tempQ1, this.tempQ2).toAxisAngle4f$();
...
var faces=$I$(8).newInt2$I(n * (addBase ? 2 : 1));
...
this.outputCylinderChildScaled$H$B(colix, ($b$[0] = endcaps, $b$[0]));
this.popMatrix$();
...
var faces=$I$(8).newInt2$I(n * (addEndcaps ? 4 : 2));
for (var i=0, fpt=0; i < n; i++) {
...
var check=P$.___Exporter.round$javajs_util_T3(ptCenter) + (checkRadius ? " " + ((radius * 100)|0) : "");
if (this.htSpheresRendered.get$O(check) != null ) return;
this.htSpheresRendered.put$TK$TV(check, $I$(9).TRUE);
...
for (var i=0; i < 6; i++) this.plateVertices[i]=Clazz.new_($I$(2));
...
this.outputAttrPt$S$javajs_util_T3("translation", this.tempP1);
p$1.setFont$H$S$javajs_awt_Font.apply(this, [colix, text, font3d]);
this.outputChildStart$();
...
}this.output$S(" string " + $I$(5).esc$S(text) + "}" );
...
Clazz.newMeth(C$, 'setFont$H$S$javajs_awt_Font', function (colix, text, font3d) {
