(function(){var P$=Clazz.newPackage("org.jmol.adapter.readers.xtal"),p$1={},I$=[[0,'javajs.util.V3','javajs.util.Lst','org.jmol.util.Logger','javajs.util.PT','java.util.Hashtable','javajs.util.P3','javajs.util.M3','org.jmol.adapter.smarter.Bond']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "CgdReader", null, 'org.jmol.adapter.smarter.AtomSetCollectionReader');
C$.vecs=null;
...
if (this.edgeData == null ) this.edgeData=Clazz.new_($I$(2));
this.edgeData.addLast$TV(this.line);
break;
}
}return true;
});
...
this.asc.atomSymbolicMap.put$TK$TV(name, a);
this.asc.addVibrationVector$I$F$F$F(a.index, 1.0, 3.0, 7.0);
if (this.htEdges == null ) this.htEdges=Clazz.new_($I$(5));
this.htEdges.put$TK$TV(a, Clazz.array($I$(1), [edgeCount]));
}, p$1);
...
if (b != null ) this.asc.addBond$org_jmol_adapter_smarter_Bond(Clazz.new_($I$(8).c$$I$I$I,[a.index, b.index, 1]));
