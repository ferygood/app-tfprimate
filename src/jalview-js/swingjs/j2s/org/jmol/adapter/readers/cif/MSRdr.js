...
this.cr.asc.setInfo$S$O("someModelsAreModulated", $I$(7).TRUE);
...
this.cr.asc.setInfo$S$O("modulationOn", this.modTUV == null  ? $I$(7).TRUE : this.modTUV);
...
dim++;
case 48:
if (data.indexOf$S(".") >= 0) a=$I$(15).getTokensFloat$S$FA$I(data, null, dim);
break;
default:
return false;
}
