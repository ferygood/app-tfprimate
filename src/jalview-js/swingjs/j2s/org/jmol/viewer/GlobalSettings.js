...
return (v == null  && doSet  && name.charAt$I(0) != "_"  ? this.setUserVariable$S$org_jmol_script_SV(name, $I$(11).newV$I$O(4, "")) : $I$(11).getVariable$O(v));
});
...
return (asVariable ? v : $I$(11).oValue$O(v));
}return null;
});

Clazz.newMeth(C$, 'getVariableList$', function () {
return $I$(9).getVariableList$java_util_Map$I$Z$Z(this.htUserVariables, 0, true, false);
});
...
p$1.app$javajs_util_SB$S.apply(this, [str, "set appletProxy " + $I$(14).esc$S(this.appletProxy)]);
p$1.app$javajs_util_SB$S.apply(this, [str, "set applySymmetryToBonds " + this.applySymmetryToBonds]);
if (this.atomTypes.length$() > 0) p$1.app$javajs_util_SB$S.apply(this, [str, "set atomTypes " + $I$(14).esc$S(this.atomTypes)]);
...
p$1.app$javajs_util_SB$S.apply(this, [str, "set defaultLattice " + $I$(10).eP$javajs_util_T3(this.ptDefaultLattice)]);
p$1.app$javajs_util_SB$S.apply(this, [str, "set defaultLoadFilter " + $I$(14).esc$S(this.defaultLoadFilter)]);
...
p$1.app$javajs_util_SB$S.apply(this, [str, "#set defaultDirectory " + $I$(14).esc$S(this.defaultDirectory)]);
p$1.app$javajs_util_SB$S.apply(this, [str, "#set loadFormat " + $I$(14).esc$S(this.loadFormat)]);
p$1.app$javajs_util_SB$S.apply(this, [str, "#set loadLigandFormat " + $I$(14).esc$S(this.pdbLoadLigandFormat)]);
p$1.app$javajs_util_SB$S.apply(this, [str, "#set smilesUrlFormat " + $I$(14).esc$S(this.smilesUrlFormat)]);
p$1.app$javajs_util_SB$S.apply(this, [str, "#set nihResolverFormat " + $I$(14).esc$S(this.nihResolverFormat)]);
p$1.app$javajs_util_SB$S.apply(this, [str, "#set pubChemFormat " + $I$(14).esc$S(this.pubChemFormat)]);
...
p$1.app$javajs_util_SB$S.apply(this, [str, "set pdbAddHydrogens " + (htParams != null  && htParams.get$O("pdbNoHydrogens") !== $I$(8).TRUE   ? this.pdbAddHydrogens : false)]);
