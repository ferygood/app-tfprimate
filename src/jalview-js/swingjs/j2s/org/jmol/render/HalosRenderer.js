(function(){var P$=Clazz.newPackage("org.jmol.render"),I$=[[0,'org.jmol.util.C']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "HalosRenderer", null, 'org.jmol.render.ShapeRenderer');
