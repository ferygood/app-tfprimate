...
this.thisModel=null;
}this.meshes=$I$(4).deleteElements$O$I$I(this.meshes, i, 1);
continue;
...
str.append$S($I$(6).jvxlGetFile$org_jmol_jvxl_data_JvxlData$org_jmol_jvxl_data_MeshData$SA$S$Z$I$S$S(this.jvxlData, null, null, "TRAILERONLY", true, 0, null, null));
return str.toString();
...
if (this.moDebug) this.setPropI$S$O$javajs_util_BS("debug", $I$(3).TRUE, null);
...
if (this.moSquareData === $I$(3).TRUE  || this.moSquareLinear === $I$(3).TRUE  ) max=max * max;
