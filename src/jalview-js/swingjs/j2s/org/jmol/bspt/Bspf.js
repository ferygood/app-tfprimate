(function(){var P$=Clazz.newPackage("org.jmol.bspt"),I$=[[0,'org.jmol.bspt.Bspt','org.jmol.bspt.CubeIterator','javajs.util.AU']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "Bspf");
...
if (bspt == null ) {
bspt=this.bspts[bsptIndex]=Clazz.new_($I$(1).c$$I$I,[this.dimMax, bsptIndex]);
