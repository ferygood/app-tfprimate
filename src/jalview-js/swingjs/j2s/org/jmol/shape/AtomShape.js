(function(){var P$=Clazz.newPackage("org.jmol.shape"),I$=[[0,'javajs.util.AU','org.jmol.atomdata.RadiusData',['org.jmol.atomdata.RadiusData','.EnumType'],'javajs.util.BS','org.jmol.util.C','org.jmol.c.PAL','org.jmol.c.VDW','org.jmol.util.BSUtil']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "AtomShape", null, 'org.jmol.shape.Shape');
...
return;
}if (this.rd == null ) this.rd=Clazz.new_($I$(2).c$$FA$F$org_jmol_atomdata_RadiusData_EnumType$org_jmol_c_VDW,[null, size, $I$(3).SCREEN, null]);
...
for (var i=bs.nextSetBit$I(0); i >= 0 && i < n ; i=bs.nextSetBit$I(i + 1)) this.setColixAndPalette$H$B$I(colix, ($b$[0] = pid, $b$[0]), i);
...
var atrans=data[1];
var sizes=data[2];
var rd=Clazz.new_($I$(2).c$$FA$F$org_jmol_atomdata_RadiusData_EnumType$org_jmol_c_VDW,[null, 0, $I$(3).FACTOR, $I$(7).AUTO]);
if (this.bsColixSet == null ) this.bsColixSet=Clazz.new_($I$(4));
if (this.bsSizeSet == null ) this.bsSizeSet=Clazz.new_($I$(4));
...
this.setColixAndPalette$H$B$I(colix, ($b$[0] = $I$(6).UNKNOWN.id, $b$[0]), i);
...
this.colixes[atomIndex]=colix=this.getColixI$H$B$I(colix, ($b$[0] = paletteID, $b$[0]), atomIndex);
this.bsColixSet.setBitTo$I$Z(atomIndex, colix != 0 || this.shapeID == 0 );
this.paletteIDs[atomIndex]=(paletteID|0);
});
