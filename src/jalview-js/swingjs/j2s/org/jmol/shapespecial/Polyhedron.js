...
o=info.get$O("bsFlat");
this.bsFlat=(o == null  ? Clazz.new_($I$(9)) : isSV ? $I$(4).getBitSet$org_jmol_script_SV$Z(o, false) : o);
} catch (e) {
...
info=Clazz.new_($I$(11));
info.put$TK$TV("vertexCount", Integer.valueOf$I(this.nVertices));
...
info.put$TK$TV("vertices", pts);
info.put$TK$TV("elemNos", this.getElemNos$());
if (this.id == null ) {
info.put$TK$TV("atomIndex", Integer.valueOf$I(this.centralAtom.i));
} else {
info.put$TK$TV("id", this.id);
info.put$TK$TV("center", $I$(1).newP$javajs_util_T3(this.center));
info.put$TK$TV("color", $I$(5).getHexCode$H(this.colix));
info.put$TK$TV("colorEdge", $I$(5).getHexCode$H(this.colixEdge == 0 ? this.colix : this.colixEdge));
if (this.offset != null ) info.put$TK$TV("offset", this.offset);
if (this.scale != 1 ) info.put$TK$TV("scale", Float.valueOf$F(this.scale));
}if (this.id != null  || !isState ) info.put$TK$TV("modelIndex", Integer.valueOf$I(this.modelIndex));
if (!isState) {
this.info=info;
if (this.id == null ) {
info.put$TK$TV("center", $I$(1).newP$javajs_util_T3(this.centralAtom));
info.put$TK$TV("modelNumber", Integer.valueOf$I(this.centralAtom.getModelNumber$()));
info.put$TK$TV("atomNumber", Integer.valueOf$I(this.centralAtom.getAtomNumber$()));
info.put$TK$TV("atomName", this.centralAtom.getInfo$());
info.put$TK$TV("element", this.centralAtom.getElementSymbol$());
var energy=vwr.ms.getInfo$I$S(this.centralAtom.mi, "Energy");
if (energy != null ) info.put$TK$TV("energy", energy);
}info.put$TK$TV("triangleCount", Integer.valueOf$I(this.triangles.length));
info.put$TK$TV("volume", p$1.getVolume.apply(this, []));
...
info.put$TK$TV("atomNames", names);
info.put$TK$TV("vertexIndices", indices);
if (this.faces != null  && !this.collapsed  && this.faceTriangles != null  ) {
info.put$TK$TV("faceCount", Integer.valueOf$I(this.faces.length));
info.put$TK$TV("faceTriangles", this.faceTriangles);
if (isFaceCalc) {
var faceTypes=Clazz.array(Integer.TYPE, [this.faces.length]);
var faceAreas=Clazz.array(Float.TYPE, [this.faces.length]);
var facePoints=Clazz.new_($I$(13));
var vAB=Clazz.new_($I$(2));
var vAC=Clazz.new_($I$(2));
...
facePoints.addLast$TV(fpts);
}
info.put$TK$TV("face_types", faceTypes);
info.put$TK$TV("face_areas", faceAreas);
info.put$TK$TV("face_points", facePoints);
}}if (this.smarts != null ) info.put$TK$TV("smarts", this.smarts);
if (this.smiles != null ) info.put$TK$TV("smiles", this.smiles);
if (this.polySmiles != null ) info.put$TK$TV("polySmiles", this.polySmiles);
if (this.pointGroup != null ) info.put$TK$TV("pointGroup", this.pointGroup.getPointGroupName$());
if (this.pointGroupFamily != null ) info.put$TK$TV("pointGroupFamily", this.pointGroupFamily.getPointGroupName$());
}if (this.pointScale > 0 ) info.put$TK$TV("pointScale", Float.valueOf$F(this.pointScale));
if (this.faces != null ) info.put$TK$TV("faces", this.faces);
if (isState || $I$(10).debugging ) {
info.put$TK$TV("bsFlat", this.bsFlat);
if (this.collapsed) info.put$TK$TV("collapsed", $I$(14).valueOf$Z(this.collapsed));
if (this.distanceRef != 0 ) info.put$TK$TV("r", Float.valueOf$F(this.distanceRef));
var n=Clazz.array($I$(1), [this.normals.length]);
for (var i=n.length; --i >= 0; ) n[i]=$I$(1).newP$javajs_util_T3(this.normals[i]);

if (!isState) info.put$TK$TV("normals", n);
info.put$TK$TV("triangles", $I$(3).arrayCopyII$IAA$I(this.triangles, this.triangles.length));
}return info;
});
...
var pts=Clazz.array($I$(15), [this.nVertices]);
...
var ident=(this.id == null  ? "({" + this.centralAtom.i + "})"  : "ID " + $I$(16).e$O(this.id));
return "  polyhedron @{" + $I$(16).e$O(this.getInfo$org_jmol_viewer_Viewer$S(vwr, null)) + "} " + (this.isFullyLit ? " fullyLit" : "") + ";" + (this.visible ? "" : "polyhedra " + ident + " off;" ) + "\n" ;
});
...
var bsTemp=Clazz.new_($I$(9));
for (var i=this.normals.length; --i >= 0; ) this.normixes[i]=(this.bsFlat.get$I(i) ? $I$(17).get2SidedNormix$javajs_util_V3$javajs_util_BS(this.normals[i], bsTemp) : $I$(17).getNormixV$javajs_util_V3$javajs_util_BS(this.normals[i], bsTemp));
