...
var C$=Clazz.newClass(P$, "SkipBMH", null, 'com.stevesoft.pat.Skip');
...
C$.superclazz.c$$S$Z$I.apply(this, [pt, ign, offset]);
C$.$init$.apply(this);
for (var k=0; k < 64; k++) {
...
var vend=P$.Skip.min$I$I(s.length$() - 1, end + this.sm1 + this.offset );
var k;
