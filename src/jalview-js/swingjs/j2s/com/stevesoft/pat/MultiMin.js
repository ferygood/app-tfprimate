...
var C$=Clazz.newClass(P$, "MultiMin", null, 'com.stevesoft.pat.Multi');
...
C$.superclazz.c$$com_stevesoft_pat_patInt$com_stevesoft_pat_patInt$com_stevesoft_pat_Pattern.apply(this, [i1, i2, p]);
C$.$init$.apply(this);
