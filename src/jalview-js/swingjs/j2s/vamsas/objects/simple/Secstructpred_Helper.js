...
var C$=Clazz.newClass(P$, "Secstructpred_Helper");
C$.typeDesc=null;

C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.typeDesc=Clazz.new_($I$(1).c$$Class$Z,[Clazz.getClass($I$(2)), true]);
{
C$.typeDesc.setXmlType$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["http://simple.objects.vamsas", "Secstructpred"]));
var elemField=Clazz.new_($I$(4));
elemField.setFieldName$S("output");
elemField.setXmlName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["", "output"]));
