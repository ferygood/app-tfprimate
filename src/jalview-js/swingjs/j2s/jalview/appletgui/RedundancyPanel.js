...
C$.superclazz.c$$jalview_appletgui_AlignmentPanel$I$Z$jalview_renderer_ResidueShaderI.apply(this, [ap, 0, false, null]);
C$.$init$.apply(this);
...
(function(){var C$=Clazz.newClass(P$, "RedundancyPanel$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.AdjustmentListener', 1);
...
var worker=Clazz.new_($I$(6).c$$Runnable,[this]);
worker.start$();
}, 1);
...
var redundantSequences=Clazz.new_($I$(8));
...
var del=Clazz.new_($I$(2));
this.undoButton.setEnabled$Z(true);
var value=this.slider.getValue$();
var sg=this.ap.av.getSelectionGroup$();
for (var i=0; i < this.redundancy.length; i++) {
if (value <= this.redundancy[i] ) {
del.addElement$TE(this.originalSequences[i]);
}}
if (del.size$() > 0) {
...
var cut=Clazz.new_($I$(11).c$$S$jalview_commands_EditCommand_Action$jalview_datamodel_SequenceIA$I$I$jalview_datamodel_AlignmentI,[$I$(3).getString$S("action.remove_redundancy"), $I$(12).CUT, deleted, 0, width, this.ap.av.getAlignment$()]);
