(function(){var P$=Clazz.newPackage("jalview.appletgui"),I$=[[0,'java.awt.Color','java.awt.Panel','java.awt.Scrollbar','java.awt.Toolkit','java.awt.BorderLayout','java.awt.ScrollPane','java.awt.Button','jalview.util.MessageManager','java.awt.GridLayout','java.awt.Label','java.awt.Frame','java.awt.event.WindowAdapter','jalview.bin.JalviewLite','java.awt.PopupMenu','java.awt.MenuItem','java.util.Arrays','jalview.appletgui.FeatureColourChooser','jalview.appletgui.UserDefinedColours',['jalview.appletgui.FeatureSettings','.MyCheckbox'],'java.awt.Font','java.util.ArrayList','java.util.HashSet',['jalview.viewmodel.seqfeatures.FeatureRendererModel','.FeatureSettingsBean']]],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
...
this.featurePanel=Clazz.new_($I$(2));
this.groupItemListener=((P$.FeatureSettings$1||
(function(){var C$=Clazz.newClass(P$, "FeatureSettings$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
this.transparency=Clazz.new_($I$(3).c$$I$I$I$I$I,[0, 100 - ((this.fr.getTransparency$() * 100)|0), 1, 1, 100]);
...
}var invert=Clazz.new_($I$(7).c$$S,[$I$(8).getString$S("label.invert_selection")]);
invert.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$2||
(function(){var C$=Clazz.newClass(P$, "FeatureSettings$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
var lowerPanel=Clazz.new_($I$(2).c$$java_awt_LayoutManager,[Clazz.new_($I$(9).c$$I$I$I$I,[2, 1, 5, 10])]);
lowerPanel.add$java_awt_Component(invert);
var tPanel=Clazz.new_($I$(2).c$$java_awt_LayoutManager,[Clazz.new_($I$(5))]);
tPanel.add$java_awt_Component$O(this.transparency, "Center");
tPanel.add$java_awt_Component$O(Clazz.new_($I$(10).c$$S,["Transparency"]), "East");
lowerPanel.add$java_awt_Component$O(tPanel, "South");
this.add$java_awt_Component$O(lowerPanel, "South");
this.groupPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(9).c$$I$I,[((this.fr.getFeatureGroupsSize$())/4|0) + 1, 4]));
...
(function(){var C$=Clazz.newClass(P$, "FeatureSettings$3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.WindowAdapter'), null, 1);
...
), Clazz.new_($I$(12), [this, {me: me}],P$.FeatureSettings$3)));
...
var men=Clazz.new_($I$(14).c$$S,[$I$(8).formatMessage$S$SA("label.settings_for_type", Clazz.array(String, -1, [type]))]);
var scr=Clazz.new_($I$(15).c$$S,[$I$(8).getString$S("label.sort_by_score")]);
men.add$java_awt_MenuItem(scr);
var me=this;
scr.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$4||
(function(){var C$=Clazz.newClass(P$, "FeatureSettings$4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
Clazz.newMeth(C$, ['actionPerformed$java_awt_event_ActionEvent','actionPerformed$'], function (e) {
this.$finals$.me.ap.alignFrame.avc.sortAlignmentByFeatureScore$java_util_List($I$(16).asList$TTA(Clazz.array(String, -1, [this.$finals$.type])));
});
})()
), Clazz.new_(P$.FeatureSettings$4.$init$, [this, {me: me, type: type}])));
var dens=Clazz.new_($I$(15).c$$S,[$I$(8).getString$S("label.sort_by_density")]);
dens.addActionListener$java_awt_event_ActionListener(((P$.FeatureSettings$5||
(function(){var C$=Clazz.newClass(P$, "FeatureSettings$5", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
Clazz.newMeth(C$, ['actionPerformed$java_awt_event_ActionEvent','actionPerformed$'], function (e) {
this.$finals$.me.ap.alignFrame.avc.sortAlignmentByFeatureDensity$java_util_List($I$(16).asList$TTA(Clazz.array(String, -1, [this.$finals$.type])));
});
})()
), Clazz.new_(P$.FeatureSettings$5.$init$, [this, {me: me, type: type}])));
men.add$java_awt_MenuItem(dens);
if (minmax != null ) {
var typeMinMax=minmax.get$O(type);
if (typeMinMax != null  && typeMinMax[0] != null  ) {
var mxcol=Clazz.new_($I$(15).c$$S,[(typeCol.isSimpleColour$()) ? "Graduated Colour" : "Single Colour"]);
...
Clazz.new_($I$(17).c$$jalview_appletgui_FeatureSettings$S,[this.$finals$.me, this.$finals$.type]);
...
Clazz.new_($I$(18).c$$jalview_appletgui_FeatureSettings$S$jalview_api_FeatureColourI,[this.$finals$.me, this.$finals$.check.type, this.$finals$.typeCol]);
}});
})()
), Clazz.new_(P$.FeatureSettings$6.$init$, [this, {typeCol: typeCol, me: me, type: type, check: check}])));
}}var selectContaining=Clazz.new_($I$(15).c$$S,[$I$(8).getString$S("label.select_columns_containing")]);
...
), Clazz.new_(P$.FeatureSettings$7.$init$, [this, {me: me, type: type}])));
men.add$java_awt_MenuItem(selectContaining);
var selectNotContaining=Clazz.new_($I$(15).c$$S,[$I$(8).getString$S("label.select_columns_not_containing")]);
...
), Clazz.new_(P$.FeatureSettings$8.$init$, [this, {me: me, type: type}])));
men.add$java_awt_MenuItem(selectNotContaining);
var hideContaining=Clazz.new_($I$(15).c$$S,[$I$(8).getString$S("label.hide_columns_containing")]);
...
var hideNotContaining=Clazz.new_($I$(15).c$$S,[$I$(8).getString$S("label.hide_columns_not_containing")]);
...
var check=Clazz.new_($I$(19).c$$S$Z$Z, [this, null, group, visible, false]);
check.addMouseListener$java_awt_event_MouseListener(this);
check.setFont$java_awt_Font(Clazz.new_($I$(20).c$$S$I$I,["Serif", 1, 12]));
...
var displayableTypes=Clazz.new_($I$(21));
var foundGroups=Clazz.new_($I$(22));
...
var visibleGroups=Clazz.new_($I$(22));
...
this.featurePanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(9).c$$I$I$I$I,[this.featurePanel.getComponentCount$(), 1, 10, 5]));
...
selected=true;
}check=Clazz.new_($I$(19).c$$S$Z$Z$jalview_api_FeatureColourI, [this, null, type, selected, false, this.fr.getFeatureStyle$S(type)]);
check.addMouseListener$java_awt_event_MouseListener(this);
...
rowData[i]=Clazz.new_($I$(23).c$$S$jalview_api_FeatureColourI$jalview_datamodel_features_FeatureMatcherSetI$Boolean,[check.type, colour, null, new Boolean(check.getState$())]);
i++;
}
...
Clazz.new_($I$(18).c$$O$S$java_awt_Color,[this, check.type, fcol.getColour$()]);
} else {
Clazz.new_($I$(17).c$$jalview_appletgui_FeatureSettings$S,[this, check.type]);
...
;
(function(){var C$=Clazz.newClass(P$.FeatureSettings, "MyCheckbox", function(){
...
C$.superclazz.c$$S$Z.apply(this, [label, checked]);
C$.$init$.apply(this);
this.type=label;
