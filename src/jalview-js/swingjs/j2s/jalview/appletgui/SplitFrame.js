(function(){var P$=Clazz.newPackage("jalview.appletgui"),p$1={},I$=[[0,'jalview.structure.StructureSelectionManager','java.awt.Panel','java.awt.GridLayout','java.awt.Dimension','java.awt.BorderLayout','jalview.bin.JalviewLite']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "SplitFrame", null, 'jalview.appletgui.EmbmenuFrame');
...
this.outermost=Clazz.new_($I$(2).c$$java_awt_LayoutManager,[Clazz.new_($I$(3).c$$I$I,[2, 1])]);
var topPanel=Clazz.new_($I$(2));
var bottomPanel=Clazz.new_($I$(2));
...
this.topFrame.alignPanel.idPanel.idCanvas.setSize$java_awt_Dimension(Clazz.new_($I$(4).c$$I$I,[w3, d.height]));
}if (w2 != w3) {
var d=this.bottomFrame.alignPanel.idPanel.idCanvas.getSize$();
this.bottomFrame.alignPanel.idPanel.idCanvas.setSize$java_awt_Dimension(Clazz.new_($I$(4).c$$I$I,[w3, d.height]));
...
panel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(5)));
