...
this.revealAll=null;
this.revealSeq=null;
this.revealSeq_index=0;
this.menu1=null;
}, 1);

Clazz.newMeth(C$, '$init$', function () {
this.groupMenu=Clazz.new_($I$(1));
this.editGroupName=Clazz.new_($I$(2));
this.noColour=Clazz.new_($I$(3));
this.clustalColour=Clazz.new_($I$(3));
this.zappoColour=Clazz.new_($I$(3));
this.taylorColour=Clazz.new_($I$(3));
this.hydrophobicityColour=Clazz.new_($I$(3));
this.helixColour=Clazz.new_($I$(3));
this.strandColour=Clazz.new_($I$(3));
this.turnColour=Clazz.new_($I$(3));
this.buriedColour=Clazz.new_($I$(3));
this.PIDColour=Clazz.new_($I$(3));
this.BLOSUM62Colour=Clazz.new_($I$(3));
this.nucleotideColour=Clazz.new_($I$(3));
this.purinePyrimidineColour=Clazz.new_($I$(3));
this.userDefinedColour=Clazz.new_($I$(2));
this.abovePIDColour=Clazz.new_($I$(3));
this.modifyPID=Clazz.new_($I$(2));
this.conservationColour=Clazz.new_($I$(3));
this.modifyConservation=Clazz.new_($I$(2));
this.noColourmenuItem=Clazz.new_($I$(2));
...
this.seqShowAnnotationsMenu=Clazz.new_($I$(1).c$$S,[$I$(4).getString$S("label.show_annotations")]);
this.seqHideAnnotationsMenu=Clazz.new_($I$(1).c$$S,[$I$(4).getString$S("label.hide_annotations")]);
this.seqAddReferenceAnnotations=Clazz.new_($I$(2).c$$S,[$I$(4).getString$S("label.add_reference_annotations")]);
this.groupShowAnnotationsMenu=Clazz.new_($I$(1).c$$S,[$I$(4).getString$S("label.show_annotations")]);
this.groupHideAnnotationsMenu=Clazz.new_($I$(1).c$$S,[$I$(4).getString$S("label.hide_annotations")]);
this.groupAddReferenceAnnotations=Clazz.new_($I$(2).c$$S,[$I$(4).getString$S("label.add_reference_annotations")]);
this.editMenu=Clazz.new_($I$(1).c$$S,[$I$(4).getString$S("action.edit")]);
this.copy=Clazz.new_($I$(2).c$$S,[$I$(4).getString$S("action.copy")]);
this.cut=Clazz.new_($I$(2).c$$S,[$I$(4).getString$S("action.cut")]);
this.toUpper=Clazz.new_($I$(2).c$$S,[$I$(4).getString$S("label.to_upper_case")]);
this.toLower=Clazz.new_($I$(2).c$$S,[$I$(4).getString$S("label.to_lower_case")]);
this.toggleCase=Clazz.new_($I$(2).c$$S,[$I$(4).getString$S("label.toggle_case")]);
this.outputmenu=Clazz.new_($I$(1));
this.seqMenu=Clazz.new_($I$(1));
this.pdb=Clazz.new_($I$(2));
this.hideSeqs=Clazz.new_($I$(2));
this.repGroup=Clazz.new_($I$(2));
this.sequenceName=Clazz.new_($I$(2).c$$S,[$I$(4).getString$S("label.edit_name_description")]);
this.sequenceFeature=Clazz.new_($I$(2).c$$S,[$I$(4).getString$S("label.create_sequence_feature")]);
this.editSequence=Clazz.new_($I$(2).c$$S,[$I$(4).getString$S("label.edit_sequence")]);
this.sequenceDetails=Clazz.new_($I$(2).c$$S,[$I$(4).getString$S("label.sequence_details")]);
this.selSeqDetails=Clazz.new_($I$(2).c$$S,[$I$(4).getString$S("label.sequence_details")]);
this.makeReferenceSeq=Clazz.new_($I$(2));
this.revealAll=Clazz.new_($I$(2));
this.revealSeq=Clazz.new_($I$(2));
this.revealSeq_index=-1;
this.menu1=Clazz.new_($I$(1));
}, 1);
...
var selectedSequence=(this.seq == null  ? $I$(8).emptyList$() : $I$(9).asList$TTA([this.seq]));
...
var tipEntries=Clazz.new_($I$(10));
var candidates=Clazz.new_($I$(6));
...
var tooltip=Clazz.new_($I$(12).c$$I,[64]);
...
(function(){var C$=Clazz.newClass(P$, "APopupMenu$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
(function(){var C$=Clazz.newClass(P$, "APopupMenu$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
), Clazz.new_(P$.APopupMenu$2.$init$, [this, {url: url, target: target}])));
...
var dialog=Clazz.new_($I$(13).c$$S$S$S$S$java_awt_Frame$S$I$I$Z,[this.getGroup$().getName$(), this.getGroup$().getDescription$(), "       Group Name", "Group Description", this.ap.alignFrame, "Edit Group Name / Description", 500, 100, true]);
if (dialog.accept) {
...
}var dialog=Clazz.new_($I$(13).c$$S$S$S$S$java_awt_Frame$S$I$I$Z,[this.seq.getSequenceAsString$I$I(sg.getStartRes$(), sg.getEndRes$() + 1), null, "Edit Sequence ", null, this.ap.alignFrame, "Edit Sequence", 500, 100, true]);
if (dialog.accept) {
var editCommand=Clazz.new_($I$(14).c$$S$jalview_commands_EditCommand_Action$S$jalview_datamodel_SequenceIA$I$I$jalview_datamodel_AlignmentI,[$I$(4).getString$S("label.edit_sequences"), $I$(15).REPLACE, dialog.getName$().replace$C$C(" ", this.ap.av.getGapCharacter$()), sg.getSequencesAsArray$java_util_Map(this.ap.av.getHiddenRepSequences$()), sg.getStartRes$(), sg.getEndRes$() + 1, this.ap.av.getAlignment$()]);
...
}var caseCommand=Clazz.new_($I$(16).c$$S$jalview_datamodel_SequenceIA$java_util_List$I,[description, sg.getSequencesAsArray$java_util_Map(this.ap.av.getHiddenRepSequences$()), startEnd, caseChange]);
...
var seqs=Clazz.new_($I$(17));
var features=Clazz.new_($I$(17));
...
if (start <= end) {
seqs.add$TE(sg.getSequenceAt$I(i));
features.add$TE(Clazz.new_($I$(18).c$$S$S$I$I$S,[null, null, start, end, "Jalview"]));
}}
if (!seqs.isEmpty$()) {
...
var cap=Clazz.new_($I$(19).c$$Z$jalview_appletgui_AlignFrame,[true, this.ap.alignFrame]);
var frame=Clazz.new_($I$(20));
...
cap.setText$S(Clazz.new_($I$(22)).formatSequences$jalview_io_FileFormatI$Z$jalview_api_AlignmentViewPanel$Z(fileFormat, this.ap.av.getShowJVSuffix$(), this.ap, true));
});
...
var cap=Clazz.new_($I$(19).c$$Z$jalview_appletgui_AlignFrame,[false, this.ap.alignFrame]);
var contents=Clazz.new_($I$(12).c$$I,[128]);
...
Clazz.new_($I$(24).c$$S,[null]).createSequenceAnnotationReport$StringBuilder$jalview_datamodel_SequenceI$Z$Z$jalview_viewmodel_seqfeatures_FeatureRendererModel(contents, seq, true, true, this.ap.seqPanel.seqCanvas.fr);
contents.append$S("</p>");
}
var frame=Clazz.new_($I$(20));
frame.add$java_awt_Component(cap);
...
var dialog=Clazz.new_($I$(13).c$$S$S$S$S$java_awt_Frame$S$I$I$Z,[this.seq.getName$(), this.seq.getDescription$(), "       Sequence Name", "Sequence Description", this.ap.alignFrame, "Edit Sequence Name / Description", 500, 100, true]);
if (dialog.accept) {
...
Clazz.new_($I$(25).c$$jalview_datamodel_PDBEntry$jalview_datamodel_SequenceIA$SA$jalview_appletgui_AlignmentPanel$jalview_io_DataSourceType,[entry, Clazz.array($I$(23), -1, [this.seq]), null, this.ap, $I$(26).URL]);
} else {
Clazz.new_($I$(27).c$$jalview_datamodel_PDBEntry$jalview_datamodel_SequenceIA$SA$jalview_appletgui_AlignmentPanel$jalview_io_DataSourceType,[entry, Clazz.array($I$(23), -1, [this.seq]), null, this.ap, $I$(26).URL]);
}} else {
var cap=Clazz.new_($I$(19).c$$Z$jalview_appletgui_AlignFrame,[true, this.ap.alignFrame]);
...
sg.cs=Clazz.new_($I$(29).c$$jalview_schemes_ColourSchemeI,[Clazz.new_($I$(30).c$$jalview_datamodel_AnnotatedCollectionI$java_util_Map,[sg, this.ap.av.getHiddenRepSequences$()])]);
this.refresh$();
});

Clazz.newMeth(C$, 'zappoColour_actionPerformed$', function () {
this.getGroup$().cs=Clazz.new_($I$(29).c$$jalview_schemes_ColourSchemeI,[Clazz.new_($I$(31))]);
this.refresh$();
});

Clazz.newMeth(C$, 'taylorColour_actionPerformed$', function () {
this.getGroup$().cs=Clazz.new_($I$(29).c$$jalview_schemes_ColourSchemeI,[Clazz.new_($I$(32))]);
this.refresh$();
});

Clazz.newMeth(C$, 'hydrophobicityColour_actionPerformed$', function () {
this.getGroup$().cs=Clazz.new_($I$(29).c$$jalview_schemes_ColourSchemeI,[Clazz.new_($I$(33))]);
this.refresh$();
});

Clazz.newMeth(C$, 'helixColour_actionPerformed$', function () {
this.getGroup$().cs=Clazz.new_($I$(29).c$$jalview_schemes_ColourSchemeI,[Clazz.new_($I$(34))]);
this.refresh$();
});

Clazz.newMeth(C$, 'strandColour_actionPerformed$', function () {
this.getGroup$().cs=Clazz.new_($I$(29).c$$jalview_schemes_ColourSchemeI,[Clazz.new_($I$(35))]);
this.refresh$();
});

Clazz.newMeth(C$, 'turnColour_actionPerformed$', function () {
this.getGroup$().cs=Clazz.new_($I$(29).c$$jalview_schemes_ColourSchemeI,[Clazz.new_($I$(36))]);
this.refresh$();
});

Clazz.newMeth(C$, 'buriedColour_actionPerformed$', function () {
this.getGroup$().cs=Clazz.new_($I$(29).c$$jalview_schemes_ColourSchemeI,[Clazz.new_($I$(37))]);
this.refresh$();
});

Clazz.newMeth(C$, 'nucleotideMenuItem_actionPerformed$', function () {
this.getGroup$().cs=Clazz.new_($I$(29).c$$jalview_schemes_ColourSchemeI,[Clazz.new_($I$(38))]);
this.refresh$();
});

Clazz.newMeth(C$, 'purinePyrimidineColour_actionPerformed$', function () {
this.getGroup$().cs=Clazz.new_($I$(29).c$$jalview_schemes_ColourSchemeI,[Clazz.new_($I$(39))]);
this.refresh$();
});
...
Clazz.new_($I$(42).c$$jalview_appletgui_AlignmentPanel$jalview_datamodel_SequenceGroup,[this.ap, this.getGroup$()]);
});

Clazz.newMeth(C$, 'PIDColour_actionPerformed$', function () {
var sg=this.getGroup$();
sg.cs=Clazz.new_($I$(29).c$$jalview_schemes_ColourSchemeI,[Clazz.new_($I$(43))]);
sg.cs.setConsensus$jalview_datamodel_ProfilesI($I$(40).calculate$java_util_List$I$I(sg.getSequences$java_util_Map(this.ap.av.getHiddenRepSequences$()), 0, this.ap.av.getAlignment$().getWidth$()));
this.refresh$();
});
...
var sg=this.getGroup$();
sg.cs=Clazz.new_($I$(29).c$$jalview_schemes_ColourSchemeI,[Clazz.new_($I$(44))]);
sg.cs.setConsensus$jalview_datamodel_ProfilesI($I$(40).calculate$java_util_List$I$I(sg.getSequences$java_util_Map(this.ap.av.getHiddenRepSequences$()), 0, this.ap.av.getAlignment$().getWidth$()));
this.refresh$();
});
...
showMenu.removeAll$();
hideMenu.removeAll$();
var all=$I$(9).asList$TTA(Clazz.array(String, -1, [$I$(4).getString$S("label.all")]));
...
var shownTypes=Clazz.new_($I$(6));
var hiddenTypes=Clazz.new_($I$(6));
...
(function(){var C$=Clazz.newClass(P$, "APopupMenu$3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
), Clazz.new_(P$.APopupMenu$3.$init$, [this, {types: types, forSequences: forSequences, allTypes: allTypes, actionIsShow: actionIsShow}])));
