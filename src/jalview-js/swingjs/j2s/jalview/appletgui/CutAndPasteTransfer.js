...
this.accept=Clazz.new_($I$(2).c$$S,["New Window"]);
this.addSequences=Clazz.new_($I$(2).c$$S,["Add to Current Alignment"]);
this.cancel=Clazz.new_($I$(2).c$$S,["Close"]);
...
try {
var fin=Clazz.new_($I$(6).c$$S$jalview_io_DataSourceType,[this.textarea.getText$(), $I$(7).PASTE]);
fin.parse$();
if (fin.getTree$() != null ) {
...
var al=null;
try {
var format=Clazz.new_($I$(8)).identify$S$jalview_io_DataSourceType(text, $I$(7).PASTE);
var afa=Clazz.new_($I$(9).c$$jalview_api_AlignmentViewPanel,[this.alignFrame.alignPanel]);
...
af=Clazz.new_($I$(10).c$$jalview_datamodel_AlignmentI$jalview_datamodel_SequenceIA$jalview_datamodel_HiddenColumns$jalview_bin_JalviewLite$S$Z,[al, hiddenSeqs, colSel, this.alignFrame.viewport.applet, "Cut & Paste input - " + format, false]);
...
af=Clazz.new_($I$(10).c$$jalview_datamodel_AlignmentI$jalview_bin_JalviewLite$S$Z,[al, this.alignFrame.viewport.applet, "Cut & Paste input - " + format, false]);
...
var dialog=Clazz.new_($I$(13).c$$java_awt_Frame$S$Z$I$I,[this.getParent$(), title, true, 100, 400]);
dialog.ok.setLabel$S($I$(5).getString$S("action.yes"));
dialog.cancel.setLabel$S($I$(5).getString$S("action.no"));
var question=Clazz.new_($I$(3).c$$java_awt_LayoutManager,[Clazz.new_($I$(4))]);
var text=$I$(5).getString$S("label.open_split_window?");
question.add$java_awt_Component$O(Clazz.new_($I$(14).c$$S$I,[text, 1]), "Center");
...
var copyFrame=Clazz.new_($I$(10).c$$jalview_datamodel_AlignmentI$jalview_bin_JalviewLite$S$Z$Z,[this.alignFrame.viewport.getAlignment$(), applet, this.alignFrame.getTitle$(), false, false]);
var newFrame=Clazz.new_($I$(10).c$$jalview_datamodel_AlignmentI$jalview_bin_JalviewLite$S$Z$Z,[al, this.alignFrame.viewport.applet, "Cut & Paste input - " + format, false, false]);
var dnaFrame=al.isNucleotide$() ? newFrame : copyFrame;
var proteinFrame=al.isNucleotide$() ? copyFrame : newFrame;
var sf=Clazz.new_($I$(15).c$$jalview_appletgui_AlignFrame$jalview_appletgui_AlignFrame,[dnaFrame, proteinFrame]);
...
var tcf=null;
try {
tcf=Clazz.new_($I$(16).c$$O$jalview_io_DataSourceType,[this.textarea.getText$(), $I$(7).PASTE]);
if (tcf.isValid$()) {
...
this.alignFrame.changeColour$jalview_schemes_ColourSchemeI(Clazz.new_($I$(17).c$$jalview_datamodel_AnnotatedCollectionI,[this.alignFrame.viewport.getAlignment$()]));
...
if (tcf == null ) {
if (Clazz.new_($I$(18)).annotateAlignmentView$jalview_api_AlignViewportI$O$jalview_io_DataSourceType(this.alignFrame.viewport, this.textarea.getText$(), $I$(7).PASTE)) {
this.alignFrame.alignPanel.fontChanged$();
...
var pdb=Clazz.new_($I$(19));
pdb.setFile$S(text);
if (this.alignFrame.alignPanel.av.applet.jmolAvailable) {
Clazz.new_($I$(20).c$$jalview_datamodel_PDBEntry$jalview_datamodel_SequenceIA$SA$jalview_appletgui_AlignmentPanel$jalview_io_DataSourceType,[pdb, Clazz.array($I$(21), -1, [this.seq]), null, this.alignFrame.alignPanel, $I$(7).PASTE]);
} else {
Clazz.new_($I$(22).c$$jalview_datamodel_PDBEntry$jalview_datamodel_SequenceIA$SA$jalview_appletgui_AlignmentPanel$jalview_io_DataSourceType,[pdb, Clazz.array($I$(21), -1, [this.seq]), null, this.alignFrame.alignPanel, $I$(7).PASTE]);
}});
...
this.textarea.setFont$java_awt_Font(Clazz.new_($I$(23).c$$S$I$I,["Monospaced", 0, 10]));
