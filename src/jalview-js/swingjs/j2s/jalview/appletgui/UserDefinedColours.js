(function(){var P$=Clazz.newPackage("jalview.appletgui"),p$1={},I$=[[0,'java.util.Vector','java.awt.Panel','java.awt.GridLayout','java.awt.Button','java.awt.Scrollbar','java.awt.Label','java.awt.TextField','jalview.schemes.FeatureColour','java.awt.Rectangle','jalview.util.MessageManager','java.awt.Dialog','Error','java.awt.Frame','jalview.bin.JalviewLite','jalview.schemes.ResidueProperties','java.awt.Color','java.awt.Font','java.awt.event.MouseAdapter','jalview.schemes.UserColourScheme','jalview.renderer.ResidueShader','jalview.analysis.AAFrequency']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "UserDefinedColours", null, 'java.awt.Panel', ['java.awt.event.ActionListener', 'java.awt.event.AdjustmentListener', 'java.awt.event.FocusListener']);
...
this.oldColours=Clazz.new_($I$(1));
this.R=0;
this.G=0;
this.B=0;
...
this.rScroller=Clazz.new_($I$(5));
this.label1=Clazz.new_($I$(6));
this.rText=Clazz.new_($I$(7));
this.label4=Clazz.new_($I$(6));
this.gScroller=Clazz.new_($I$(5));
this.gText=Clazz.new_($I$(7));
this.label5=Clazz.new_($I$(6));
this.bScroller=Clazz.new_($I$(5));
this.bText=Clazz.new_($I$(7));
this.target=Clazz.new_($I$(2));
}, 1);
...
Clazz.super_(C$, this,1);
this.$caller=fr;
this.originalColour=Clazz.new_($I$(8).c$$java_awt_Color,[fr.colourPanel.getBackground$()]);
...
Clazz.super_(C$, this,1);
this.$caller=$caller;
this.originalColour=Clazz.new_($I$(8).c$$java_awt_Color,[col]);
...
C$.c$$O$S$jalview_api_FeatureColourI$java_awt_Color.apply(this, [$caller, label, Clazz.new_($I$(8).c$$java_awt_Color,[colour]), colour]);
}, 1);
...
this.okcancelPanel.setBounds$java_awt_Rectangle(Clazz.new_($I$(9).c$$I$I$I$I,[0, 113, 400, 35]));
...
this.dialog=Clazz.new_($I$(11).c$$java_awt_Frame$S$Z,[alignframe, title, true]);
} else {
throw Clazz.new_($I$(12).c$$S,[$I$(10).getString$S("label.error_unsupported_owwner_user_colour_scheme")]);
}this.dialog.add$java_awt_Component(this);
this.setSize$I$I(400, 123);
this.okcancelPanel.setBounds$java_awt_Rectangle(Clazz.new_($I$(9).c$$I$I$I$I,[0, 123, 400, 35]));
...
var col=Clazz.new_($I$(16).c$$I$I$I,[this.R, this.G, this.B]);
...
this.oldColours.addElement$TE(col);
button.setLabel$S(label);
button.setForeground$java_awt_Color(col.darker$().darker$().darker$());
button.setFont$java_awt_Font(Clazz.new_($I$(17).c$$S$I$I,["Verdana", 1, 10]));
...
), Clazz.new_($I$(18), [this, null],P$.UserDefinedColours$1)));
...
return Clazz.new_($I$(16).c$$I$I$I,[this.R, this.G, this.B]);
});

Clazz.newMeth(C$, 'applyButton_actionPerformed$', function () {
if (this.$caller != null ) {
if (Clazz.instanceOf(this.$caller, "jalview.appletgui.FeatureSettings")) {
(this.$caller).setUserColour$S$jalview_api_FeatureColourI(this.originalLabel, Clazz.new_($I$(8).c$$java_awt_Color,[this.getColor$()]));
...
(this.$caller).colourPanel.updateColor$jalview_api_FeatureColourI(Clazz.new_($I$(8).c$$java_awt_Color,[this.getColor$()]));
...
var ucs=Clazz.new_($I$(19).c$$java_awt_ColorA,[newColours]);
if (this.ap != null ) {
if (this.seqGroup != null ) {
this.seqGroup.cs=Clazz.new_($I$(20).c$$jalview_schemes_ColourSchemeI,[ucs]);
...
if (this.seqGroup != null ) {
this.seqGroup.cs=Clazz.new_($I$(20).c$$jalview_schemes_ColourSchemeI,[this.oldColourScheme]);
...
this.okButton.setFont$java_awt_Font(Clazz.new_($I$(17).c$$S$I$I,["Verdana", 0, 11]));
this.okButton.setLabel$S($I$(10).getString$S("action.ok"));
this.okButton.addActionListener$java_awt_event_ActionListener(this);
this.applyButton.setFont$java_awt_Font(Clazz.new_($I$(17).c$$S$I$I,["Verdana", 0, 11]));
...
this.cancelButton.setFont$java_awt_Font(Clazz.new_($I$(17).c$$S$I$I,["Verdana", 0, 11]));
...
this.setBackground$java_awt_Color(Clazz.new_($I$(16).c$$I$I$I,[212, 208, 223]));
this.okcancelPanel.setBounds$java_awt_Rectangle(Clazz.new_($I$(9).c$$I$I$I$I,[0, 265, 400, 35]));
this.buttonPanel.setBounds$java_awt_Rectangle(Clazz.new_($I$(9).c$$I$I$I$I,[0, 123, 400, 142]));
...
this.rScroller.setBounds$java_awt_Rectangle(Clazz.new_($I$(9).c$$I$I$I$I,[36, 27, 119, 19]));
...
this.label1.setBounds$java_awt_Rectangle(Clazz.new_($I$(9).c$$I$I$I$I,[19, 30, 16, 15]));
this.rText.setFont$java_awt_Font(Clazz.new_($I$(17).c$$S$I$I,["Dialog", 0, 10]));
this.rText.setText$S("0        ");
this.rText.setBounds$java_awt_Rectangle(Clazz.new_($I$(9).c$$I$I$I$I,[156, 27, 53, 19]));
...
this.label4.setBounds$java_awt_Rectangle(Clazz.new_($I$(9).c$$I$I$I$I,[15, 56, 20, 15]));
...
this.gScroller.setBounds$java_awt_Rectangle(Clazz.new_($I$(9).c$$I$I$I$I,[35, 52, 120, 20]));
this.gScroller.addAdjustmentListener$java_awt_event_AdjustmentListener(this);
this.gText.setFont$java_awt_Font(Clazz.new_($I$(17).c$$S$I$I,["Dialog", 0, 10]));
this.gText.setText$S("0        ");
this.gText.setBounds$java_awt_Rectangle(Clazz.new_($I$(9).c$$I$I$I$I,[156, 52, 53, 20]));
...
this.label5.setBounds$java_awt_Rectangle(Clazz.new_($I$(9).c$$I$I$I$I,[14, 82, 20, 15]));
...
this.bScroller.setBounds$java_awt_Rectangle(Clazz.new_($I$(9).c$$I$I$I$I,[35, 78, 120, 20]));
this.bScroller.addAdjustmentListener$java_awt_event_AdjustmentListener(this);
this.bText.setFont$java_awt_Font(Clazz.new_($I$(17).c$$S$I$I,["Dialog", 0, 10]));
this.bText.setText$S("0        ");
this.bText.setBounds$java_awt_Rectangle(Clazz.new_($I$(9).c$$I$I$I$I,[157, 78, 52, 20]));
...
this.target.setBounds$java_awt_Rectangle(Clazz.new_($I$(9).c$$I$I$I$I,[229, 26, 134, 79]));
