(function(){var P$=Clazz.newPackage("jalview.ws.jws2"),p$1={},I$=[[0,'jalview.util.MessageManager','jalview.datamodel.AlignmentAnnotation','jalview.datamodel.Annotation']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "JabawsCalcWorker", null, 'jalview.ws.jws2.AbstractJabaCalcWorker');
...
}var dssan=Clazz.new_($I$(2).c$$jalview_datamodel_AlignmentAnnotation,[newAnnot]);
...
while (!this.gapMap[i]){
elm[i++]=Clazz.new_($I$(3).c$$S$S$C$F,["", "", " ", NaN]);
}
}elm[i]=Clazz.new_($I$(3).c$$S$S$C$F,["", "" + new Float(val).toString(), " ", val]);
}
