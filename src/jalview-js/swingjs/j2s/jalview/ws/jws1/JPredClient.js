(function(){var P$=Clazz.newPackage("jalview.ws.jws1"),p$1={},I$=[[0,'jalview.bin.Cache','jalview.datamodel.SequenceI','jalview.analysis.SeqsetUtils','jalview.analysis.AlignSeq','jalview.ws.jws1.JPredThread','Error','jalview.util.MessageManager','jalview.datamodel.Sequence','jalview.gui.WebserviceInfo','ext.vamsas.JpredServiceLocator','java.net.URL','jalview.gui.JvOptionPane','jalview.gui.Desktop','javax.swing.JMenuItem','jalview.ws.jws1.JPredClient']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "JPredClient", null, 'jalview.ws.jws1.WS1Client');
...
if (server == null ) {
$I$(1).log.warn$O("Couldn\'t find a Jpred webservice to invoke!");
return;
}var msf=null;
var seq=null;
var delMap=null;
...
var jthread=Clazz.new_($I$(5).c$$jalview_gui_WebserviceInfo$S$ext_vamsas_Jpred$java_util_Hashtable$jalview_datamodel_SequenceIA$IA$jalview_datamodel_AlignmentView$jalview_gui_AlignFrame$S,[this.wsInfo, altitle, server, SequenceInfo, aln, delMap, alview, parentFrame, this.WsURL]);
this.wsInfo.setthisService$jalview_ws_WSClientI(jthread);
jthread.start$();
} else {
if (!msa && msf.length > 1 ) {
throw Clazz.new_($I$(6).c$$S,[$I$(7).getString$S("error.implementation_error_multiple_single_sequence_prediction_jobs_not_supported")]);
...
var jthread=Clazz.new_($I$(5).c$$jalview_gui_WebserviceInfo$S$ext_vamsas_Jpred$S$java_util_Hashtable$jalview_datamodel_SequenceI$IA$jalview_datamodel_AlignmentView$jalview_gui_AlignFrame,[this.wsInfo, altitle, server, this.WsURL, SequenceInfo, seq, delMap, alview, parentFrame]);
this.wsInfo.setthisService$jalview_ws_WSClientI(jthread);
jthread.start$();
}}, p$1);

Clazz.newMeth(C$, 'getPredictionName$S', function (webServiceName) {
if (webServiceName.toLowerCase$().indexOf$S("secondary structure prediction") > -1) {
...
var aln=Clazz.array($I$(2), [msf.length]);
for (var i=0, j=msf.length; i < j; i++) {
aln[i]=Clazz.new_($I$(8).c$$jalview_datamodel_SequenceI,[msf[i]]);
}
var SequenceInfo=$I$(3).uniquify$jalview_datamodel_SequenceIA$Z(aln, true);
var server=p$1.locateWebService.apply(this, []);
if (server == null ) {
return;
}var jthread=Clazz.new_($I$(5).c$$jalview_gui_WebserviceInfo$S$ext_vamsas_Jpred$java_util_Hashtable$jalview_datamodel_SequenceIA$IA$jalview_datamodel_AlignmentView$jalview_gui_AlignFrame$S,[this.wsInfo, altitle, server, SequenceInfo, aln, null, null, parentFrame, this.WsURL]);
this.wsInfo.setthisService$jalview_ws_WSClientI(jthread);
jthread.start$();
}, p$1);
...
if (server == null ) {
return;
}var jthread=Clazz.new_($I$(5).c$$jalview_gui_WebserviceInfo$S$ext_vamsas_Jpred$S$java_util_Hashtable$jalview_datamodel_SequenceI$IA$jalview_datamodel_AlignmentView$jalview_gui_AlignFrame,[this.wsInfo, altitle, server, this.WsURL, SequenceInfo, seq, null, null, parentFrame]);
this.wsInfo.setthisService$jalview_ws_WSClientI(jthread);
jthread.start$();
});
...
var wsInfo=Clazz.new_($I$(9).c$$S$S$Z,[this.WebServiceJobTitle, this.WebServiceReference, true]);
return wsInfo;
}, p$1);

Clazz.newMeth(C$, 'locateWebService', function () {
var loc=Clazz.new_($I$(10));
var server=null;
try {
server=loc.getjpred$java_net_URL(Clazz.new_($I$(11).c$$S,[this.WsURL]));
(server).setTimeout$I(60000);
} catch (ex) {
if (Clazz.exceptionOf(ex,"Exception")){
$I$(12).showMessageDialog$java_awt_Component$S$S$I($I$(13).desktop, $I$(7).formatMessage$S$SA("label.secondary_structure_prediction_service_couldnt_be_located", Clazz.array(String, -1, [this.WebServiceName, this.WsURL])), $I$(7).getString$S("label.internal_jalview_error"), 2);
...
var method=Clazz.new_($I$(14).c$$S,[sh.getName$()]);
method.setToolTipText$S(sh.getEndpointURL$());
method.addActionListener$java_awt_event_ActionListener(((P$.JPredClient$1||
(function(){var C$=Clazz.newClass(P$, "JPredClient$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
Clazz.new_($I$(15).c$$ext_vamsas_ServiceHandle$S$Z$jalview_datamodel_AlignmentView$jalview_gui_AlignFrame$Z,[this.$finals$.sh, this.$finals$.af.getTitle$(), false, msa, this.$finals$.af, true]);
} else {
if (msa.getSequences$().length > 1) {
Clazz.new_($I$(15).c$$ext_vamsas_ServiceHandle$S$Z$jalview_datamodel_AlignmentView$jalview_gui_AlignFrame$Z,[this.$finals$.sh, this.$finals$.af.getTitle$(), true, msa, this.$finals$.af, true]);
}}});
})()
