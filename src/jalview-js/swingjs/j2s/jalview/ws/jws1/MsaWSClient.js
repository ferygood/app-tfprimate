(function(){var P$=Clazz.newPackage("jalview.ws.jws1"),p$1={},I$=[[0,'jalview.gui.JvOptionPane','jalview.gui.Desktop','jalview.util.MessageManager','jalview.ws.jws1.MsaWSThread','ext.vamsas.MuscleWSServiceLocator','java.net.URL','javax.swing.JMenuItem','jalview.ws.jws1.MsaWSClient']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "MsaWSClient", null, 'jalview.ws.jws1.WS1Client');
...
}var msathread=Clazz.new_($I$(4).c$$ext_vamsas_MuscleWS$S$jalview_gui_WebserviceInfo$jalview_gui_AlignFrame$S$S$jalview_datamodel_AlignmentView$Z$Z$jalview_datamodel_AlignmentI,[this.server, this.WsURL, this.wsInfo, this.alignFrame, this.WebServiceName, jobtitle, msa, submitGaps, preserveOrder, seqdataset]);
this.wsInfo.setthisService$jalview_ws_WSClientI(msathread);
msathread.start$();
}, p$1);

Clazz.newMeth(C$, 'locateWebService', function () {
var loc=Clazz.new_($I$(5));
try {
this.server=loc.getMuscleWS$java_net_URL(Clazz.new_($I$(6).c$$S,[this.WsURL]));
...
var method=Clazz.new_($I$(7).c$$S,[this.WebServiceName]);
...
Clazz.new_($I$(8).c$$ext_vamsas_ServiceHandle$S$jalview_datamodel_AlignmentView$Z$Z$jalview_datamodel_AlignmentI$jalview_gui_AlignFrame,[this.$finals$.serviceHandle, this.$finals$.alignFrame.getTitle$(), msa, false, true, this.$finals$.alignFrame.getViewport$().getAlignment$().getDataset$(), this.$finals$.alignFrame]);
});
})()
...
var methodR=Clazz.new_($I$(7).c$$S,[serviceHandle.getName$() + " Realign"]);
...
Clazz.newMeth(C$, ['actionPerformed$java_awt_event_ActionEvent','actionPerformed$'], function (e) {
var msa=this.$finals$.alignFrame.gatherSequencesForAlignment$();
Clazz.new_($I$(8).c$$ext_vamsas_ServiceHandle$S$jalview_datamodel_AlignmentView$Z$Z$jalview_datamodel_AlignmentI$jalview_gui_AlignFrame,[this.$finals$.serviceHandle, this.$finals$.alignFrame.getTitle$(), msa, true, true, this.$finals$.alignFrame.getViewport$().getAlignment$().getDataset$(), this.$finals$.alignFrame]);
});
})()
