...
msa[i]=Clazz.new_($I$(18).c$$S$S,[seqs[i].getId$(), seqs[i].getSeq$()]);
}
return msa;
}, p$2);
...
(function(){var C$=Clazz.newClass(P$, "SeqSearchWSThread$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
(function(){var C$=Clazz.newClass(P$, "SeqSearchWSThread$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
var featureColours=Clazz.new_($I$(20));
var al=null;
var nf=null;
...
nf=null;
continue;
}var af=Clazz.new_($I$(21).c$$jalview_datamodel_AlignmentI$I$I,[al, 700, 500]);
if (nf != null ) {
...
;
(function(){var C$=Clazz.newClass(P$.SeqSearchWSThread, "SeqSearchWSJob", function(){
...
alseqs=p$2.getVamsasAlignment$vamsas_objects_simple_Alignment.apply(this.this$0, [(this.result).getAlignment$()]);
}var al=Clazz.new_($I$(11).c$$jalview_datamodel_SequenceIA,[alseqs]);
var inFile=null;
try {
inFile=(this.result).getAnnotation$();
if (inFile != null  && inFile.length$() > 0 ) {
Clazz.new_($I$(12)).readAnnotationFile$jalview_datamodel_AlignmentI$S$jalview_io_DataSourceType(al, inFile, $I$(13).PASTE);
}} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
...
if (inFile != null  && inFile.length$() > 0 ) {
var ff=Clazz.new_($I$(14).c$$O$jalview_io_DataSourceType,[inFile, $I$(13).PASTE]);
...
if (inFile != null  && inFile.length$() > 0 ) {
nf=Clazz.new_($I$(15).c$$S$jalview_io_DataSourceType,[inFile, $I$(13).PASTE]);
if (!nf.isValid$()) {
nf.close$();
nf=null;
}}} catch (e) {
