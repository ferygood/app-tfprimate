...
this.wsInfo=Clazz.new_($I$(3).c$$S$S$Z,[this.WebServiceJobTitle, this.WebServiceName + "\n" + this.WebServiceReference , true]);
...
var submit=Clazz.new_($I$(4).c$$S,[this.service.details.Name]);
...
(function(){var C$=Clazz.newClass(P$, "RestClient$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
Clazz.new_($I$(5).c$$jalview_ws_rest_RestServiceDescription$jalview_gui_AlignFrame,[this.b$['jalview.ws.rest.RestClient'].service, this.$finals$.alignFrame]);
});
})()
...
(function(){var C$=Clazz.newClass(P$, "RestClient$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'javax.swing.event.MenuListener', 1);
...
Clazz.newMeth(C$, ['menuSelected$javax_swing_event_MenuEvent','menuSelected$'], function (e) {
});

Clazz.newMeth(C$, ['menuDeselected$javax_swing_event_MenuEvent','menuDeselected$'], function (e) {
});

Clazz.newMeth(C$, ['menuCanceled$javax_swing_event_MenuEvent','menuCanceled$'], function (e) {
});
})()
...
this._input=Clazz.new_($I$(6).c$$jalview_datamodel_AlignmentI$jalview_datamodel_HiddenColumns$jalview_datamodel_SequenceGroup$Z$Z$Z,[this.av.getAlignment$(), this.av.getAlignment$().getHiddenColumns$(), this.av.getSelectionGroup$(), this.av.hasHiddenColumns$(), true, true]);
...
this._input=Clazz.new_($I$(6).c$$jalview_datamodel_AlignmentI$jalview_datamodel_HiddenColumns$jalview_datamodel_SequenceGroup$Z$Z$Z,[this.av.getAlignment$(), this.av.getAlignment$().getHiddenColumns$(), this.av.getSelectionGroup$(), this.av.hasHiddenColumns$(), false, true]);
...
this._input=Clazz.new_($I$(6).c$$jalview_datamodel_AlignmentI$jalview_datamodel_HiddenColumns$jalview_datamodel_SequenceGroup$Z$Z$Z,[this.av.getAlignment$(), this.av.getAlignment$().getHiddenColumns$(), null, this.av.hasHiddenColumns$(), false, true]);
this.viewTitle="" + (this.av.hasHiddenColumns$() ? (Clazz.new_($I$(7).c$$S,[" "]).append$S($I$(2).getString$S("label.visible_region_of")).toString()) : "") + this.af.getTitle$() ;
}var jobsthread=Clazz.new_($I$(8).c$$jalview_ws_rest_RestClient,[this]);
...
var iparams=Clazz.new_($I$(10));
var toolp;
var aliinput=Clazz.new_($I$(11));
aliinput.token="ali_file";
aliinput.writeAsFile=true;
iparams.put$TK$TV(aliinput.token, aliinput);
var sgroups=Clazz.new_($I$(12));
sgroups.setMinsize$I(2);
sgroups.min=2;
iparams.put$TK$TV("groups", sgroups);
sgroups.token="groups";
sgroups.sep=" ";
var shmrService=Clazz.new_($I$(13).c$$S$S$S$S$S$java_util_Map$Z$Z$C,[action, description, name, "http://zeus.few.vu.nl/programs/shmrwww/index.php?tool=jalview", "?tool=jalview", iparams, true, false, "-"]);
...
C$.services.add$TE(descr.toString());
}
} catch (ex) {
...
lst[i++]=Clazz.new_(C$.c$$jalview_ws_rest_RestServiceDescription,[Clazz.new_($I$(13).c$$S,[svc])]);
}
return lst;
}, 1);
...
var rsbsDescrs=Clazz.new_($I$(15));
for (var rsbs, $rsbs = 0, $$rsbs = C$.getRestClients$(); $rsbs<$$rsbs.length&&((rsbs=($$rsbs[$rsbs])),1);$rsbs++) {
rsbsDescrs.add$TE(rsbs.getRestDescription$().toString());
}
return rsbsDescrs;
}, 1);
...
if (rsbsUrls != null ) {
C$.services=Clazz.new_($I$(15).c$$java_util_Collection,[rsbsUrls]);
var sprop=Clazz.new_($I$(7));
