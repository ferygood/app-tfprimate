...
var C$=Clazz.newClass(P$, "HydrophobicColourScheme", null, 'jalview.schemes.ScoreColourScheme');
...
C$.superclazz.c$$IA$DA$D$D.apply(this, [$I$(1).aaIndex, $I$(1).hyd, -3.9, 4.5]);
C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'makeColour$F', function (c) {
return Clazz.new_($I$(2).c$$F$F$F,[c, 0.0, 1.0 - c]);
});
...
return $I$(3).Hydrophobic.toString();
});
