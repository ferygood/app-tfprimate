...
var C$=Clazz.newClass(P$, "TurnColourScheme", null, 'jalview.schemes.ScoreColourScheme');
...
C$.superclazz.c$$IA$DA$D$D.apply(this, [$I$(1).aaIndex, $I$(1).turn, 0.47, 1.56]);
C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'makeColour$F', function (c) {
return Clazz.new_($I$(2).c$$F$F$F,[c, 1 - c, 1 - c]);
});
