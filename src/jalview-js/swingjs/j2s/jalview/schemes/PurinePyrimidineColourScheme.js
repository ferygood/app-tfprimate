...
var C$=Clazz.newClass(P$, "PurinePyrimidineColourScheme", null, 'jalview.schemes.ResidueColourScheme');
...
C$.superclazz.c$$IA$java_awt_ColorA.apply(this, [$I$(1).purinepyrimidineIndex, $I$(1).purinepyrimidine]);
C$.$init$.apply(this);
}, 1);
