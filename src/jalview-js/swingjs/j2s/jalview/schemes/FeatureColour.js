...
}if (nextToken.toLowerCase$().startsWith$S("label")) {
byLabel=true;
mincol=(gcol.hasMoreTokens$() ? gcol.nextToken$() : null);
mincol=(gcol.hasMoreTokens$() ? gcol.nextToken$() : null);
} else if (nextToken.toLowerCase$().startsWith$S("score")) {
mincol=(gcol.hasMoreTokens$() ? gcol.nextToken$() : null);
mincol=(gcol.hasMoreTokens$() ? gcol.nextToken$() : null);
} else if (nextToken.toLowerCase$().startsWith$S("attribute")) {
byAttribute=true;
...
if (byAttribute) {
fc.setAttributeName$SA($I$(3).fromAttributeDisplayName$S(attName));
}return fc;
}var colour=$I$(4).parseColourString$S(descriptor);
if (colour == null ) {
...
if (tok.toLowerCase$().startsWith$S("abso")) {
...
try {
var minColour=$I$(4).parseColourString$S(mincol);
var maxColour=$I$(4).parseColourString$S(maxcol);
...
if (byAttribute) {
featureColour.setAttributeName$SA($I$(3).fromAttributeDisplayName$S(attName));
}var ttype=null;
var tval=null;
if (gcol.hasMoreTokens$()) {
ttype=gcol.nextToken$();
if (ttype.toLowerCase$().startsWith$S("below")) {
featureColour.setBelowThreshold$Z(true);
} else if (ttype.toLowerCase$().startsWith$S("above")) {
featureColour.setAboveThreshold$Z(true);
} else {
if (!ttype.toLowerCase$().startsWith$S("no")) {
...
C$.c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color$F$F.apply(this, [c, c == null  ? $I$(5).white : $I$(4).bleachColour$java_awt_Color$F(c, 0.9), c == null  ? $I$(5).black : c, C$.DEFAULT_NO_COLOUR, 0, 0]);
...
return label == null  ? this.noColour : $I$(4).createColourFromName$S(label);
...
}return String.format$S$OA("%s\t%s", [featureType, colourString]);
});
...
by=C$.I18N_SCORE;
}tt.append$S($I$(1).formatMessage$S$OA("action.by_title_param", [by]));
