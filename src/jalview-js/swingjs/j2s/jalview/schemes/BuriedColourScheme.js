...
var C$=Clazz.newClass(P$, "BuriedColourScheme", null, 'jalview.schemes.ScoreColourScheme');
...
C$.superclazz.c$$IA$DA$D$D.apply(this, [$I$(1).aaIndex, $I$(1).buried, 0.05, 4.6]);
C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'makeColour$F', function (c) {
return Clazz.new_($I$(2).c$$F$F$F,[0, (1.0 - c), c]);
});
