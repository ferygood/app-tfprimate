(function(){var P$=Clazz.newPackage("jalview.schemes"),I$=[[0,'java.awt.Color','jalview.schemes.Consensus','jalview.schemes.ResidueProperties',['jalview.schemes.ClustalxColourScheme','.ConsensusColour'],['jalview.schemes.ClustalxColourScheme','.ClustalColour'],'jalview.util.Comparison','jalview.schemes.JalviewColourScheme']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "ClustalxColourScheme", function(){
...
this.conses[0]=Clazz.new_($I$(2).c$$S$D,["WLVIMAFCYHP", 60]);
this.conses[1]=Clazz.new_($I$(2).c$$S$D,["WLVIMAFCYHP", 80]);
this.conses[2]=Clazz.new_($I$(2).c$$S$D,["ED", 50]);
this.conses[3]=Clazz.new_($I$(2).c$$S$D,["KR", 60]);
this.conses[4]=Clazz.new_($I$(2).c$$S$D,["G", 50]);
this.conses[5]=Clazz.new_($I$(2).c$$S$D,["N", 50]);
this.conses[6]=Clazz.new_($I$(2).c$$S$D,["QE", 50]);
this.conses[7]=Clazz.new_($I$(2).c$$S$D,["P", 50]);
this.conses[8]=Clazz.new_($I$(2).c$$S$D,["TS", 50]);
this.conses[26]=Clazz.new_($I$(2).c$$S$D,["A", 85]);
this.conses[27]=Clazz.new_($I$(2).c$$S$D,["C", 85]);
this.conses[10]=Clazz.new_($I$(2).c$$S$D,["E", 85]);
this.conses[11]=Clazz.new_($I$(2).c$$S$D,["F", 85]);
this.conses[12]=Clazz.new_($I$(2).c$$S$D,["G", 85]);
this.conses[13]=Clazz.new_($I$(2).c$$S$D,["H", 85]);
this.conses[14]=Clazz.new_($I$(2).c$$S$D,["I", 85]);
this.conses[15]=Clazz.new_($I$(2).c$$S$D,["L", 85]);
this.conses[16]=Clazz.new_($I$(2).c$$S$D,["M", 85]);
this.conses[17]=Clazz.new_($I$(2).c$$S$D,["N", 85]);
this.conses[18]=Clazz.new_($I$(2).c$$S$D,["P", 85]);
this.conses[19]=Clazz.new_($I$(2).c$$S$D,["Q", 85]);
this.conses[20]=Clazz.new_($I$(2).c$$S$D,["R", 85]);
this.conses[21]=Clazz.new_($I$(2).c$$S$D,["S", 85]);
this.conses[22]=Clazz.new_($I$(2).c$$S$D,["T", 85]);
this.conses[23]=Clazz.new_($I$(2).c$$S$D,["V", 85]);
this.conses[24]=Clazz.new_($I$(2).c$$S$D,["W", 85]);
this.conses[25]=Clazz.new_($I$(2).c$$S$D,["Y", 85]);
this.conses[28]=Clazz.new_($I$(2).c$$S$D,["K", 85]);
this.conses[29]=Clazz.new_($I$(2).c$$S$D,["D", 85]);
this.conses[30]=Clazz.new_($I$(2).c$$S$D,["G", 0]);
this.conses[31]=Clazz.new_($I$(2).c$$S$D,["P", 0]);
this.colours=Clazz.array($I$(4), [11]);
var tmp8=Clazz.array($I$(2), [1]);
tmp8[0]=this.conses[30];
this.colours[7]=Clazz.new_($I$(4).c$$jalview_schemes_ClustalxColourScheme_ClustalColour$jalview_schemes_ConsensusA, [this, null, $I$(5).ORANGE, tmp8]);
var tmp9=Clazz.array($I$(2), [1]);
tmp9[0]=this.conses[31];
this.colours[8]=Clazz.new_($I$(4).c$$jalview_schemes_ClustalxColourScheme_ClustalColour$jalview_schemes_ConsensusA, [this, null, $I$(5).YELLOW, tmp9]);
var tmp10=Clazz.array($I$(2), [1]);
tmp10[0]=this.conses[27];
this.colours[9]=Clazz.new_($I$(4).c$$jalview_schemes_ClustalxColourScheme_ClustalColour$jalview_schemes_ConsensusA, [this, null, $I$(5).PINK, tmp8]);
...
this.colours[0]=Clazz.new_($I$(4).c$$jalview_schemes_ClustalxColourScheme_ClustalColour$jalview_schemes_ConsensusA, [this, null, $I$(5).BLUE, tmp1]);
this.colours[10]=Clazz.new_($I$(4).c$$jalview_schemes_ClustalxColourScheme_ClustalColour$jalview_schemes_ConsensusA, [this, null, $I$(5).CYAN, tmp1]);
...
this.colours[1]=Clazz.new_($I$(4).c$$jalview_schemes_ClustalxColourScheme_ClustalColour$jalview_schemes_ConsensusA, [this, null, $I$(5).GREEN, tmp2]);
var tmp3=Clazz.array($I$(2), [3]);
tmp3[0]=this.conses[17];
tmp3[1]=this.conses[29];
tmp3[2]=this.conses[5];
this.colours[2]=Clazz.new_($I$(4).c$$jalview_schemes_ClustalxColourScheme_ClustalColour$jalview_schemes_ConsensusA, [this, null, $I$(5).GREEN, tmp3]);
...
this.colours[3]=Clazz.new_($I$(4).c$$jalview_schemes_ClustalxColourScheme_ClustalColour$jalview_schemes_ConsensusA, [this, null, $I$(5).GREEN, tmp4]);
var tmp5=Clazz.array($I$(2), [4]);
tmp5[0]=this.conses[3];
tmp5[1]=this.conses[28];
tmp5[2]=this.conses[20];
tmp5[3]=this.conses[19];
this.colours[4]=Clazz.new_($I$(4).c$$jalview_schemes_ClustalxColourScheme_ClustalColour$jalview_schemes_ConsensusA, [this, null, $I$(5).RED, tmp5]);
...
this.colours[5]=Clazz.new_($I$(4).c$$jalview_schemes_ClustalxColourScheme_ClustalColour$jalview_schemes_ConsensusA, [this, null, $I$(5).MAGENTA, tmp6]);
...
this.colours[6]=Clazz.new_($I$(4).c$$jalview_schemes_ClustalxColourScheme_ClustalColour$jalview_schemes_ConsensusA, [this, null, $I$(5).MAGENTA, tmp7]);
...
;
(function(){var C$=Clazz.newClass(P$.ClustalxColourScheme, "ClustalColour", function(){
...
C$.$init$.apply(this);
this.colour=Clazz.new_($I$(1).c$$F$F$F,[r, g, b]);
}, 1);
...
;
(function(){var C$=Clazz.newClass(P$.ClustalxColourScheme, "ConsensusColour", function(){
