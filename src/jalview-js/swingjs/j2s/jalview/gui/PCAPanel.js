...
this.progressBar=Clazz.new_($I$(2).c$$javax_swing_JPanel$javax_swing_JLabel,[this.statusPanel, this.statusBar]);
this.addInternalFrameListener$javax_swing_event_InternalFrameListener(((P$.PCAPanel$1||
(function(){var C$=Clazz.newClass(P$, "PCAPanel$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('javax.swing.event.InternalFrameAdapter'), null, 1);
...
), Clazz.new_($I$(3), [this, null],P$.PCAPanel$1)));
...
this.setPcaModel$jalview_viewmodel_PCAModel(Clazz.new_($I$(5).c$$jalview_datamodel_AlignmentView$jalview_datamodel_SequenceIA$Z$jalview_api_analysis_ScoreModelI$jalview_api_analysis_SimilarityParamsI,[seqstrings, seqs, nucleotide, scoreModel, params]));
$I$(6).Register$java_awt_Component$S(this, this.av.getSequenceSetId$());
this.setRotatableCanvas$jalview_gui_RotatableCanvas(Clazz.new_($I$(7).c$$jalview_gui_AlignmentPanel,[alignPanel]));
...
(function(){var C$=Clazz.newClass(P$, "PCAPanel$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, [['jalview.gui.JalviewColourChooser','jalview.gui.JalviewColourChooser.ColourChooserListener']], 1);
...
Clazz.new_($I$(10).c$$S$OutOfMemoryError,["calculating PCA", er]);
this.working=false;
return;
} else {
throw er;
...
this.setMinimumSize$java_awt_Dimension(Clazz.new_($I$(12).c$$I$I,[470, 250]));
}this.working=false;
});
...
Clazz.new_($I$(10).c$$S$OutOfMemoryError,["opening PCA details", oom]);
cap.dispose$();
} else {
throw oom;
}
...
var printer=Clazz.new_($I$(15), [this, null]);
printer.start$();
});
...
var al=Clazz.new_($I$(17).c$$jalview_datamodel_SequenceIA,[alAndColsel[0]]);
...
var af=Clazz.new_($I$(18).c$$jalview_datamodel_AlignmentI$jalview_datamodel_HiddenColumns$I$I,[al, alAndColsel[1], 700, 500]);
...
(function(){var C$=Clazz.newClass(P$, "PCAPanel$3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, [['jalview.gui.ImageExporter','jalview.gui.ImageExporter.ImageWriterI']], 1);
...
var exporter=Clazz.new_($I$(19).c$$jalview_gui_ImageExporter_ImageWriterI$jalview_gui_IProgressIndicator$jalview_util_ImageMaker_TYPE$S,[writer, null, type, pca]);
...
var item;
var buttonGroup=Clazz.new_($I$(20));
var iSize=aps.length;
for (var i=0; i < iSize; i++) {
var panel=aps[i];
item=Clazz.new_($I$(21).c$$S$Z,[panel.av.getViewName$(), panel.av === this.getRotatableCanvas$().av ]);
buttonGroup.add$javax_swing_AbstractButton(item);
item.addActionListener$java_awt_event_ActionListener(((P$.PCAPanel$4||
(function(){var C$=Clazz.newClass(P$, "PCAPanel$4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
var itemf=Clazz.new_($I$(21).c$$S,["All Views"]);
...
(function(){var C$=Clazz.newClass(P$, "PCAPanel$5", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
if (Clazz.exceptionOf(oom,"OutOfMemoryError")){
Clazz.new_($I$(10).c$$S$OutOfMemoryError,["exporting PCA points", oom]);
cap.dispose$();
} else {
throw oom;
}
...
if (Clazz.exceptionOf(oom,"OutOfMemoryError")){
Clazz.new_($I$(10).c$$S$OutOfMemoryError,["exporting transformed PCA points", oom]);
cap.dispose$();
} else {
throw oom;
}
...
;
(function(){var C$=Clazz.newClass(P$.PCAPanel, "PCAPrinter", function(){
