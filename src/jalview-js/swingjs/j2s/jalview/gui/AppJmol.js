...
var pdbentry=Clazz.new_($I$(6).c$$S$S$jalview_datamodel_PDBEntry_Type$S,[ids[i], null, $I$(7).PDB, files[i]]);
pdbentrys[i]=pdbentry;
}
this.jmb=Clazz.new_($I$(8).c$$jalview_gui_AppJmol$jalview_structure_StructureSelectionManager$jalview_datamodel_PDBEntryA$jalview_datamodel_SequenceIAA$jalview_io_DataSourceType,[this, ap.getStructureSelectionManager$(), pdbentrys, seqs, null]);
...
(function(){var C$=Clazz.newClass(P$, "AppJmol$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('javax.swing.event.InternalFrameAdapter'), null, 1);
...
), Clazz.new_($I$(9), [this, null],P$.AppJmol$1)));
...
(function(){var C$=Clazz.newClass(P$, "AppJmol$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('javax.swing.event.InternalFrameAdapter'), null, 1);
...
), Clazz.new_($I$(9), [this, null],P$.AppJmol$2)));
}, p$1);
...
this.renderPanel=Clazz.new_($I$(12), [this, null]);
...
var bl=Clazz.new_($I$(14));
bl.setHgap$I(0);
bl.setVgap$I(0);
this.scriptWindow=Clazz.new_($I$(15).c$$java_awt_LayoutManager,[bl]);
...
if (item.isSelected$()) {
toshow.addElement$TE(item.getText$());
}}}
...
var fileList=Clazz.new_($I$(17));
for (var s, $s = files.iterator$(); $s.hasNext$()&&((s=($s.next$())),1);) {
fileList.append$S(" ").append$S("\"").append$S($I$(18).escapeString$S(s)).append$S("\"");
}
...
var oomerror = e$$;
{
Clazz.new_($I$(19).c$$S$OutOfMemoryError,["When trying to open the Jmol viewer!", oomerror]);
...
var oomerror = e$$;
{
Clazz.new_($I$(19).c$$S$OutOfMemoryError,["When trying to add structures to the Jmol viewer!", oomerror]);
$I$(20).log.debug$O("File locations are " + filesString);
return;
}
} else if (Clazz.exceptionOf(e$$,"Exception")){
...
(function(){var C$=Clazz.newClass(P$, "AppJmol$3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
var errormsgs=Clazz.new_($I$(17));
var files=Clazz.new_($I$(22));
var pdbid="";
try {
...
var oomerror = e$$;
{
Clazz.new_($I$(19).c$$S$OutOfMemoryError,["Retrieving PDB id " + pdbid, oomerror]);
}
} else if (Clazz.exceptionOf(e$$,"Exception")){
var ex = e$$;
{
...
if (pdbseq != null ) {
file=Clazz.new_($I$(24).c$$S,[pdbseq.getSequenceAt$I(0).getAllPDBEntries$().elementAt$I(0).getFile$()]).getAbsolutePath$();
...
if (filesInViewer[c].equals$O(file)) {
file=null;
break;
}}
}if (file != null ) {
...
var oomerror = e$$;
{
Clazz.new_($I$(19).c$$S$OutOfMemoryError,["Retrieving PDB files: " + pdbid, oomerror]);
}
} else if (Clazz.exceptionOf(e$$,"Exception")){
var ex = e$$;
{
...
(function(){var C$=Clazz.newClass(P$, "AppJmol$4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, [['jalview.gui.ImageExporter','jalview.gui.ImageExporter.ImageWriterI']], 1);
...
), Clazz.new_(P$.AppJmol$4.$init$, [this, {width: width, height: height}]));
var view=$I$(4).getString$S("action.view").toLowerCase$();
var exporter=Clazz.new_($I$(26).c$$jalview_gui_ImageExporter_ImageWriterI$jalview_gui_IProgressIndicator$jalview_util_ImageMaker_TYPE$S,[writer, this.jmb.getIProgressIndicator$(), type, this.getTitle$()]);
...
this.splitPane=Clazz.new_($I$(28).c$$I,[0]);
...
;
(function(){var C$=Clazz.newClass(P$.AppJmol, "RenderPanel", function(){
