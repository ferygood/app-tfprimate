...
(function(){var C$=Clazz.newClass(P$, "CutAndPasteTransfer$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
var chooser=Clazz.new_($I$(3).c$$S,[$I$(4).getProperty$S("LAST_DIRECTORY")]);
chooser.setAcceptAllFileFilterUsed$Z(false);
chooser.setFileView$javax_swing_filechooser_FileView(Clazz.new_($I$(5)));
...
if (value == 0) {
try {
var out=Clazz.new_($I$(6).c$$java_io_Writer,[Clazz.new_($I$(7).c$$java_io_File,[chooser.getSelectedFile$()])]);
...
c.setContents$java_awt_datatransfer_Transferable$java_awt_datatransfer_ClipboardOwner(Clazz.new_($I$(9).c$$S,[this.textarea.getSelectedText$()]), null);
});
...
try {
format=Clazz.new_($I$(11)).identify$S$jalview_io_DataSourceType(text, $I$(12).PASTE);
} catch (e1) {
...
try {
var fa=Clazz.new_($I$(17).c$$jalview_api_AlignmentViewPanel,[this.alignpanel]);
...
af=Clazz.new_($I$(18).c$$jalview_datamodel_AlignmentI$jalview_datamodel_SequenceIA$jalview_datamodel_HiddenColumns$I$I,[al, hiddenSeqs, hidden, 700, 500]);
...
af=Clazz.new_($I$(18).c$$jalview_datamodel_AlignmentI$I$I,[al, 700, 500]);
...
if (e.isPopupTrigger$()) {
var popup=Clazz.new_($I$(20).c$$S,[$I$(2).getString$S("action.edit")]);
var item=Clazz.new_($I$(21).c$$S,[$I$(2).getString$S("action.copy")]);
item.addActionListener$java_awt_event_ActionListener(((P$.CutAndPasteTransfer$2||
(function(){var C$=Clazz.newClass(P$, "CutAndPasteTransfer$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
item=Clazz.new_($I$(21).c$$S,[$I$(2).getString$S("action.paste")]);
item.addActionListener$java_awt_event_ActionListener(((P$.CutAndPasteTransfer$3||
(function(){var C$=Clazz.newClass(P$, "CutAndPasteTransfer$3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
