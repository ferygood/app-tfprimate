...
C$.$font=Clazz.new_($I$(1).c$$S$I$I,["Arial", 0, 11]);
...
var newAnnotation=Clazz.new_($I$(4).c$$S$S$jalview_datamodel_AnnotationA,[null, null, Clazz.array($I$(5), [this.ap.av.getAlignment$().getWidth$()])]);
...
Clazz.new_($I$(6).c$$jalview_gui_AlignmentPanel,[this.ap]).exportAnnotation$jalview_datamodel_AlignmentAnnotation(aa[this.selectedRow]);
...
var dialog=Clazz.new_($I$(7).c$$S$S$S$S,[annotation.label, annotation.description, name, description]);
dialog.showDialog$javax_swing_JComponent$S$Runnable(this.ap.alignFrame, title, ((P$.AnnotationLabels$1||
(function(){var C$=Clazz.newClass(P$, "AnnotationLabels$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
), Clazz.new_(P$.AnnotationLabels$1.$init$, [this, {annotation: annotation, dialog: dialog, addNew: addNew}])));
});
...
(function(){var C$=Clazz.newClass(P$, "AnnotationLabels$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
$I$(10).showOrHideSequenceAnnotations$jalview_datamodel_AlignmentI$java_util_Collection$java_util_List$Z$Z(this.b$['jalview.gui.AnnotationLabels'].ap.av.getAlignment$(), $I$(11).singleton$TT(this.$finals$.label), null, false, false);
this.b$['jalview.gui.AnnotationLabels'].ap.refresh$Z(true);
});
})()
), Clazz.new_(P$.AnnotationLabels$2.$init$, [this, {label: label}])));
pop.add$javax_swing_JMenuItem(hideType);
}}item=Clazz.new_($I$(9).c$$S,[C$.DELETE]);
item.addActionListener$java_awt_event_ActionListener(this);
pop.add$javax_swing_JMenuItem(item);
if (this.hasHiddenRows) {
item=Clazz.new_($I$(9).c$$S,[C$.SHOWALL]);
item.addActionListener$java_awt_event_ActionListener(this);
pop.add$javax_swing_JMenuItem(item);
}item=Clazz.new_($I$(9).c$$S,[C$.OUTPUT_TEXT]);
item.addActionListener$java_awt_event_ActionListener(this);
pop.add$javax_swing_JMenuItem(item);
if (this.selectedRow < aa.length) {
var label=aa[this.selectedRow].label;
...
pop.addSeparator$();
item=Clazz.new_($I$(12).c$$S$Z,[C$.TOGGLE_LABELSCALE, aa[this.selectedRow].scaleColLabel]);
item.addActionListener$java_awt_event_ActionListener(this);
pop.add$javax_swing_JMenuItem(item);
...
var consclipbrd=Clazz.new_($I$(9).c$$S,[C$.COPYCONS_SEQ]);
...
pop.addSeparator$();
var cbmi=Clazz.new_($I$(12).c$$S$Z,[$I$(2).getString$S("label.ignore_gaps_consensus"), (ann.groupRef != null ) ? ann.groupRef.getIgnoreGapsConsensus$() : ap.av.isIgnoreGapsConsensus$()]);
var aaa=ann;
cbmi.addActionListener$java_awt_event_ActionListener(((P$.AnnotationLabels$3||
(function(){var C$=Clazz.newClass(P$, "AnnotationLabels$3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
), Clazz.new_(P$.AnnotationLabels$3.$init$, [this, {aaa: aaa, cbmi: cbmi, ap: ap}])));
pop.add$javax_swing_JMenuItem(cbmi);
if (aaa.groupRef != null ) {
var chist=Clazz.new_($I$(12).c$$S$Z,[$I$(2).getString$S("label.show_group_histogram"), ann.groupRef.isShowConsensusHistogram$()]);
chist.addActionListener$java_awt_event_ActionListener(((P$.AnnotationLabels$4||
(function(){var C$=Clazz.newClass(P$, "AnnotationLabels$4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
), Clazz.new_(P$.AnnotationLabels$4.$init$, [this, {aaa: aaa, chist: chist, ap: ap}])));
pop.add$javax_swing_JMenuItem(chist);
var cprofl=Clazz.new_($I$(12).c$$S$Z,[$I$(2).getString$S("label.show_group_logo"), ann.groupRef.isShowSequenceLogo$()]);
cprofl.addActionListener$java_awt_event_ActionListener(((P$.AnnotationLabels$5||
(function(){var C$=Clazz.newClass(P$, "AnnotationLabels$5", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
), Clazz.new_(P$.AnnotationLabels$5.$init$, [this, {aaa: aaa, cprofl: cprofl, ap: ap}])));
pop.add$javax_swing_JMenuItem(cprofl);
var cproflnorm=Clazz.new_($I$(12).c$$S$Z,[$I$(2).getString$S("label.normalise_group_logo"), ann.groupRef.isNormaliseSequenceLogo$()]);
cproflnorm.addActionListener$java_awt_event_ActionListener(((P$.AnnotationLabels$6||
(function(){var C$=Clazz.newClass(P$, "AnnotationLabels$6", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
), Clazz.new_(P$.AnnotationLabels$6.$init$, [this, {aaa: aaa, cproflnorm: cproflnorm, ap: ap}])));
pop.add$javax_swing_JMenuItem(cproflnorm);
} else {
var chist=Clazz.new_($I$(12).c$$S$Z,[$I$(2).getString$S("label.show_histogram"), ap.av.isShowConsensusHistogram$()]);
chist.addActionListener$java_awt_event_ActionListener(((P$.AnnotationLabels$7||
(function(){var C$=Clazz.newClass(P$, "AnnotationLabels$7", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
pop.add$javax_swing_JMenuItem(chist);
var cprof=Clazz.new_($I$(12).c$$S$Z,[$I$(2).getString$S("label.show_logo"), ap.av.isShowSequenceLogo$()]);
cprof.addActionListener$java_awt_event_ActionListener(((P$.AnnotationLabels$8||
(function(){var C$=Clazz.newClass(P$, "AnnotationLabels$8", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
var cprofnorm=Clazz.new_($I$(12).c$$S$Z,[$I$(2).getString$S("label.normalise_logo"), ap.av.isNormaliseSequenceLogo$()]);
cprofnorm.addActionListener$java_awt_event_ActionListener(((P$.AnnotationLabels$9||
(function(){var C$=Clazz.newClass(P$, "AnnotationLabels$9", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
if ((d.height - dif) > 20) {
this.ap.annotationScroller.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(13).c$$I$I,[d.width, d.height - dif]));
d=this.ap.annotationSpaceFillerHolder.getPreferredSize$();
this.ap.annotationSpaceFillerHolder.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(13).c$$I$I,[d.width, d.height - dif]));
...
if (aa == null ) {
return null;
}var msg=Clazz.new_($I$(14).c$$I,[32]);
...
this.ap.av.setSelectionGroup$jalview_datamodel_SequenceGroup(Clazz.new_($I$(18).c$$jalview_datamodel_SequenceGroup,[aa[this.selectedRow].groupRef]));
} else {
...
this.ap.getSeqPanel$().ap.getIdPanel$().highlightSearchResults$java_util_List($I$(20).asList$TTA(Clazz.array($I$(21), -1, [aa[this.selectedRow].sequenceRef])));
} else if (evt.getClickCount$() >= 2) {
this.ap.getSeqPanel$().ap.getIdPanel$().highlightSearchResults$java_util_List(null);
var sg=this.ap.av.getSelectionGroup$();
if (sg != null ) {
if (!($I$(17).isControlDown$java_awt_event_MouseEvent(evt) || evt.isShiftDown$() )) {
sg=Clazz.new_($I$(18).c$$jalview_datamodel_SequenceGroup,[sg]);
sg.clear$();
...
if (dseqs[0] == null ) {
dseqs[0]=Clazz.new_($I$(22).c$$jalview_datamodel_SequenceI,[sq]);
...
}var ds=Clazz.new_($I$(25).c$$jalview_datamodel_SequenceIA,[dseqs]);
...
}var output=Clazz.new_($I$(26)).formatSequences$jalview_io_FileFormatI$jalview_datamodel_SequenceIA$SA$IA($I$(27).Fasta, seqs, omitHidden, alignmentStartEnd);
$I$(28).getDefaultToolkit$().getSystemClipboard$().setContents$java_awt_datatransfer_Transferable$java_awt_datatransfer_ClipboardOwner(Clazz.new_($I$(29).c$$S,[output]), $I$(30).instance);
var hiddenColumns=null;
if (this.av.hasHiddenColumns$()) {
hiddenColumns=Clazz.new_($I$(31).c$$jalview_datamodel_HiddenColumns,[this.av.getAlignment$().getHiddenColumns$()]);
