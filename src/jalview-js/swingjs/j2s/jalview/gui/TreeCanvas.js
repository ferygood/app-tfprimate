...
var rect=Clazz.new_($I$(6).c$$I$I$I$I,[xend + 10, ypos - (charHeight/2|0), charWidth, charHeight]);
...
this.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(11).c$$I$I,[this.scrollPane.getWidth$(), this.fm.getHeight$() * this.nameHash.size$()]));
...
(function(){var C$=Clazz.newClass(P$, "TreeCanvas$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, [['jalview.gui.JalviewColourChooser','jalview.gui.JalviewColourChooser.ColourChooserListener']], 1);
...
var cs=null;
var _sg=Clazz.new_($I$(3).c$$java_util_List$S$jalview_schemes_ColourSchemeI$Z$Z$Z$I$I,[sequences, null, cs, true, true, false, 0, this.av.getAlignment$().getWidth$() - 1]);
_sg.setName$S("JTreeGroup:" + _sg.hashCode$());
_sg.setIdColour$java_awt_Color(col);
for (var a=0; a < aps.length; a++) {
var sg=Clazz.new_($I$(3).c$$jalview_datamodel_SequenceGroup,[_sg]);
...
var c=Clazz.new_($I$(17).c$$S$java_util_List$I$I,["Group", sg.getSequences$java_util_Map(null), sg.getStartRes$(), sg.getEndRes$()]);
c.calculate$();
