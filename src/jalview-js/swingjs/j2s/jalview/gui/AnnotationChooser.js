(function(){var P$=Clazz.newPackage("jalview.gui"),p$1={},I$=[[0,'java.awt.Font','java.util.HashMap','java.awt.GridLayout','javax.swing.JPanel','java.awt.FlowLayout','java.awt.Checkbox','java.util.ArrayList','java.awt.BorderLayout','java.awt.CheckboxGroup','jalview.util.MessageManager','jalview.gui.JvSwingUtils','javax.swing.JButton','javax.swing.JInternalFrame','javax.swing.JLayeredPane','jalview.gui.Desktop']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "AnnotationChooser", null, 'javax.swing.JPanel');
C$.CHECKBOX_FONT=null;

C$.$clinit$ = function() {Clazz.load(C$, 1);
C$.CHECKBOX_FONT=Clazz.new_($I$(1).c$$S$I$I,["Serif", 1, 12]);
}
...
this.applyToSelectedSequences=false;
this.applyToUnselectedSequences=false;
this.selectedTypes=null;
}, 1);

Clazz.newMeth(C$, '$init$', function () {
this.resetState=null;
this.selectedTypes=Clazz.new_($I$(2));
}, 1);
...
this.setLayout$java_awt_LayoutManager(Clazz.new_($I$(3).c$$I$I,[3, 1]));
...
var jp=Clazz.new_($I$(4).c$$java_awt_LayoutManager,[Clazz.new_($I$(5).c$$I,[0])]);
...
var check=Clazz.new_($I$(6).c$$S,[type]);
check.setFont$java_awt_Font(C$.CHECKBOX_FONT);
check.addItemListener$java_awt_event_ItemListener(((P$.AnnotationChooser$1||
(function(){var C$=Clazz.newClass(P$, "AnnotationChooser$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
this.b$['jalview.gui.AnnotationChooser'].selectedTypes.put$TK$TV(this.$finals$.type, this.$finals$.type);
} else {
...
jp.setLayout$java_awt_LayoutManager(Clazz.new_($I$(8)));
...
var applyToOptions=Clazz.new_($I$(4).c$$java_awt_LayoutManager,[Clazz.new_($I$(5).c$$I,[0])]);
var actingOn=Clazz.new_($I$(9));
var forAll=$I$(10).getString$S("label.all_sequences");
var allSequences=Clazz.new_($I$(6).c$$S$java_awt_CheckboxGroup$Z,[forAll, actingOn, wholeAlignment]);
allSequences.addItemListener$java_awt_event_ItemListener(((P$.AnnotationChooser$2||
(function(){var C$=Clazz.newClass(P$, "AnnotationChooser$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
var selectedSequences=Clazz.new_($I$(6).c$$S$java_awt_CheckboxGroup$Z,[forSelected, actingOn, !wholeAlignment]);
...
(function(){var C$=Clazz.newClass(P$, "AnnotationChooser$3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
var unselectedSequences=Clazz.new_($I$(6).c$$S$java_awt_CheckboxGroup$Z,[exceptSelected, actingOn, false]);
...
(function(){var C$=Clazz.newClass(P$, "AnnotationChooser$4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
var showHideOptions=Clazz.new_($I$(4).c$$java_awt_LayoutManager,[Clazz.new_($I$(5).c$$I,[0])]);
var showOrHide=Clazz.new_($I$(9));
var showLabel=$I$(10).getString$S("label.show_selected_annotations");
var showOption=Clazz.new_($I$(6).c$$S$java_awt_CheckboxGroup$Z,[showLabel, showOrHide, false]);
showOption.addItemListener$java_awt_event_ItemListener(((P$.AnnotationChooser$5||
(function(){var C$=Clazz.newClass(P$, "AnnotationChooser$5", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
var hideOption=Clazz.new_($I$(6).c$$S$java_awt_CheckboxGroup$Z,[hideLabel, showOrHide, true]);
hideOption.addItemListener$java_awt_event_ItemListener(((P$.AnnotationChooser$6||
(function(){var C$=Clazz.newClass(P$, "AnnotationChooser$6", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
var ok=Clazz.new_($I$(12).c$$S,[$I$(10).getString$S("action.ok")]);
ok.setFont$java_awt_Font(labelFont);
ok.addActionListener$java_awt_event_ActionListener(((P$.AnnotationChooser$7||
(function(){var C$=Clazz.newClass(P$, "AnnotationChooser$7", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
var cancel=Clazz.new_($I$(12).c$$S,[$I$(10).getString$S("action.cancel")]);
cancel.setFont$java_awt_Font(labelFont);
cancel.addActionListener$java_awt_event_ActionListener(((P$.AnnotationChooser$8||
(function(){var C$=Clazz.newClass(P$, "AnnotationChooser$8", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
