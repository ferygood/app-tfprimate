...
}var xrefs=Clazz.new_($I$(3).c$$jalview_datamodel_SequenceIA$jalview_datamodel_AlignmentI,[this.sel, dataset]).findXrefSequences$S$Z(this.source, dna);
if (xrefs == null ) {
return;
}C$.findGeneLoci$java_util_List(xrefs.getSequences$());
var featureColourScheme=Clazz.new_($I$(4)).getFeatureColourScheme$S(this.source);
...
return;
}}var newFrame=Clazz.new_($I$(7).c$$jalview_datamodel_AlignmentI$I$I,[xrefsAlignment, 700, 500]);
...
this.xrefViews.add$TE(newFrame.alignPanel);
return;
}var copyThis=Clazz.new_($I$(7).c$$jalview_datamodel_AlignmentI$I$I,[copyAlignment, 700, 500]);
...
var sf=Clazz.new_($I$(9).c$$jalview_jbgui_GAlignFrame$jalview_jbgui_GAlignFrame,[dna ? copyThis : newFrame, dna ? newFrame : copyThis]);
...
this.xrefViews.add$TE(dna ? copyThis.alignPanel : newFrame.alignPanel);
this.xrefViews.add$TE(!dna ? copyThis.alignPanel : newFrame.alignPanel);
} catch (e$$) {
if (Clazz.exceptionOf(e$$,"OutOfMemoryError")){
var e = e$$;
{
Clazz.new_($I$(10).c$$S$OutOfMemoryError,["whilst fetching crossreferences", e]);
}
} else {
var e = e$$;
{
...
var retrievedLoci=Clazz.new_($I$(11));
...
return;
}var ensemblDivisions=Clazz.new_($I$(12)).getDivisions$();
var divisionsArray=ensemblDivisions.toArray$TTA(Clazz.array(String, [ensemblDivisions.size$()]));
...
retrievedLoci.put$TK$TV(dbref, geneLoci);
return true;
...
var al=Clazz.new_($I$(19).c$$jalview_datamodel_SequenceIA,[sprods]);
