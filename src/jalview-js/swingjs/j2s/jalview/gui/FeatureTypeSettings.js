...
C$.DECFMT_2_2=Clazz.new_($I$(2).c$$S,["##.##"]);
}
...
this.max=0;
this.scaleFactor=0;
this.simpleColour=null;
this.byCategory=null;
this.graduatedColour=null;
this.coloursPanel=null;
this.filtersPanel=null;
this.singleColour=null;
this.minColour=null;
this.maxColour=null;
this.threshold=null;
this.slider=null;
...
this.changeColourAction=null;
this.noValueCombo=null;
this.colourByTextCombo=null;
this.colourByRangeCombo=null;
this.andFilters=null;
this.orFilters=null;
this.filters=null;
this.chooseFiltersPanel=null;
}, 1);

Clazz.newMeth(C$, '$init$', function () {
this.adjusting=false;
this.simpleColour=Clazz.new_($I$(3));
this.byCategory=Clazz.new_($I$(3));
this.graduatedColour=Clazz.new_($I$(3));
this.singleColour=Clazz.new_($I$(4));
this.minColour=Clazz.new_($I$(4));
this.maxColour=Clazz.new_($I$(4));
this.threshold=Clazz.new_($I$(5));
this.slider=Clazz.new_($I$(6));
this.thresholdValue=Clazz.new_($I$(7).c$$I,[20]);
this.thresholdIsMin=Clazz.new_($I$(8));
this.featureSettings=null;
}, 1);
...
this.threshline=Clazz.new_($I$(10).c$$F$S$java_awt_Color,[(this.max - this.min) / 2.0, "Threshold", $I$(11).black]);
...
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
var graduatedColourPanel=Clazz.new_($I$(4));
graduatedColourPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(14).c$$java_awt_Container$I,[graduatedColourPanel, 1]));
...
var graduatedChoicePanel=Clazz.new_($I$(4).c$$java_awt_LayoutManager,[Clazz.new_($I$(16).c$$I,[0])]);
graduatedChoicePanel.setBackground$java_awt_Color($I$(11).white);
this.graduatedColour=Clazz.new_($I$(3).c$$S,[$I$(1).getString$S("label.by_range_of") + ":"]);
this.graduatedColour.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(17).c$$I$I,[130, 20]));
...
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
var colourRangePanel=Clazz.new_($I$(4).c$$java_awt_LayoutManager,[Clazz.new_($I$(16).c$$I,[0])]);
...
this.minColour.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(17).c$$I$I,[40, 20]));
...
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.MouseAdapter'), null, 1);
...
), Clazz.new_($I$(19), [this, null],P$.FeatureTypeSettings$4)));
...
this.maxColour.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(17).c$$I$I,[40, 20]));
...
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$5", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.MouseAdapter'), null, 1);
...
), Clazz.new_($I$(19), [this, null],P$.FeatureTypeSettings$5)));
this.maxColour.setBorder$javax_swing_border_Border(Clazz.new_($I$(20).c$$java_awt_Color,[$I$(11).black]));
...
}this.noValueCombo=Clazz.new_($I$(5));
this.noValueCombo.addItem$TE($I$(1).getString$S("label.no_colour"));
this.noValueCombo.addItem$TE($I$(1).getString$S("label.min_colour"));
this.noValueCombo.addItem$TE($I$(1).getString$S("label.max_colour"));
this.noValueCombo.addItemListener$java_awt_event_ItemListener(((P$.FeatureTypeSettings$6||
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$6", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
var minText=Clazz.new_($I$(22).c$$S,[$I$(1).getString$S("label.min_value") + ":"]);
minText.setFont$java_awt_Font($I$(15).getLabelFont$());
var maxText=Clazz.new_($I$(22).c$$S,[$I$(1).getString$S("label.max_value") + ":"]);
maxText.setFont$java_awt_Font($I$(15).getLabelFont$());
var noText=Clazz.new_($I$(22).c$$S,[$I$(1).getString$S("label.no_value") + ":"]);
...
var thresholdPanel=Clazz.new_($I$(4).c$$java_awt_LayoutManager,[Clazz.new_($I$(16).c$$I,[0])]);
...
this.threshold.addItem$TE($I$(1).getString$S("label.threshold_feature_no_threshold"));
this.threshold.addItem$TE($I$(1).getString$S("label.threshold_feature_above_threshold"));
this.threshold.addItem$TE($I$(1).getString$S("label.threshold_feature_below_threshold"));
this.thresholdValue.addActionListener$java_awt_event_ActionListener(((P$.FeatureTypeSettings$7||
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$7", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$8", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.FocusAdapter'), null, 1);
...
), Clazz.new_($I$(23), [this, null],P$.FeatureTypeSettings$8)));
...
this.slider.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(17).c$$I$I,[100, 32]));
...
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$9", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'javax.swing.event.ChangeListener', 1);
...
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$10", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.MouseAdapter'), null, 1);
...
this.b$['jalview.gui.FeatureTypeSettings'].ap.paintAlignment$Z$Z(true, true);
}});
})()
), Clazz.new_($I$(19), [this, null],P$.FeatureTypeSettings$10)));
this.thresholdValue.setEnabled$Z(false);
...
var okCancelPanel=Clazz.new_($I$(4));
...
var colourByPanel=Clazz.new_($I$(4));
colourByPanel.setBackground$java_awt_Color($I$(11).white);
colourByPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(14).c$$java_awt_Container$I,[colourByPanel, 1]));
$I$(15).createTitledBorder$javax_swing_JComponent$S$Z(colourByPanel, $I$(1).getString$S("action.colour"), true);
var simpleColourPanel=Clazz.new_($I$(4).c$$java_awt_LayoutManager,[Clazz.new_($I$(16).c$$I,[0])]);
simpleColourPanel.setBackground$java_awt_Color($I$(11).white);
colourByPanel.add$java_awt_Component(simpleColourPanel);
this.simpleColour=Clazz.new_($I$(3).c$$S,[$I$(1).getString$S("label.simple_colour")]);
this.simpleColour.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(17).c$$I$I,[130, 20]));
...
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$11", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
this.singleColour.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(17).c$$I$I,[40, 20]));
...
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$12", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.MouseAdapter'), null, 1);
...
), Clazz.new_($I$(19), [this, null],P$.FeatureTypeSettings$12)));
simpleColourPanel.add$java_awt_Component(this.simpleColour);
simpleColourPanel.add$java_awt_Component(this.singleColour);
var byTextPanel=Clazz.new_($I$(4).c$$java_awt_LayoutManager,[Clazz.new_($I$(16).c$$I,[0])]);
...
this.byCategory=Clazz.new_($I$(3).c$$S,[$I$(1).getString$S("label.by_text_of") + ":"]);
this.byCategory.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(17).c$$I$I,[130, 20]));
this.byCategory.setOpaque$Z(false);
this.byCategory.addItemListener$java_awt_event_ItemListener(((P$.FeatureTypeSettings$13||
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$13", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$14", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$15", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, [['jalview.gui.JalviewColourChooser','jalview.gui.JalviewColourChooser.ColourChooserListener']], 1);
...
Clazz.newMeth(C$, ['colourSelected$java_awt_Color','colourSelected$'], function (col) {
...
this.ap.paintAlignment$Z$Z(updateStructsAndOverview, updateStructsAndOverview);
p$1.updateColoursPanel.apply(this, []);
});
...
var thresh=0.0;
try {
thresh=(Float.valueOf$S(this.thresholdValue.getText$())).floatValue$();
} catch (e) {
...
}var fc=Clazz.new_($I$(26).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color$F$F,[this.singleColour.getBackground$(), this.minColour.getBackground$(), this.maxColour.getBackground$(), noColour, minValue, maxValue]);
...
this.featureSettings.actionPerformed$(Clazz.new_($I$(27).c$$O$I$S,[this, 0, "CLOSED"]));
}});
...
var displayAtts=Clazz.new_($I$(28));
var tooltips=Clazz.new_($I$(28));
if (withText) {
displayAtts.add$TE(C$.LABEL_18N);
tooltips.add$TE($I$(1).getString$S("label.description"));
}if (withRange) {
var minMax=this.fr.getMinMax$().get$O(this.featureType);
if (minMax != null  && minMax[0][0] != minMax[0][1]  ) {
displayAtts.add$TE(C$.SCORE_18N);
tooltips.add$TE(C$.SCORE_18N);
...
continue;
}displayAtts.add$TE($I$(9).toAttributeDisplayName$SA(attName));
var desc=fa.getDescription$S$SA(this.featureType, attName);
if (desc != null  && desc.length$() > 50 ) {
desc=desc.substring$I$I(0, 50) + "...";
}tooltips.add$TE(desc == null  ? "" : desc);
}
var attCombo=$I$(15).buildComboWithTooltips$java_util_List$java_util_List(displayAtts, tooltips);
return attCombo;
});

Clazz.newMeth(C$, 'initialiseFiltersPanel', function () {
this.filters=Clazz.new_($I$(28));
var filtersPanel=Clazz.new_($I$(4));
filtersPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(14).c$$java_awt_Container$I,[filtersPanel, 1]));
...
this.chooseFiltersPanel=Clazz.new_($I$(4));
...
var andOrPanel=Clazz.new_($I$(4).c$$java_awt_LayoutManager,[Clazz.new_($I$(16).c$$I,[0])]);
andOrPanel.setBackground$java_awt_Color($I$(11).white);
this.andFilters=Clazz.new_($I$(3).c$$S,[$I$(1).getString$S("label.and")]);
this.orFilters=Clazz.new_($I$(3).c$$S,[$I$(1).getString$S("label.or")]);
this.andFilters.setOpaque$Z(false);
this.orFilters.setOpaque$Z(false);
var actionListener=((P$.FeatureTypeSettings$16||
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$16", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
andOrPanel.add$java_awt_Component(Clazz.new_($I$(22).c$$S,[$I$(1).getString$S("label.join_conditions")]));
...
this.filters.add$TE(matcher);
}
}this.filters.add$TE($I$(9).NULL_MATCHER);
if (this.filters.size$() <= 5) {
this.chooseFiltersPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(29).c$$I$I,[5, 1]));
} else {
this.chooseFiltersPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(14).c$$java_awt_Container$I,[this.chooseFiltersPanel, 1]));
}var filterIndex=0;
...
var filterRow=Clazz.new_($I$(4).c$$java_awt_LayoutManager,[Clazz.new_($I$(16).c$$I,[0])]);
...
var condCombo=Clazz.new_($I$(5));
var patternField=Clazz.new_($I$(7).c$$I,[8]);
patternField.setText$S(pattern);
var actionListener=((P$.FeatureTypeSettings$17||
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$17", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
), Clazz.new_(P$.FeatureTypeSettings$17.$init$, [this, {patternField: patternField, condCombo: condCombo, attCombo: attCombo, filterIndex: filterIndex}]));
var itemListener=((P$.FeatureTypeSettings$18||
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$18", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
Clazz.newMeth(C$, ['itemStateChanged$java_awt_event_ItemEvent','itemStateChanged$'], function (e) {
this.$finals$.actionListener.actionPerformed$(null);
});
})()
...
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$19", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ItemListener', 1);
...
), Clazz.new_(P$.FeatureTypeSettings$19.$init$, [this, {attCombo: attCombo, condCombo: condCombo, patternField: patternField, actionListener: actionListener}])));
...
condCombo.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(17).c$$I$I,[150, 20]));
...
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$20", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.FocusAdapter'), null, 1);
...
), Clazz.new_($I$(23), [this, {actionListener: actionListener}],P$.FeatureTypeSettings$20)));
...
var removeCondition=Clazz.new_($I$(30).c$$S,["\u2717"]);
removeCondition.setBorder$javax_swing_border_Border(Clazz.new_($I$(31).c$$I$I$I$I,[0, 0, 0, 0]));
removeCondition.setBackground$java_awt_Color($I$(11).WHITE);
removeCondition.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(17).c$$I$I,[23, 17]));
removeCondition.setToolTipText$S($I$(1).getString$S("label.delete_row"));
removeCondition.addActionListener$java_awt_event_ActionListener(((P$.FeatureTypeSettings$21||
(function(){var C$=Clazz.newClass(P$, "FeatureTypeSettings$21", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
var attName=attCombo.getSelectedItem$();
var cond=condCombo.getSelectedItem$();
