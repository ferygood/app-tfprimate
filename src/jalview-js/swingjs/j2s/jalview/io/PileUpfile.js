(function(){var P$=Clazz.newPackage("jalview.io"),I$=[[0,'StringBuffer','jalview.util.Format']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "PileUpfile", null, 'jalview.io.MSFfile');
...
var out=Clazz.new_($I$(1).c$$S,["PileUp"]);
...
out.append$S(Clazz.new_($I$(2).c$$S,["%-" + maxid + "s" ]).form$S(name + " "));
for (var k=0; k < 5; k++) {
var start=(i * 50) + (k * 10);
var end=start + 10;
