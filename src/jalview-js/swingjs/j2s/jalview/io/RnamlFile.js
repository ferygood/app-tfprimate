(function(){var P$=Clazz.newPackage("jalview.io"),p$1={},I$=[[0,'java.io.FileReader','java.io.BufferedReader','jalview.util.MessageManager','fr.orsay.lri.varna.factories.RNAFactory','jalview.datamodel.SequenceI','jalview.datamodel.Sequence','jalview.datamodel.Annotation','jalview.analysis.Rna','jalview.datamodel.AlignmentAnnotation','com.stevesoft.pat.Regex']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "RnamlFile", null, 'jalview.io.AlignFile');
...
var fr=null;
fr=Clazz.new_($I$(1).c$$java_io_File,[this.inFile]);
var r=Clazz.new_($I$(2).c$$java_io_Reader,[fr]);
return r;
});
...
this.id += "." + i;
}}sqs[i]=Clazz.new_($I$(6).c$$S$S$I$I,[this.id, seq, begin, end]);
...
ann[k]=Clazz.new_($I$(7).c$$S$S$C$F,[annot[k], "", $I$(8).getRNASecStrucState$S(annot[k]).charAt$I(0), 0.0]);
}
var align=Clazz.new_($I$(9).c$$S$S$jalview_datamodel_AnnotationA,["Secondary Structure", current.getID$().trim$().length$() > 0 ? "Secondary Structure for " + current.getID$() : "", ann]);
...
var m=Clazz.new_($I$(10).c$$S,["[\\/]?([-A-Za-z0-9]+)\\.?"]);
var mm=dataName;
