(function(){var P$=Clazz.newPackage("jalview.io.vamsas"),p$1={},I$=[[0,'uk.ac.vamsas.objects.core.DbRef','jalview.datamodel.DBRefEntry','uk.ac.vamsas.objects.core.Map','jalview.bin.Cache','jalview.io.vamsas.DatastoreItem','jalview.io.vamsas.Datasetsequence','jalview.datamodel.Mapping']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "Dbref", null, 'jalview.io.vamsas.Rangetype');
...
C$.superclazz.c$$jalview_io_VamsasAppDatastore$O$Class.apply(this, [datastore, dbentry, Clazz.getClass($I$(1))]);
C$.$init$.apply(this);
this.sq=sq2;
...
C$.superclazz.c$$jalview_io_VamsasAppDatastore$uk_ac_vamsas_client_Vobject$Class.apply(this, [datastore, ref, Clazz.getClass($I$(2))]);
C$.$init$.apply(this);
this.sequence=vdseq;
this.sq=dsseq;
...
if (dssync == null ) {
dssync=Clazz.new_($I$(6).c$$jalview_io_VamsasAppDatastore$jalview_datamodel_SequenceI$S$uk_ac_vamsas_objects_core_DataSet,[this.datastore, mp.getTo$(), (mp.getMappedWidth$() == mp.getWidth$()) ? this.sequence.getDictionary$() : ((mp.getMappedWidth$() == 3) ? "info:iubmb.org/nucleosides" : "info:iubmb.org/aminoacids"), this.ds]);
}}} else {
...
}var mp=Clazz.new_($I$(7).c$$jalview_util_MapList,[this.parsemapType$uk_ac_vamsas_objects_core_MapType(vobj.getMap$I(0))]);
...
var vobj=this.vobj;
var jvobj=this.jvobj;
this.sq.addDBRef$jalview_datamodel_DBRefEntry(jvobj=Clazz.new_($I$(2).c$$S$S$S,[vobj.getSource$().toString(), vobj.getVersion$().toString(), vobj.getAccessionId$().toString()]));
if (vobj.getMapCount$() > 0) {
if (vobj.getMapCount$() > 1) {
$I$(4).log.debug$O("Ignoring additional mappings on DbRef: " + jvobj.getSource$() + ":" + jvobj.getAccessionId$() );
}var mp=Clazz.new_($I$(7).c$$jalview_util_MapList,[this.parsemapType$uk_ac_vamsas_objects_core_MapType(vobj.getMap$I(0))]);
