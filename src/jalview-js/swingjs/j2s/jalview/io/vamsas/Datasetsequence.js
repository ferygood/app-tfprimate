(function(){var P$=Clazz.newPackage("jalview.io.vamsas"),p$1={},I$=[[0,'uk.ac.vamsas.objects.core.Sequence','jalview.datamodel.SequenceI','jalview.datamodel.Sequence','jalview.io.vamsas.DatastoreItem','jalview.io.vamsas.Sequencefeature','jalview.io.vamsas.Dbref']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "Datasetsequence", null, 'jalview.io.vamsas.DatastoreItem');
...
C$.superclazz.c$$jalview_io_VamsasAppDatastore$O$Class.apply(this, [vamsasAppDatastore, sq, Clazz.getClass($I$(1))]);
C$.$init$.apply(this);
...
var vseq=this.vobj;
var dsseq=Clazz.new_($I$(3).c$$S$S$I$I,[vseq.getName$(), vseq.getSequence$(), (vseq.getStart$()|0), (vseq.getEnd$()|0)]);
...
changed|=Clazz.new_($I$(5).c$$jalview_io_VamsasAppDatastore$jalview_datamodel_SequenceFeature$uk_ac_vamsas_objects_core_DataSet$uk_ac_vamsas_objects_core_Sequence,[this.datastore, sf, this.dataset, this.vobj]).docWasUpdated$();
}
return changed;
}, p$1);
...
modifiedthedoc|=Clazz.new_($I$(6).c$$jalview_io_VamsasAppDatastore$jalview_datamodel_DBRefEntry$jalview_datamodel_SequenceI$uk_ac_vamsas_objects_core_Sequence$uk_ac_vamsas_objects_core_DataSet,[this.datastore, entries.get$I(db), sq, this.vobj, this.dataset]).docWasUpdated$();
}
...
modifiedtheseq|=Clazz.new_($I$(6).c$$jalview_io_VamsasAppDatastore$uk_ac_vamsas_objects_core_DbRef$uk_ac_vamsas_objects_core_Sequence$jalview_datamodel_SequenceI,[this.datastore, entries[db], vsq, sq]).jvWasUpdated$();
}
