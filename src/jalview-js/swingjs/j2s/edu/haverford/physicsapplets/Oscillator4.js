(function(){var P$=Clazz.newPackage("edu.haverford.physicsapplets"),p$1={},p$2={},p$3={},I$=[[0,['edu.haverford.physicsapplets.Oscillator4','.vector2d'],'java.awt.RenderingHints','java.awt.Color','java.awt.BasicStroke','javax.swing.Timer',['edu.haverford.physicsapplets.Oscillator4','.GraphPanel'],['edu.haverford.physicsapplets.Oscillator4','.AniPanel2'],['edu.haverford.physicsapplets.Oscillator4','.AniPanel'],'Thread','javax.swing.JPanel','javax.swing.JButton','javax.swing.JCheckBox','javax.swing.JLabel','javax.swing.JSlider','javax.swing.BoxLayout','java.awt.event.ComponentAdapter','javax.swing.BorderFactory','java.awt.event.MouseAdapter','java.awt.event.MouseMotionAdapter','java.awt.Dimension']],$I$=function(i){return I$[i]||(I$[i]=Clazz.load(I$[0][i]))};
var C$=Clazz.newClass(P$, "Oscillator4", function(){
...
thisApplet.__Info.width=675; thisApplet.__Info.height=485;
};
}
...
this.addComponentListener$java_awt_event_ComponentListener(((P$.Oscillator4$1||
(function(){var C$=Clazz.newClass(P$, "Oscillator4$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.ComponentAdapter'), null, 1);
...
p$3.formComponentResized$java_awt_event_ComponentEvent.apply(this.b$['edu.haverford.physicsapplets.Oscillator4'], [evt]);
});
})()
), Clazz.new_($I$(16), [this, null],P$.Oscillator4$1)));
this.jPanel1.setLayout$java_awt_LayoutManager(Clazz.new_($I$(15).c$$java_awt_Container$I,[this.jPanel1, 0]));
this.jPanel1.addHierarchyBoundsListener$java_awt_event_HierarchyBoundsListener(((P$.Oscillator4$2||
(function(){var C$=Clazz.newClass(P$, "Oscillator4$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.HierarchyBoundsListener', 1);
...
p$3.jPanel1AncestorResized$java_awt_event_HierarchyEvent.apply(this.b$['edu.haverford.physicsapplets.Oscillator4'], [evt]);
});
})()
), Clazz.new_(P$.Oscillator4$2.$init$, [this, null])));
this.leftPanel.setLayout$java_awt_LayoutManager(Clazz.new_($I$(15).c$$java_awt_Container$I,[this.leftPanel, 0]));
this.leftPanel.setBorder$javax_swing_border_Border($I$(17).createEtchedBorder$());
this.leftPanel.addMouseListener$java_awt_event_MouseListener(((P$.Oscillator4$3||
(function(){var C$=Clazz.newClass(P$, "Oscillator4$3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.MouseAdapter'), null, 1);
...
p$3.leftPanelMouseClicked$java_awt_event_MouseEvent.apply(this.b$['edu.haverford.physicsapplets.Oscillator4'], [evt]);
});
})()
), Clazz.new_($I$(18), [this, null],P$.Oscillator4$3)));
this.leftPanel.addMouseMotionListener$java_awt_event_MouseMotionListener(((P$.Oscillator4$4||
(function(){var C$=Clazz.newClass(P$, "Oscillator4$4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('java.awt.event.MouseMotionAdapter'), null, 1);
...
p$3.leftPanelMouseDragged$java_awt_event_MouseEvent.apply(this.b$['edu.haverford.physicsapplets.Oscillator4'], [evt]);
});
})()
), Clazz.new_($I$(19), [this, null],P$.Oscillator4$4)));
...
this.rightPanel.setBorder$javax_swing_border_Border($I$(17).createEtchedBorder$());
...
this.middlePanel.setBorder$javax_swing_border_Border($I$(17).createEtchedBorder$());
this.middlePanel.setMaximumSize$java_awt_Dimension(Clazz.new_($I$(20).c$$I$I,[3000, 100]));
this.middlePanel.setMinimumSize$java_awt_Dimension(Clazz.new_($I$(20).c$$I$I,[300, 140]));
this.middlePanel.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(20).c$$I$I,[300, 140]));
...
this.jPanel2.setBorder$javax_swing_border_Border($I$(17).createEtchedBorder$());
this.jPanel2.setMaximumSize$java_awt_Dimension(Clazz.new_($I$(20).c$$I$I,[10000000, 34]));
this.goButton.setText$S("Go!");
this.goButton.addActionListener$java_awt_event_ActionListener(((P$.Oscillator4$5||
(function(){var C$=Clazz.newClass(P$, "Oscillator4$5", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
p$3.goButtonActionPerformed$java_awt_event_ActionEvent.apply(this.b$['edu.haverford.physicsapplets.Oscillator4'], [evt]);
});
})()
), Clazz.new_(P$.Oscillator4$5.$init$, [this, null])));
...
this.showVectorsBox.addActionListener$java_awt_event_ActionListener(((P$.Oscillator4$6||
(function(){var C$=Clazz.newClass(P$, "Oscillator4$6", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
Clazz.newMeth(C$, ['actionPerformed$java_awt_event_ActionEvent','actionPerformed','actionPerformed$'], function (evt) {
p$3.showVectorsBoxActionPerformed$java_awt_event_ActionEvent.apply(this.b$['edu.haverford.physicsapplets.Oscillator4'], [evt]);
});
})()
), Clazz.new_(P$.Oscillator4$6.$init$, [this, null])));
...
this.showDropLines.addActionListener$java_awt_event_ActionListener(((P$.Oscillator4$7||
(function(){var C$=Clazz.newClass(P$, "Oscillator4$7", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
Clazz.newMeth(C$, ['actionPerformed$java_awt_event_ActionEvent','actionPerformed','actionPerformed$'], function (evt) {
p$3.showDropLinesActionPerformed$java_awt_event_ActionEvent.apply(this.b$['edu.haverford.physicsapplets.Oscillator4'], [evt]);
});
})()
), Clazz.new_(P$.Oscillator4$7.$init$, [this, null])));
...
this.jSlider1.addChangeListener$javax_swing_event_ChangeListener(((P$.Oscillator4$8||
(function(){var C$=Clazz.newClass(P$, "Oscillator4$8", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'javax.swing.event.ChangeListener', 1);
...
p$3.jSlider1StateChanged$javax_swing_event_ChangeEvent.apply(this.b$['edu.haverford.physicsapplets.Oscillator4'], [evt]);
});
})()
), Clazz.new_(P$.Oscillator4$8.$init$, [this, null])));
...
this.kText.setText$S("  k: " + String.valueOf$D(Math.round(this.jSlider1.getValue$() * 10000.0 / 50.0) / 10000.0));
this.k=(this.jSlider1.getValue$() / 100.0) + 1.0E-5;
this.updateMath$();
this.disp.time=0;
this.beats.time=0;
}, p$3);
...
;
(function(){var C$=Clazz.newClass(P$.Oscillator4, "GraphPanel", function(){
...
p$1.drawVectors$java_awt_Graphics2D$edu_haverford_physicsapplets_Oscillator4_vector2d$I$I.apply(this, [this.biG, this.thePoint, this.xAxis, this.yAxis]);
} else {
p$1.drawGraphPoint$java_awt_Graphics2D$edu_haverford_physicsapplets_Oscillator4_vector2d$I$I.apply(this, [this.biG, this.thePoint, this.xAxis, this.yAxis]);
}g.drawImage$java_awt_Image$I$I$java_awt_image_ImageObserver(this.bi, 0, 0, this);
});

Clazz.newMeth(C$, 'drawVectors$java_awt_Graphics2D$edu_haverford_physicsapplets_Oscillator4_vector2d$I$I', function (g, p, xlines, ylines) {
...
var slThePoint=p$1.screenLocation$edu_haverford_physicsapplets_Oscillator4_vector2d.apply(this, [Clazz.new_($I$(1).c$$D$D, [this, null, xspace * p.x, yspace * p.y])]);
var pt=Clazz.new_($I$(1).c$$D$D, [this, null, xspace * p.x, yspace * p.y]);
var c=pt.dot$edu_haverford_physicsapplets_Oscillator4_vector2d(Clazz.new_($I$(1).c$$D$D, [this, null, xspace, yspace])) / ((xspace * xspace + yspace * yspace));
var sl=p$1.screenLocation$edu_haverford_physicsapplets_Oscillator4_vector2d.apply(this, [Clazz.new_($I$(1).c$$D$D, [this, null, c * xspace, c * yspace])]);
g.setColor$java_awt_Color($I$(3).blue);
p$1.drawArrow$java_awt_Graphics2D$edu_haverford_physicsapplets_Oscillator4_vector2d$edu_haverford_physicsapplets_Oscillator4_vector2d.apply(this, [g, Clazz.new_($I$(1).c$$D$D, [this, null, (this.getSize$().width/2|0), (this.getSize$().height/2|0)]), sl]);
...
c=pt.dot$edu_haverford_physicsapplets_Oscillator4_vector2d(Clazz.new_($I$(1).c$$D$D, [this, null, -xspace, yspace])) / ((xspace * xspace + yspace * yspace));
sl=p$1.screenLocation$edu_haverford_physicsapplets_Oscillator4_vector2d.apply(this, [Clazz.new_($I$(1).c$$D$D, [this, null, -c * xspace, c * yspace])]);
p$1.drawArrow$java_awt_Graphics2D$edu_haverford_physicsapplets_Oscillator4_vector2d$edu_haverford_physicsapplets_Oscillator4_vector2d.apply(this, [g, Clazz.new_($I$(1).c$$D$D, [this, null, (this.getSize$().width/2|0), (this.getSize$().height/2|0)]), sl]);
if (this.this$0.dropLines) {
g.setStroke$java_awt_Stroke(this.this$0.dashedStroke);
g.drawLine$I$I$I$I((slThePoint.x|0), (slThePoint.y|0), (sl.x|0), (sl.y|0));
...
p$1.drawArrow$java_awt_Graphics2D$edu_haverford_physicsapplets_Oscillator4_vector2d$edu_haverford_physicsapplets_Oscillator4_vector2d.apply(this, [g, Clazz.new_($I$(1).c$$D$D, [this, null, (this.getSize$().width/2|0), (this.getSize$().height/2|0)]), slThePoint]);
g.setColor$java_awt_Color(Clazz.new_($I$(3).c$$I$I$I,[186, 85, 211]));
p$1.drawArrow$java_awt_Graphics2D$edu_haverford_physicsapplets_Oscillator4_vector2d$edu_haverford_physicsapplets_Oscillator4_vector2d.apply(this, [g, Clazz.new_($I$(1).c$$D$D, [this, null, (this.getSize$().width/2|0), (this.getSize$().height/2|0)]), Clazz.new_($I$(1).c$$D$D, [this, null, slThePoint.x, (this.getSize$().height/2|0)])]);
g.setColor$java_awt_Color($I$(3).red);
p$1.drawArrow$java_awt_Graphics2D$edu_haverford_physicsapplets_Oscillator4_vector2d$edu_haverford_physicsapplets_Oscillator4_vector2d.apply(this, [g, Clazz.new_($I$(1).c$$D$D, [this, null, (this.getSize$().width/2|0), (this.getSize$().height/2|0)]), Clazz.new_($I$(1).c$$D$D, [this, null, (this.getSize$().width/2|0), slThePoint.y])]);
if (this.this$0.dropLines) {
g.setStroke$java_awt_Stroke(this.this$0.dashedStroke);
g.setColor$java_awt_Color(Clazz.new_($I$(3).c$$I$I$I,[186, 85, 211]));
...
Clazz.newMeth(C$, 'drawArrow$java_awt_Graphics2D$edu_haverford_physicsapplets_Oscillator4_vector2d$edu_haverford_physicsapplets_Oscillator4_vector2d', function (g, start, end) {
var t=end.minus$edu_haverford_physicsapplets_Oscillator4_vector2d(start);
...
Clazz.newMeth(C$, 'drawGraphPoint$java_awt_Graphics2D$edu_haverford_physicsapplets_Oscillator4_vector2d$I$I', function (g, v, xlines, ylines) {
var sl=p$1.screenLocation$edu_haverford_physicsapplets_Oscillator4_vector2d.apply(this, [Clazz.new_($I$(1).c$$D$D, [this, null, (this.getSize$().width / (xlines)) * v.x, (this.getSize$().height / (ylines)) * v.y])]);
...
Clazz.newMeth(C$, 'worldLocation$edu_haverford_physicsapplets_Oscillator4_vector2d', function (screenLocation) {
return Clazz.new_($I$(1).c$$D$D, [this, null, screenLocation.x - (this.getSize$().width/2|0), -1 * (screenLocation.y - (this.getSize$().height/2|0))]);
}, p$1);

Clazz.newMeth(C$, 'screenLocation$edu_haverford_physicsapplets_Oscillator4_vector2d', function (world) {
...
var l=p$1.worldLocation$edu_haverford_physicsapplets_Oscillator4_vector2d.apply(this, [Clazz.new_($I$(1).c$$D$D, [this, null, evt.getX$(), evt.getY$()])]);
...
;
(function(){var C$=Clazz.newClass(P$.Oscillator4, "vector2d", function(){
Clazz.newInstance(this, arguments[0],true,C$);
});
...
Clazz.newMeth(C$, 'minus$edu_haverford_physicsapplets_Oscillator4_vector2d', function ($in) {
return Clazz.new_(C$.c$$D$D, [this, null, this.x - $in.x, this.y - $in.y]);
});

Clazz.newMeth(C$, 'plus$edu_haverford_physicsapplets_Oscillator4_vector2d', function ($in) {
return Clazz.new_(C$.c$$D$D, [this, null, this.x + $in.x, this.y + $in.y]);
});
...
Clazz.newMeth(C$, 'dot$edu_haverford_physicsapplets_Oscillator4_vector2d', function ($in) {
return $in.x * this.x + $in.y * this.y;
});
})()
;
(function(){var C$=Clazz.newClass(P$.Oscillator4, "AniPanel", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
this.biG.setColor$java_awt_Color(Clazz.new_($I$(3).c$$I$I$I,[150, 150, 150]));
this.biG.fillRect$I$I$I$I(((this.getSize$().width/2|0) - this.this$0.bobDist - 10), 55, 2 * (this.this$0.bobDist + 10), 5);
this.biG.setColor$java_awt_Color(Clazz.new_($I$(3).c$$I$I$I,[((200 - 40 * this.this$0.k)|0), ((200 - 40 * this.this$0.k)|0), ((200 - 40 * this.this$0.k)|0)]));
...
this.timer=Clazz.new_($I$(5).c$$I$java_awt_event_ActionListener,[1 ||6, ((P$.Oscillator4$AniPanel$1||
(function(){var C$=Clazz.newClass(P$, "Oscillator4$AniPanel$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.awt.event.ActionListener', 1);
...
if (!this.b$['edu.haverford.physicsapplets.Oscillator4.AniPanel'].running) {
this.b$['edu.haverford.physicsapplets.Oscillator4.AniPanel'].timer.stop$();
return;
}p$2.doStep.apply(this.b$['edu.haverford.physicsapplets.Oscillator4.AniPanel'], []);
});
})()
), Clazz.new_(P$.Oscillator4$AniPanel$1.$init$, [this, null]))]);
...
;
(function(){var C$=Clazz.newClass(P$.Oscillator4, "AniPanel2", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'javax.swing.JPanel');
...
var yspacing=(this.getSize$().height/5|0);
var Tint=94.248 / this.this$0.Ws;
...
this.biG.drawString$S$I$I("Left Mass Position", ((0.75 * this.getSize$().width + 7)|0), (3 * yspacing + 5));
this.biG.setColor$java_awt_Color($I$(3).red);
this.last=Clazz.new_($I$(1).c$$D$D, [this, null, spacing, 4 * yspacing - this.this$0.graph.theNewPoint.y * 2 * Math.cos(this.this$0.Ws * ((Tint / this.steps) + this.time - Tint))  + this.this$0.graph.theNewPoint.x * 2 * Math.cos(this.this$0.Wb * ((Tint / this.steps) + this.time - Tint)) ]);
for (var i=1; i < this.steps + 1; i++) {
this.biG.drawLine$I$I$I$I(((i * spacing)|0), ((4 * yspacing - this.this$0.graph.theNewPoint.y * 2 * Math.cos(this.this$0.Ws * ((i * Tint / this.steps) + this.time - Tint))  + this.this$0.graph.theNewPoint.x * 2 * Math.cos(this.this$0.Wb * ((i * Tint / this.steps) + this.time - Tint)) )|0), (this.last.x|0), (this.last.y|0));
this.last.x=i * spacing;
this.last.y=4 * yspacing - this.this$0.graph.theNewPoint.y * 2 * Math.cos(this.this$0.Ws * ((i * Tint / this.steps) + this.time - Tint))  + this.this$0.graph.theNewPoint.x * 2 * Math.cos(this.this$0.Wb * ((i * Tint / this.steps) + this.time - Tint)) ;
}
this.biG.fillOval$I$I$I$I(((this.last.x)|0) - 4, ((this.last.y)|0) - 4, 8, 8);
this.biG.drawString$S$I$I("Right Mass Position", ((0.75 * this.getSize$().width + 7)|0), (4 * yspacing + 5));
g.drawImage$java_awt_Image$I$I$java_awt_image_ImageObserver(this.bi, 0, 0, this);
});
