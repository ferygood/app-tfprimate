...
var C$=Clazz.newClass(P$, "SeqSearchServiceSoapBindingStub", null, 'org.apache.axis.client.Stub', 'ext.vamsas.SeqSearchI');
C$._operations=null;
...
oper.setReturnQName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["", "getDatabaseReturn"]));
...
oper.addParameter$javax_xml_namespace_QName$javax_xml_namespace_QName$Class$B$Z$Z(Clazz.new_($I$(3).c$$S$S,["", "job_id"]), Clazz.new_($I$(3).c$$S$S,["http://www.w3.org/2001/XMLSchema", "string"]), Clazz.getClass(String), ($b$[0] = 1, $b$[0]), false, false);
oper.setReturnType$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["simple.objects.vamsas", "SeqSearchResult"]));
oper.setReturnClass$Class(Clazz.getClass($I$(6)));
oper.setReturnQName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["", "getResultReturn"]));
oper.setStyle$org_apache_axis_enum_Style($I$(4).RPC);
oper.setUse$org_apache_axis_enum_Use($I$(5).ENCODED);
C$._operations[1]=oper;
oper=Clazz.new_($I$(1));
oper.setName$S("psearch");
oper.addParameter$javax_xml_namespace_QName$javax_xml_namespace_QName$Class$B$Z$Z(Clazz.new_($I$(3).c$$S$S,["", "al"]), Clazz.new_($I$(3).c$$S$S,["simple.objects.vamsas", "Alignment"]), Clazz.getClass($I$(7)), ($b$[0] = 1, $b$[0]), false, false);
oper.addParameter$javax_xml_namespace_QName$javax_xml_namespace_QName$Class$B$Z$Z(Clazz.new_($I$(3).c$$S$S,["", "database"]), Clazz.new_($I$(3).c$$S$S,["http://www.w3.org/2001/XMLSchema", "string"]), Clazz.getClass(String), ($b$[0] = 1, $b$[0]), false, false);
oper.setReturnType$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["simple.objects.vamsas", "WsJobId"]));
oper.setReturnClass$Class(Clazz.getClass($I$(8)));
oper.setReturnQName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["", "psearchReturn"]));
oper.setStyle$org_apache_axis_enum_Style($I$(4).RPC);
oper.setUse$org_apache_axis_enum_Use($I$(5).ENCODED);
C$._operations[2]=oper;
oper=Clazz.new_($I$(1));
oper.setName$S("search");
oper.addParameter$javax_xml_namespace_QName$javax_xml_namespace_QName$Class$B$Z$Z(Clazz.new_($I$(3).c$$S$S,["", "s"]), Clazz.new_($I$(3).c$$S$S,["simple.objects.vamsas", "Sequence"]), Clazz.getClass($I$(9)), ($b$[0] = 1, $b$[0]), false, false);
oper.addParameter$javax_xml_namespace_QName$javax_xml_namespace_QName$Class$B$Z$Z(Clazz.new_($I$(3).c$$S$S,["", "database"]), Clazz.new_($I$(3).c$$S$S,["http://www.w3.org/2001/XMLSchema", "string"]), Clazz.getClass(String), ($b$[0] = 1, $b$[0]), false, false);
oper.setReturnType$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["simple.objects.vamsas", "WsJobId"]));
oper.setReturnClass$Class(Clazz.getClass($I$(8)));
oper.setReturnQName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["", "searchReturn"]));
oper.setStyle$org_apache_axis_enum_Style($I$(4).RPC);
oper.setUse$org_apache_axis_enum_Use($I$(5).ENCODED);
C$._operations[3]=oper;
oper=Clazz.new_($I$(1));
oper.setName$S("cancel");
oper.addParameter$javax_xml_namespace_QName$javax_xml_namespace_QName$Class$B$Z$Z(Clazz.new_($I$(3).c$$S$S,["", "jobId"]), Clazz.new_($I$(3).c$$S$S,["http://www.w3.org/2001/XMLSchema", "string"]), Clazz.getClass(String), ($b$[0] = 1, $b$[0]), false, false);
oper.setReturnType$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["simple.objects.vamsas", "WsJobId"]));
oper.setReturnClass$Class(Clazz.getClass($I$(8)));
oper.setReturnQName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["", "cancelReturn"]));
oper.setStyle$org_apache_axis_enum_Style($I$(4).RPC);
oper.setUse$org_apache_axis_enum_Use($I$(5).ENCODED);
...
qName=Clazz.new_($I$(3).c$$S$S,["simple.objects.vamsas", "Result"]);
...
qName=Clazz.new_($I$(3).c$$S$S,["simple.objects.vamsas", "WsJobId"]);
this.cachedSerQNames.add$TE(qName);
cls=Clazz.getClass($I$(8));
this.cachedSerClasses.add$TE(cls);
this.cachedSerFactories.add$TE(beansf);
this.cachedDeserFactories.add$TE(beandf);
qName=Clazz.new_($I$(3).c$$S$S,["http://simple.objects.vamsas", "Object"]);
this.cachedSerQNames.add$TE(qName);
cls=Clazz.getClass($I$(22));
this.cachedSerClasses.add$TE(cls);
this.cachedSerFactories.add$TE(beansf);
this.cachedDeserFactories.add$TE(beandf);
qName=Clazz.new_($I$(3).c$$S$S,["vamsas", "ArrayOf_xsd_string"]);
this.cachedSerQNames.add$TE(qName);
cls=Clazz.array(String, -1);
this.cachedSerClasses.add$TE(cls);
this.cachedSerFactories.add$TE(arraysf);
this.cachedDeserFactories.add$TE(arraydf);
qName=Clazz.new_($I$(3).c$$S$S,["simple.objects.vamsas", "Alignment"]);
this.cachedSerQNames.add$TE(qName);
cls=Clazz.getClass($I$(7));
this.cachedSerClasses.add$TE(cls);
this.cachedSerFactories.add$TE(beansf);
this.cachedDeserFactories.add$TE(beandf);
qName=Clazz.new_($I$(3).c$$S$S,["simple.objects.vamsas", "Sequence"]);
this.cachedSerQNames.add$TE(qName);
cls=Clazz.getClass($I$(9));
this.cachedSerClasses.add$TE(cls);
this.cachedSerFactories.add$TE(beansf);
this.cachedDeserFactories.add$TE(beandf);
qName=Clazz.new_($I$(3).c$$S$S,["vamsas", "ArrayOf_tns1_Sequence"]);
this.cachedSerQNames.add$TE(qName);
cls=Clazz.array($I$(9), -1);
this.cachedSerClasses.add$TE(cls);
this.cachedSerFactories.add$TE(arraysf);
this.cachedDeserFactories.add$TE(arraydf);
qName=Clazz.new_($I$(3).c$$S$S,["simple.objects.vamsas", "SeqSearchResult"]);
this.cachedSerQNames.add$TE(qName);
cls=Clazz.getClass($I$(6));
this.cachedSerClasses.add$TE(cls);
this.cachedSerFactories.add$TE(beansf);
this.cachedDeserFactories.add$TE(beandf);
qName=Clazz.new_($I$(3).c$$S$S,["simple.objects.vamsas", "SequenceSet"]);
this.cachedSerQNames.add$TE(qName);
...
throw Clazz.new_($I$(25).c$$S$Throwable,["Failure trying to get the Call object", _t]);
}
});
...
_call.setSOAPVersion$org_apache_axis_soap_SOAPConstants($I$(24).SOAP11_CONSTANTS);
_call.setOperationName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["vamsas", "getDatabase"]));
...
_call.setSOAPActionURI$S("");
_call.setSOAPVersion$org_apache_axis_soap_SOAPConstants($I$(24).SOAP11_CONSTANTS);
_call.setOperationName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["vamsas", "getResult"]));
this.setRequestHeaders$org_apache_axis_client_Call(_call);
this.setAttachments$org_apache_axis_client_Call(_call);
...
_call.setSOAPActionURI$S("");
_call.setSOAPVersion$org_apache_axis_soap_SOAPConstants($I$(24).SOAP11_CONSTANTS);
_call.setOperationName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["vamsas", "psearch"]));
this.setRequestHeaders$org_apache_axis_client_Call(_call);
this.setAttachments$org_apache_axis_client_Call(_call);
...
_call.setSOAPActionURI$S("");
_call.setSOAPVersion$org_apache_axis_soap_SOAPConstants($I$(24).SOAP11_CONSTANTS);
_call.setOperationName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["vamsas", "search"]));
this.setRequestHeaders$org_apache_axis_client_Call(_call);
this.setAttachments$org_apache_axis_client_Call(_call);
...
_call.setSOAPActionURI$S("");
_call.setSOAPVersion$org_apache_axis_soap_SOAPConstants($I$(24).SOAP11_CONSTANTS);
_call.setOperationName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["vamsas", "cancel"]));
this.setRequestHeaders$org_apache_axis_client_Call(_call);
this.setAttachments$org_apache_axis_client_Call(_call);
