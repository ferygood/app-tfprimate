...
var C$=Clazz.newClass(P$, "JpredSoapBindingStub", null, 'org.apache.axis.client.Stub', 'ext.vamsas.Jpred');
C$._operations=null;
...
oper.addParameter$javax_xml_namespace_QName$javax_xml_namespace_QName$Class$B$Z$Z(Clazz.new_($I$(3).c$$S$S,["", "seq"]), Clazz.new_($I$(3).c$$S$S,["simple.objects.vamsas", "Sequence"]), Clazz.getClass($I$(4)), ($b$[0] = 1, $b$[0]), false, false);
...
oper.setReturnQName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["", "predictReturn"]));
...
oper.addParameter$javax_xml_namespace_QName$javax_xml_namespace_QName$Class$B$Z$Z(Clazz.new_($I$(3).c$$S$S,["", "msf"]), Clazz.new_($I$(3).c$$S$S,["http://simple.objects.vamsas", "Msfalignment"]), Clazz.getClass($I$(7)), ($b$[0] = 1, $b$[0]), false, false);
oper.setReturnType$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["http://www.w3.org/2001/XMLSchema", "string"]));
oper.setReturnClass$Class(Clazz.getClass(String));
oper.setReturnQName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["", "predictOnMsaReturn"]));
oper.setStyle$org_apache_axis_enum_Style($I$(5).RPC);
oper.setUse$org_apache_axis_enum_Use($I$(6).ENCODED);
...
oper.setReturnType$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["http://simple.objects.vamsas", "Secstructpred"]));
oper.setReturnClass$Class(Clazz.getClass($I$(8)));
oper.setReturnQName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["", "getpredictReturn"]));
oper.setStyle$org_apache_axis_enum_Style($I$(5).RPC);
oper.setUse$org_apache_axis_enum_Use($I$(6).ENCODED);
...
oper.addParameter$javax_xml_namespace_QName$javax_xml_namespace_QName$Class$B$Z$Z(Clazz.new_($I$(3).c$$S$S,["", "job_id"]), Clazz.new_($I$(3).c$$S$S,["http://www.w3.org/2001/XMLSchema", "string"]), Clazz.getClass(String), ($b$[0] = 1, $b$[0]), false, false);
oper.setReturnType$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["http://simple.objects.vamsas", "JpredResult"]));
...
qName=Clazz.new_($I$(3).c$$S$S,["http://simple.objects.vamsas", "JpredResult"]);
...
this.cachedSerFactories.add$TE(beansf);
this.cachedDeserFactories.add$TE(beandf);
qName=Clazz.new_($I$(3).c$$S$S,["http://simple.objects.vamsas", "Secstructpred"]);
this.cachedSerQNames.add$TE(qName);
cls=Clazz.getClass($I$(8));
this.cachedSerClasses.add$TE(cls);
this.cachedSerFactories.add$TE(beansf);
this.cachedDeserFactories.add$TE(beandf);
qName=Clazz.new_($I$(3).c$$S$S,["http://simple.objects.vamsas", "Msfalignment"]);
this.cachedSerQNames.add$TE(qName);
...
throw Clazz.new_($I$(15).c$$S$Throwable,["Failure trying to get the Call object", _t]);
}
});
...
_call.setSOAPVersion$org_apache_axis_soap_SOAPConstants($I$(14).SOAP11_CONSTANTS);
_call.setOperationName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["vamsas", "predict"]));
...
_call.setSOAPActionURI$S("");
_call.setSOAPVersion$org_apache_axis_soap_SOAPConstants($I$(14).SOAP11_CONSTANTS);
_call.setOperationName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["vamsas", "predictOnMsa"]));
this.setRequestHeaders$org_apache_axis_client_Call(_call);
this.setAttachments$org_apache_axis_client_Call(_call);
...
_call.setSOAPActionURI$S("");
_call.setSOAPVersion$org_apache_axis_soap_SOAPConstants($I$(14).SOAP11_CONSTANTS);
_call.setOperationName$javax_xml_namespace_QName(Clazz.new_($I$(3).c$$S$S,["vamsas", "getpredict"]));
this.setRequestHeaders$org_apache_axis_client_Call(_call);
this.setAttachments$org_apache_axis_client_Call(_call);
