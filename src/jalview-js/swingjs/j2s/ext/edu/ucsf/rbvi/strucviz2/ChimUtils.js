...
return chimeraManager.getChimeraModel$Integer$Integer(new Integer(model), new Integer(submodel));
}, 1);
...
var models=chimeraManager.getChimeraModels$S$ext_edu_ucsf_rbvi_strucviz2_StructureManager_ModelType(model, $I$(4).PDB_MODEL);
if (models.size$() == 1) {
chimeraModel=models.get$I(0);
} else {
try {
chimeraModel=chimeraManager.getChimeraModel$Integer$Integer(Integer.valueOf$S(model), new Integer(0));
} catch (ex) {
if (Clazz.exceptionOf(ex,"NumberFormatException")){
} else {
throw ex;
...
var models=chimeraManager.getChimeraModels$S$ext_edu_ucsf_rbvi_strucviz2_StructureManager_ModelType(modelID, $I$(4).PDB_MODEL);
if (models.size$() == 1) {
chimeraModel=models.get$I(0);
...
try {
chimeraModel=chimeraManager.getChimeraModel$Integer$Integer(Integer.valueOf$S(modelID), new Integer(0));
} catch (ex) {
if (Clazz.exceptionOf(ex,"NumberFormatException")){
} else {
throw ex;
