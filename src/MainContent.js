...
class MainContent extends Component {
  scrollToFirstRow = () => {
    document.getElementById('first-row').scrollIntoView({ behavior: 'smooth' });
  };
    ...
    return (
      <>
          ...
          <Row>
            <Col className='m-5'>
              ...
              <ul>
                ...
                <Button variant="outline-success" onClick={this.scrollToFirstRow}>Get Started</Button>
              </ul>
            </Col>
          </Row>
        </main>
        <Row id="first-row" className="my-5" style={{ backgroundColor: 'rgba(149, 185, 168, 0.16)' }}>
          <Col className='m-5'>
            <p className='my-5'>
        ...
        <div className="scroll-buttons">
          <Button variant="outline-dark" onClick={this.scrollToTop}>Top</Button><br></br>
          <Button variant="outline-dark" onClick={this.scrollToBottom}>Bottom</Button>
        </div>
      </>
    );
  }
